#ifndef TARGETING_SYSTEM_TOUGHNESS_H
#define TARGETING_SYSTEM_TOUGHNESS_H
...
class Raven_TargetingSystem_Toughness :
	public Raven_TargetingSystem
{

public:

	Raven_TargetingSystem_Toughness(Raven_Bot* owner);
