...
private:
  ...
  //tells the update function to dispatch a message that the partial search is complete
...
public:
  ...
  void		 IncrementCycles() { cycles += 1; }
  int		 GetCycles() { return cycles;}
  void		 PartialTrue() { partialComplete = true;}
  void		 PartialFalse() { partialComplete = false;}
