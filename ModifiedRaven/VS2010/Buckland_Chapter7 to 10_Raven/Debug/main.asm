; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.30319.01 
	...
	TITLE	C:\Users\Alec\Desktop\GameAISource\VS2010\Buckland_Chapter7 to 10_Raven\main.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_BSS	ENDS
_DATA	SEGMENT
?g_szApplicationName@@3PADA DD FLAT:$SG141385		; g_szApplicationName
?g_szWindowClassName@@3PADA DD FLAT:$SG141387		; g_szWindowClassName
_DATA	ENDS
CONST	SEGMENT
...
$SG141385 DB	'Raven', 00H
$SG141462 DB	00H
	ORG $+1
$SG141387 DB	'MyWindowClass', 00H
	ORG $+2
$SG141451 DB	'Raven map file (*.map)', 00H
	ORG $+1
$SG141461 DB	'Filename: ', 00H
	ORG $+1
$SG141514 DB	'Error', 00H
	ORG $+2
$SG141515 DB	'Registration Failed!', 00H
	ORG $+3
$SG141518 DB	'Error!', 00H
	ORG $+1
$SG141519 DB	'CreateWindowEx Failed!', 00H
CONST	ENDS
...
PUBLIC	?ToggleCollect@Raven_Game@@QAEXXZ		; Raven_Game::ToggleCollect
PUBLIC	?isPaused@Raven_Game@@QAE_NXZ			; Raven_Game::isPaused
...
EXTRN	?setStart@Raven_Game@@QAEXXZ:PROC		; Raven_Game::setStart
EXTRN	?setPauseTimer@Raven_Game@@QAEXXZ:PROC		; Raven_Game::setPauseTimer
...
; File c:\users\alec\desktop\gameaisource\vs2010\buckland_chapter7 to 10_raven\main.cpp
_BSS	SEGMENT
...
$T151779 = -224						; size = 4
$T151778 = -220						; size = 4
_hdc$141489 = -216					; size = 4
_ps$141481 = -208					; size = 64
$T141464 = -140						; size = 32
$T141449 = -108						; size = 32
$T141448 = -76						; size = 32
_hdc$141416 = -44					; size = 4
_rect$141414 = -36					; size = 16
...
; 56   :     switch (msg)
	...
	movzx	eax, BYTE PTR $LN52@WindowProc[edx]
...
; 69   : 			   GetClientRect(hwnd, &rect);
	...
	mov	esi, esp
	lea	ecx, DWORD PTR _rect$141414[ebp]
	push	ecx
...
; 84   :          HDC hdc = GetDC(hwnd);
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	DWORD PTR _hdc$141416[ebp], eax
...
; 88   :                                           cyClient);
	...
	push	ecx
	mov	edx, DWORD PTR _hdc$141416[ebp]
	push	edx
...
; 98   :          g_pRaven = new Raven_Game();
	...
	add	esp, 4
	mov	DWORD PTR $T151779[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T151779[ebp], 0
	je	SHORT $LN45@WindowProc
	mov	ecx, DWORD PTR $T151779[ebp]
...
$LN46@WindowProc:
	...
	mov	DWORD PTR $T151778[ebp], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	edx, DWORD PTR $T151778[ebp]
...
; 120  :         switch(wParam)
	...
	movzx	eax, BYTE PTR $LN53@WindowProc[edx]
	jmp	DWORD PTR $LN60@WindowProc[eax*4]
$LN36@WindowProc:
...
; 132  : 		   if (g_pRaven->isPaused())

	mov	ecx, DWORD PTR ?g_pRaven@@3PAVRaven_Game@@A ; g_pRaven
	call	?isPaused@Raven_Game@@QAE_NXZ		; Raven_Game::isPaused
	movzx	edx, al
	test	edx, edx
	je	SHORT $LN34@WindowProc

; 133  : 		   {
; 134  : 			   g_pRaven->setPauseTimer(); //game paused, start pause timer

	mov	ecx, DWORD PTR ?g_pRaven@@3PAVRaven_Game@@A ; g_pRaven
	call	?setPauseTimer@Raven_Game@@QAEXXZ	; Raven_Game::setPauseTimer

; 135  : 			   g_pRaven->ToggleCollect();

	mov	ecx, DWORD PTR ?g_pRaven@@3PAVRaven_Game@@A ; g_pRaven
	call	?ToggleCollect@Raven_Game@@QAEXXZ	; Raven_Game::ToggleCollect

; 136  : 		   }
; 137  : 		   else

	jmp	SHORT $LN33@WindowProc
$LN34@WindowProc:

; 138  : 		   {
; 139  : 			   g_pRaven->setStart(); //game unpaused, subtract pause timer

	mov	ecx, DWORD PTR ?g_pRaven@@3PAVRaven_Game@@A ; g_pRaven
	call	?setStart@Raven_Game@@QAEXXZ		; Raven_Game::setStart
$LN33@WindowProc:
...
; 142  :            break;
	...
	jmp	SHORT $LN37@WindowProc
$LN32@WindowProc:

; 143  : 
; 144  :          case '1':
; 145  : 
; 146  :            g_pRaven->ChangeWeaponOfPossessedBot(type_blaster);
...
; 150  :          case '2':
; 151  : 
; 152  :            g_pRaven->ChangeWeaponOfPossessedBot(type_shotgun);
...
; 156  :          case '3':
; 157  : 
; 158  :            g_pRaven->ChangeWeaponOfPossessedBot(type_rocket_launcher);
...
; 162  :          case '4':
; 163  : 
; 164  :            g_pRaven->ChangeWeaponOfPossessedBot(type_rail_gun);
...
; 168  :          case 'X':
; 169  : 
; 170  :            g_pRaven->ExorciseAnyPossessedBot();
...
; 191  :     {
; 192  :       g_pRaven->ClickLeftMouseButton(MAKEPOINTS(lParam));
...
; 198  :     {
; 199  :       g_pRaven->ClickRightMouseButton(MAKEPOINTS(lParam));
...
; 207  :      switch(wParam)
	...
	sub	eax, 40001				; 00009c41H
	mov	DWORD PTR tv213[ebp], eax
	cmp	DWORD PTR tv213[ebp], 16		; 00000010H
	ja	$LN3@WindowProc
	mov	ecx, DWORD PTR tv213[ebp]
	jmp	DWORD PTR $LN61@WindowProc[ecx*4]
$LN20@WindowProc:

; 208  :       {
; 209  :       
; 210  : 
; 211  :       case IDM_GAME_LOAD:
; 212  :           
; 213  :           FileOpenDlg(hwnd, szFileName, szTitleName, "Raven map file (*.map)", "map");

	push	OFFSET $SG141450
	lea	ecx, DWORD PTR $T141448[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	DWORD PTR __$EHRec$[ebp+8], 1
	push	OFFSET $SG141451
	lea	ecx, DWORD PTR $T141449[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	BYTE PTR __$EHRec$[ebp+8], 2
	lea	edx, DWORD PTR $T141448[ebp]
	push	edx
...
; 214  : 
; 215  :           debug_con << "Filename: " << szTitleName << "";

	push	OFFSET $SG141462
	push	OFFSET ?szTitleName@?1??WindowProc@@YGJPAUHWND__@@IIJ@Z@4PADA
	push	OFFSET $SG141461
...
; 218  :           {
; 219  :             g_pRaven->LoadMap(szTitleName);

	push	OFFSET ?szTitleName@?1??WindowProc@@YGJPAUHWND__@@IIJ@Z@4PADA
	lea	ecx, DWORD PTR $T141464[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	DWORD PTR __$EHRec$[ebp+8], 3
	lea	edx, DWORD PTR $T141464[ebp]
	push	edx
	mov	ecx, DWORD PTR ?g_pRaven@@3PAVRaven_Game@@A ; g_pRaven
...
; 223  : 
; 224  :       case IDM_GAME_ADDBOT:
; 225  : 
; 226  :           g_pRaven->AddBots(1);
...
; 229  : 
; 230  :       case IDM_GAME_REMOVEBOT:
; 231  :           
; 232  :           g_pRaven->RemoveBot();
...
; 235  : 
; 236  :       case IDM_GAME_PAUSE:
; 237  :           
; 238  :           g_pRaven->TogglePause();
...
; 242  : 
; 243  : 
; 244  :       case IDM_NAVIGATION_SHOW_NAVGRAPH:
; 245  : 
; 246  :         UserOptions->m_bShowGraph = !UserOptions->m_bShowGraph;
...
; 247  : 
; 248  :         CheckMenuItemAppropriately(hwnd, IDM_NAVIGATION_SHOW_NAVGRAPH, UserOptions->m_bShowGraph);
...
; 251  :         
; 252  :       case IDM_NAVIGATION_SHOW_PATH:
; 253  : 
; 254  :         UserOptions->m_bShowPathOfSelectedBot = !UserOptions->m_bShowPathOfSelectedBot;
...
; 255  : 
; 256  :         CheckMenuItemAppropriately(hwnd, IDM_NAVIGATION_SHOW_PATH, UserOptions->m_bShowPathOfSelectedBot);
...
; 259  : 
; 260  :       case IDM_NAVIGATION_SHOW_INDICES:
; 261  : 
; 262  :         UserOptions->m_bShowNodeIndices = !UserOptions->m_bShowNodeIndices;
...
; 263  : 
; 264  :         CheckMenuItemAppropriately(hwnd, IDM_NAVIGATION_SHOW_INDICES, UserOptions->m_bShowNodeIndices);
...
; 267  : 
; 268  :       case IDM_NAVIGATION_SMOOTH_PATHS_QUICK:
; 269  : 
; 270  :         UserOptions->m_bSmoothPathsQuick = !UserOptions->m_bSmoothPathsQuick;
...
; 271  :         UserOptions->m_bSmoothPathsPrecise = false;

	call	?Instance@Raven_UserOptions@@SAPAV1@XZ	; Raven_UserOptions::Instance
	mov	BYTE PTR [eax+10], 0

; 272  :         CheckMenuItemAppropriately(hwnd, IDM_NAVIGATION_SMOOTH_PATHS_PRECISE, UserOptions->m_bSmoothPathsPrecise);
...
; 273  :         CheckMenuItemAppropriately(hwnd, IDM_NAVIGATION_SMOOTH_PATHS_QUICK, UserOptions->m_bSmoothPathsQuick);
...
; 276  : 
; 277  :       case IDM_NAVIGATION_SMOOTH_PATHS_PRECISE:
; 278  : 
; 279  :         UserOptions->m_bSmoothPathsPrecise = !UserOptions->m_bSmoothPathsPrecise;
...
; 280  :         UserOptions->m_bSmoothPathsQuick = false;

	call	?Instance@Raven_UserOptions@@SAPAV1@XZ	; Raven_UserOptions::Instance
	mov	BYTE PTR [eax+9], 0

; 281  :         CheckMenuItemAppropriately(hwnd, IDM_NAVIGATION_SMOOTH_PATHS_QUICK, UserOptions->m_bSmoothPathsQuick);
...
; 282  :         CheckMenuItemAppropriately(hwnd, IDM_NAVIGATION_SMOOTH_PATHS_PRECISE, UserOptions->m_bSmoothPathsPrecise);
...
; 285  : 
; 286  :       case IDM_BOTS_SHOW_IDS:
; 287  : 
; 288  :         UserOptions->m_bShowBotIDs = !UserOptions->m_bShowBotIDs;
...
; 289  : 
; 290  :         CheckMenuItemAppropriately(hwnd, IDM_BOTS_SHOW_IDS, UserOptions->m_bShowBotIDs);
...
; 293  : 
; 294  :       case IDM_BOTS_SHOW_HEALTH:
; 295  : 
; 296  :         UserOptions->m_bShowBotHealth = !UserOptions->m_bShowBotHealth;
...
; 297  :         
; 298  :         CheckMenuItemAppropriately(hwnd, IDM_BOTS_SHOW_HEALTH, UserOptions->m_bShowBotHealth);
...
; 301  : 
; 302  :       case IDM_BOTS_SHOW_TARGET:
; 303  : 
; 304  :         UserOptions->m_bShowTargetOfSelectedBot = !UserOptions->m_bShowTargetOfSelectedBot;
...
; 305  :         
; 306  :         CheckMenuItemAppropriately(hwnd, IDM_BOTS_SHOW_TARGET, UserOptions->m_bShowTargetOfSelectedBot);
...
; 309  : 
; 310  :       case IDM_BOTS_SHOW_SENSED:
; 311  : 
; 312  :         UserOptions->m_bShowOpponentsSensedBySelectedBot = !UserOptions->m_bShowOpponentsSensedBySelectedBot;
...
; 313  :         
; 314  :         CheckMenuItemAppropriately(hwnd, IDM_BOTS_SHOW_SENSED, UserOptions->m_bShowOpponentsSensedBySelectedBot);
...
; 317  : 
; 318  : 
; 319  :       case IDM_BOTS_SHOW_FOV:
; 320  : 
; 321  :         UserOptions->m_bOnlyShowBotsInTargetsFOV = !UserOptions->m_bOnlyShowBotsInTargetsFOV;
...
; 322  :         
; 323  :         CheckMenuItemAppropriately(hwnd, IDM_BOTS_SHOW_FOV, UserOptions->m_bOnlyShowBotsInTargetsFOV);
...
; 326  : 
; 327  :       case IDM_BOTS_SHOW_SCORES:
; 328  : 
; 329  :         UserOptions->m_bShowScore = !UserOptions->m_bShowScore;
...
; 330  :         
; 331  :         CheckMenuItemAppropriately(hwnd, IDM_BOTS_SHOW_SCORES, UserOptions->m_bShowScore);
...
; 334  : 
; 335  :       case IDM_BOTS_SHOW_GOAL_Q:
; 336  : 
; 337  :         UserOptions->m_bShowGoalsOfSelectedBot = !UserOptions->m_bShowGoalsOfSelectedBot;
...
; 338  :         
; 339  :         CheckMenuItemAppropriately(hwnd, IDM_BOTS_SHOW_GOAL_Q, UserOptions->m_bShowGoalsOfSelectedBot);
...
; 352  :          BeginPaint (hwnd, &ps);
	...
	mov	esi, esp
	lea	ecx, DWORD PTR _ps$141481[ebp]
	push	ecx
	mov	edx, DWORD PTR _hwnd$[ebp]
	push	edx
...
; 353  : 
; 354  :         //fill our backbuffer with white
; 355  :          BitBlt(hdcBackBuffer,
; 356  :                 0,
; 357  :                 0,
; 358  :                 cxClient,
; 359  :                 cyClient,
...
; 364  :           
; 365  :          
; 366  :          gdi->StartDrawing(hdcBackBuffer);
...
; 369  : 
; 370  :          gdi->StopDrawing(hdcBackBuffer);
...
; 371  : 
; 372  : 
; 373  :          //now blit backbuffer to front
; 374  : 			   BitBlt(ps.hdc, 0, 0, cxClient, cyClient, hdcBackBuffer, 0, 0, SRCCOPY); 
	...
	push	0
	push	0
	mov	edx, DWORD PTR _ps$141481[ebp]
	push	edx
	call	DWORD PTR __imp__BitBlt@36
	cmp	esi, esp
	call	__RTC_CheckEsp
...
; 376  :          EndPaint (hwnd, &ps);
	...
	mov	esi, esp
	lea	eax, DWORD PTR _ps$141481[ebp]
	push	eax
	mov	ecx, DWORD PTR _hwnd$[ebp]
	push	ecx
...
; 381  : 
; 382  :     //has the user resized the client area?
; 383  : 		case WM_SIZE:
; 384  : 		  {
; 385  :         //if so we need to update our variables so that any drawing
; 386  :         //we do using cxClient and cyClient is scaled accordingly
; 387  : 			  cxClient = LOWORD(lParam);
...
; 388  : 			  cyClient = HIWORD(lParam);

	mov	ecx, DWORD PTR _lParam$[ebp]
	shr	ecx, 16					; 00000010H
	and	ecx, 65535				; 0000ffffH
	movzx	edx, cx
	mov	DWORD PTR ?cyClient@?1??WindowProc@@YGJPAUHWND__@@IIJ@Z@4HA, edx

; 389  : 
; 390  :         //now to resize the backbuffer accordingly. First select
; 391  :         //the old bitmap back into the DC
; 392  : 			  SelectObject(hdcBackBuffer, hOldBitmap);
...
; 393  : 
; 394  :         //don't forget to do this or you will get resource leaks
...
; 396  : 
; 397  : 			  //get the DC for the application
; 398  :         HDC hdc = GetDC(hwnd);
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	DWORD PTR _hdc$141489[ebp], eax

; 399  : 
; 400  : 			  //create another bitmap of the same size and mode
; 401  :         //as the application
; 402  :         hBitmap = CreateCompatibleBitmap(hdc,
; 403  : 											  cxClient,
; 404  : 											  cyClient);
	...
	push	edx
	mov	eax, DWORD PTR _hdc$141489[ebp]
	push	eax
	call	DWORD PTR __imp__CreateCompatibleBitmap@12
	cmp	esi, esp
	call	__RTC_CheckEsp
...
; 406  : 			  ReleaseDC(hwnd, hdc);
	...
	mov	esi, esp
	mov	ecx, DWORD PTR _hdc$141489[ebp]
	push	ecx
	mov	edx, DWORD PTR _hwnd$[ebp]
	push	edx
	call	DWORD PTR __imp__ReleaseDC@8
...
; 407  : 			  
; 408  : 			  //select the new bitmap into the DC
; 409  :         SelectObject(hdcBackBuffer, hBitmap);
...
; 416  : 			 {
; 417  : 
; 418  :          //clean up our backbuffer objects
; 419  :          SelectObject(hdcBackBuffer, hOldBitmap);
...
; 423  :          
; 424  : 
; 425  :          // kill the application, this sends a WM_QUIT message  
...
; 431  :      }//end switch
; 432  : 
; 433  :      //this is where all the messages not specifically handled by our 
; 434  : 		 //winproc are sent to be processed
...
; 436  : }
	...
	mov	ecx, ebp
	push	eax
	lea	edx, DWORD PTR $LN58@WindowProc
...
PUBLIC	??_C@_1HK@KDKHCBMI@?$AAC?$AA?3?$AA?2?$AAU?$AAs?$AAe?$AAr?$AAs?$AA?2?$AAA?$AAl?$AAe?$AAc?$AA?2?$AAD?$AAe?$AAs?$AAk?$AAt?$AAo?$AAp?$AA?2?$AAG?$AAa?$AAm?$AAe?$AAA?$AAI?$AAS?$AAo?$AAu?$AAr@ ; `string'
...
??_C@_1BM@MMNOPHKK@?$AAm?$AA_?$AAh?$AAd?$AAc?$AA?5?$AA?$DN?$AA?$DN?$AA?5?$AAN?$AAU?$AAL?$AAL?$AA?$AA@ DB 'm'
	...
	DB	00H						; `string'
CONST	ENDS
;	COMDAT ??_C@_1HK@KDKHCBMI@?$AAC?$AA?3?$AA?2?$AAU?$AAs?$AAe?$AAr?$AAs?$AA?2?$AAA?$AAl?$AAe?$AAc?$AA?2?$AAD?$AAe?$AAs?$AAk?$AAt?$AAo?$AAp?$AA?2?$AAG?$AAa?$AAm?$AAe?$AAA?$AAI?$AAS?$AAo?$AAu?$AAr@
CONST	SEGMENT
??_C@_1HK@KDKHCBMI@?$AAC?$AA?3?$AA?2?$AAU?$AAs?$AAe?$AAr?$AAs?$AA?2?$AAA?$AAl?$AAe?$AAc?$AA?2?$AAD?$AAe?$AAs?$AAk?$AAt?$AAo?$AAp?$AA?2?$AAG?$AAa?$AAm?$AAe?$AAA?$AAI?$AAS?$AAo?$AAu?$AAr@ DB 'C'
...
; 177  :     assert(m_hdc == NULL);
	...
	push	177					; 000000b1H
	push	OFFSET ??_C@_1HK@KDKHCBMI@?$AAC?$AA?3?$AA?2?$AAU?$AAs?$AAe?$AAr?$AAs?$AA?2?$AAA?$AAl?$AAe?$AAc?$AA?2?$AAD?$AAe?$AAs?$AAk?$AAt?$AAo?$AAp?$AA?2?$AAG?$AAa?$AAm?$AAe?$AAA?$AAI?$AAS?$AAo?$AAu?$AAr@
...
; Function compile flags: /Odtp /RTCsu
; File c:\users\alec\desktop\gameaisource\vs2010\buckland_chapter7 to 10_raven\raven_game.h
_TEXT	ENDS
...
; Function compile flags: /Odtp /RTCsu
_TEXT	ENDS
;	COMDAT ?isPaused@Raven_Game@@QAE_NXZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?isPaused@Raven_Game@@QAE_NXZ PROC			; Raven_Game::isPaused, COMDAT
; _this$ = ecx

; 150  :   bool		  isPaused() { return m_bPaused; }
	...
	pop	ebp
	ret	0
?isPaused@Raven_Game@@QAE_NXZ ENDP			; Raven_Game::isPaused
; Function compile flags: /Odtp /RTCsu
_TEXT	ENDS
;	COMDAT ?ToggleCollect@Raven_Game@@QAEXXZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?ToggleCollect@Raven_Game@@QAEXXZ PROC			; Raven_Game::ToggleCollect, COMDAT
; _this$ = ecx

; 151  :   void		  ToggleCollect() { collectData = !collectData; }
	...
	pop	ebp
	ret	0
?ToggleCollect@Raven_Game@@QAEXXZ ENDP			; Raven_Game::ToggleCollect
_TEXT	ENDS
...
$T151828 = -280						; size = 4
$T141532 = -276						; size = 32
_err$141531 = -240					; size = 4
_bDone$141521 = -229					; size = 1
_timer$141520 = -224					; size = 104
...
; 447  : {
	...
	mov	BYTE PTR $T151844[ebp], 0

; 448  :   MSG msg;
; 449  :   //handle to our window
; 450  : 	HWND						hWnd;
; 451  : 
; 452  :  //the window class structure
; 453  : 	WNDCLASSEX     winclass;
; 454  : 
; 455  :   // first fill in the window class stucture
; 456  : 	winclass.cbSize        = sizeof(WNDCLASSEX);

	mov	DWORD PTR _winclass$[ebp], 48		; 00000030H

; 457  : 	winclass.style         = CS_HREDRAW | CS_VREDRAW;

	mov	DWORD PTR _winclass$[ebp+4], 3

; 458  :   winclass.lpfnWndProc   = WindowProc;

	mov	DWORD PTR _winclass$[ebp+8], OFFSET ?WindowProc@@YGJPAUHWND__@@IIJ@Z ; WindowProc

; 459  :   winclass.cbClsExtra    = 0;

	mov	DWORD PTR _winclass$[ebp+12], 0

; 460  :   winclass.cbWndExtra    = 0;

	mov	DWORD PTR _winclass$[ebp+16], 0

; 461  :   winclass.hInstance     = hInstance;

	mov	eax, DWORD PTR _hInstance$[ebp]
	mov	DWORD PTR _winclass$[ebp+20], eax

; 462  :   winclass.hIcon         = LoadIcon(NULL, IDI_APPLICATION);
...
; 463  :   winclass.hCursor       = LoadCursor(NULL, IDC_ARROW);
...
; 464  :   winclass.hbrBackground = NULL;

	mov	DWORD PTR _winclass$[ebp+32], 0

; 465  :   winclass.lpszMenuName  = MAKEINTRESOURCE(IDR_MENU1);

	mov	DWORD PTR _winclass$[ebp+36], 101	; 00000065H

; 466  :   winclass.lpszClassName = g_szWindowClassName;

	mov	ecx, DWORD PTR ?g_szWindowClassName@@3PADA ; g_szWindowClassName
	mov	DWORD PTR _winclass$[ebp+40], ecx

; 467  : 	winclass.hIconSm       = LoadIcon(NULL, IDI_APPLICATION);
...
; 470  :   if (!RegisterClassEx(&winclass))
...
; 471  :   {
; 472  : 		MessageBox(NULL, "Registration Failed!", "Error", 0);

	mov	esi, esp
	push	0
	push	OFFSET $SG141514
	push	OFFSET $SG141515
	push	0
...
; 481  : 		 //create the window and assign its ID to hwnd    
; 482  :      hWnd = CreateWindowEx (NULL,                 // extended style
; 483  :                             g_szWindowClassName,  // window class name
; 484  :                             g_szApplicationName,  // window caption
; 485  :                             WS_OVERLAPPED | WS_VISIBLE | WS_CAPTION | WS_SYSMENU,  // window style
; 486  :                             GetSystemMetrics(SM_CXSCREEN)/2 - WindowWidth/2,
; 487  :                             GetSystemMetrics(SM_CYSCREEN)/2 - WindowHeight/2,                    
; 488  :                             WindowWidth,     // initial x size
; 489  :                             WindowHeight,    // initial y size
; 490  :                             NULL,                 // parent window handle
; 491  :                             NULL,                 // window menu handle
; 492  :                             hInstance,            // program instance handle
; 493  :                             NULL);                // creation parameters
...
; 500  : 
; 501  :      
; 502  :     //make the window visible
; 503  :     ShowWindow (hWnd, iCmdShow);
...
; 505  :    
; 506  :     //create a timer
; 507  :     PrecisionTimer timer(FrameRate);

	sub	esp, 8
	fld	QWORD PTR __real@404e000000000000
	fstp	QWORD PTR [esp]
	lea	ecx, DWORD PTR _timer$141520[ebp]
...
; 511  : 
; 512  :     //enter the message loop
; 513  :     bool bDone = false;

	mov	BYTE PTR _bDone$141521[ebp], 0
$LN7@WinMain:

; 514  : 
; 515  :     while(!bDone)

	movzx	ecx, BYTE PTR _bDone$141521[ebp]
	test	ecx, ecx
	jne	$LN6@WinMain
$LN5@WinMain:
...
; 518  :       {
; 519  :         if( msg.message == WM_QUIT ) 

	cmp	DWORD PTR _msg$[ebp+4], 18		; 00000012H
	jne	SHORT $LN3@WinMain

; 520  :         {
; 521  :           // Stop loop if it's a quit message
; 522  : 	        bDone = true;

	mov	BYTE PTR _bDone$141521[ebp], 1
...
; 531  : 
; 532  :       if (timer.ReadyForNextFrame() && msg.message != WM_QUIT)
...
; 546  : 
; 547  :   catch (const std::runtime_error& err)
; 548  :   {
; 549  :     ErrorBox(std::string(err.what()));

	mov	esi, esp
	mov	ecx, DWORD PTR _err$141531[ebp]
	mov	edx, DWORD PTR [ecx]
	mov	ecx, DWORD PTR _err$141531[ebp]
...
; 551  :     delete g_pRaven;
	...
	mov	DWORD PTR $T151829[ebp], eax
	mov	ecx, DWORD PTR $T151829[ebp]
	mov	DWORD PTR $T151828[ebp], ecx
	cmp	DWORD PTR $T151828[ebp], 0
	je	SHORT $LN13@WinMain
	push	1
	mov	ecx, DWORD PTR $T151828[ebp]
...
; 552  :     UnregisterClass( g_szWindowClassName, winclass.hInstance );
...
; 553  :     return 0;
	...
	mov	eax, DWORD PTR $T151832[ebp]
	jmp	SHORT $LN11@WinMain
$LN20@WinMain:

; 555  :   
; 556  :  //tidy up
; 557  :  UnregisterClass( g_szWindowClassName, winclass.hInstance );
...
; 558  :  delete g_pRaven;
	...
	mov	eax, DWORD PTR ?g_pRaven@@3PAVRaven_Game@@A ; g_pRaven
	mov	DWORD PTR $T151834[ebp], eax
	mov	ecx, DWORD PTR $T151834[ebp]
	mov	DWORD PTR $T151833[ebp], ecx
	cmp	DWORD PTR $T151833[ebp], 0
...
; 559  :  return msg.wParam;

	cmp	BYTE PTR $T151844[ebp], 0
...
PUBLIC	??_C@_1IO@FAMNPFNF@?$AAC?$AA?3?$AA?2?$AAU?$AAs?$AAe?$AAr?$AAs?$AA?2?$AAA?$AAl?$AAe?$AAc?$AA?2?$AAD?$AAe?$AAs?$AAk?$AAt?$AAo?$AAp?$AA?2?$AAG?$AAa?$AAm?$AAe?$AAA?$AAI?$AAS?$AAo?$AAu?$AAr@ ; `string'
...
; File c:\users\alec\desktop\gameaisource\vs2010\common\time\precisiontimer.h
CONST	SEGMENT
...
CONST	ENDS
;	COMDAT ??_C@_1IO@FAMNPFNF@?$AAC?$AA?3?$AA?2?$AAU?$AAs?$AAe?$AAr?$AAs?$AA?2?$AAA?$AAl?$AAe?$AAc?$AA?2?$AAD?$AAe?$AAs?$AAk?$AAt?$AAo?$AAp?$AA?2?$AAG?$AAa?$AAm?$AAe?$AAA?$AAI?$AAS?$AAo?$AAu?$AAr@
CONST	SEGMENT
??_C@_1IO@FAMNPFNF@?$AAC?$AA?3?$AA?2?$AAU?$AAs?$AAe?$AAr?$AAs?$AA?2?$AAA?$AAl?$AAe?$AAc?$AA?2?$AAD?$AAe?$AAs?$AAk?$AAt?$AAo?$AAp?$AA?2?$AAG?$AAa?$AAm?$AAe?$AAA?$AAI?$AAS?$AAo?$AAu?$AAr@ DB 'C'
	DB	00H, ':', 00H, '\', 00H, 'U', 00H, 's', 00H, 'e', 00H, 'r', 00H
	DB	's', 00H, '\', 00H, 'A', 00H, 'l', 00H, 'e', 00H, 'c', 00H, '\'
	DB	00H, 'D', 00H, 'e', 00H, 's', 00H, 'k', 00H, 't', 00H, 'o', 00H
	DB	'p', 00H, '\', 00H, 'G', 00H, 'a', 00H, 'm', 00H, 'e', 00H, 'A'
...
$LN4@ReadyForNe:
	push	90					; 0000005aH
	push	OFFSET ??_C@_1IO@FAMNPFNF@?$AAC?$AA?3?$AA?2?$AAU?$AAs?$AAe?$AAr?$AAs?$AA?2?$AAA?$AAl?$AAe?$AAc?$AA?2?$AAD?$AAe?$AAs?$AAk?$AAt?$AAo?$AAp?$AA?2?$AAG?$AAa?$AAm?$AAe?$AAA?$AAI?$AAS?$AAo?$AAu?$AAr@
...
; Function compile flags: /Odtp /RTCsu
; File c:\users\alec\desktop\gameaisource\vs2010\common\misc\windowutils.h
...
; 1993 : 			_Elem *_Ptr = this->_Bx._Ptr;
	...
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+4]
	mov	DWORD PTR __Ptr$143581[ebp], eax
...
; 1995 : 				_Traits::copy(this->_Bx._Buf, _Ptr, _Newsize);
	...
	push	ecx
	mov	edx, DWORD PTR __Ptr$143581[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	add	eax, 4
	push	eax
...
; 1996 : 			this->_Alval.deallocate(_Ptr, this->_Myres + 1);
	...
	add	edx, 1
	push	edx
	mov	eax, DWORD PTR __Ptr$143581[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 1954 : 		_Traits::assign(_Myptr()[this->_Mysize = _Newsize], _Elem());
	...
	mov	BYTE PTR $T151943[ebp], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR __Newsize$[ebp]
	mov	DWORD PTR [eax+20], ecx
	lea	edx, DWORD PTR $T151943[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Myptr@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEPADXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Myptr
...
; 1118 : 			size_type _Newsize = this->_Mysize - _Count;
	...
	mov	DWORD PTR __Newsize$143560[ebp], eax

; 1119 : 			_Eos(_Newsize);

	mov	ecx, DWORD PTR __Newsize$143560[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Eos@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Eos
$LN1@erase:
...
; File c:\users\alec\desktop\gameaisource\vs2010\common\debug\debugconsole.h
CONST	SEGMENT
...
; 173  :     return *this;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR $T152014[ebp], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _ss$[ebp]
	call	??_D?$basic_ostringstream@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXXZ
	mov	eax, DWORD PTR $T152014[ebp]
$LN7@operator:
...
; 784  : 					_Ostr.rdbuf()->sputc(_Ostr.fill())))
	...
	mov	DWORD PTR $T152040[ebp], ecx
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR tv285[ebp], eax
	mov	edx, DWORD PTR tv285[ebp]
	mov	DWORD PTR $T152041[ebp], edx
	lea	eax, DWORD PTR $T152040[ebp]
	push	eax
	lea	ecx, DWORD PTR $T152041[ebp]
	push	ecx
...
; 797  : 					_Ostr.rdbuf()->sputc(_Ostr.fill())))
	...
	mov	DWORD PTR $T152042[ebp], ecx
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR tv292[ebp], eax
	mov	edx, DWORD PTR tv292[ebp]
	mov	DWORD PTR $T152043[ebp], edx
	lea	eax, DWORD PTR $T152042[ebp]
	push	eax
	lea	ecx, DWORD PTR $T152043[ebp]
	push	ecx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
...
; 807  : 	return (_Ostr);
	...
	mov	eax, DWORD PTR __Ostr$[ebp]
	mov	DWORD PTR $T152044[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+12], -1
	lea	ecx, DWORD PTR __Ok$[ebp]
	call	??1sentry@?$basic_ostream@DU?$char_traits@D@std@@@std@@QAE@XZ ; std::basic_ostream<char,std::char_traits<char> >::sentry::~sentry
	mov	eax, DWORD PTR $T152044[ebp]
...
; 319  : 			_THROW_NCEE(failure, "ios_base::failbit set");
	...
	push	1
	lea	edx, DWORD PTR $T152092[ebp]
	push	edx
	call	?make_error_code@std@@YA?AVerror_code@1@W4io_errc@31@@Z ; std::make_error_code
	add	esp, 8
	push	eax
	push	OFFSET ??_C@_0BG@FMKFHCIL@ios_base?3?3failbit?5set?$AA@
	lea	ecx, DWORD PTR $T152091[ebp]
	call	??0failure@ios_base@std@@QAE@PBDABVerror_code@2@@Z ; std::ios_base::failure::failure
	push	OFFSET __TI4?AVfailure@ios_base@std@@
	lea	eax, DWORD PTR $T152091[ebp]
	push	eax
	call	__CxxThrowException@8
...
$LN5@sputc:
	...
	mov	DWORD PTR $T152144[ebp], eax
	mov	eax, DWORD PTR $T152144[ebp]
	mov	cl, BYTE PTR __Ch$[ebp]
	mov	BYTE PTR [eax], cl
	mov	edx, DWORD PTR $T152144[ebp]
	push	edx
...
; 166  :     if (ss.str() == ""){flush(); return *this;}
	...
	call	??$?8DU?$char_traits@D@std@@V?$allocator@D@1@@std@@YA_NABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@PBD@Z ; std::operator==<char,std::char_traits<char>,std::allocator<char> >
	add	esp, 8
	mov	BYTE PTR $T152208[ebp], al
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T147289[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	movzx	ecx, BYTE PTR $T152208[ebp]
	test	ecx, ecx
	je	SHORT $LN3@operator@3
	call	?flush@DebugConsole@@SAXXZ		; DebugConsole::flush
	mov	edx, DWORD PTR _this$[ebp]
	mov	DWORD PTR $T152209[ebp], edx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _ss$[ebp]
	call	??_D?$basic_ostringstream@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXXZ
	mov	eax, DWORD PTR $T152209[ebp]
	jmp	$LN7@operator@3
$LN3@operator@3:
...
; 173  :     return *this;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR $T152210[ebp], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _ss$[ebp]
	call	??_D?$basic_ostringstream@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXXZ
	mov	eax, DWORD PTR $T152210[ebp]
$LN7@operator@3:
...
; 166  :     if (ss.str() == ""){flush(); return *this;}
	...
	call	??$?8DU?$char_traits@D@std@@V?$allocator@D@1@@std@@YA_NABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@PBD@Z ; std::operator==<char,std::char_traits<char>,std::allocator<char> >
	add	esp, 8
	mov	BYTE PTR $T152227[ebp], al
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T147304[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	movzx	ecx, BYTE PTR $T152227[ebp]
	test	ecx, ecx
	je	SHORT $LN3@operator@4
	call	?flush@DebugConsole@@SAXXZ		; DebugConsole::flush
	mov	edx, DWORD PTR _this$[ebp]
	mov	DWORD PTR $T152228[ebp], edx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _ss$[ebp]
	call	??_D?$basic_ostringstream@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXXZ
	mov	eax, DWORD PTR $T152228[ebp]
	jmp	$LN7@operator@4
$LN3@operator@4:
...
; 173  :     return *this;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR $T152229[ebp], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _ss$[ebp]
	call	??_D?$basic_ostringstream@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXXZ
	mov	eax, DWORD PTR $T152229[ebp]
$LN7@operator@4:
...
; 634  : 			size_type _Idx = _STD addressof(_Val) - this->_Myfirst;
	...
	sar	eax, 5
	mov	DWORD PTR __Idx$148283[ebp], eax
...
; 640  : 				_STD forward<_Ty>(this->_Myfirst[_Idx]));
	...
	mov	eax, DWORD PTR __Idx$148283[ebp]
	shl	eax, 5
	mov	ecx, DWORD PTR _this$[ebp]
	add	eax, DWORD PTR [ecx+4]
	push	eax
...
; 967  : 		return (*(end() - 1));
	...
	push	1
	lea	eax, DWORD PTR $T152309[ebp]
	push	eax
	lea	ecx, DWORD PTR $T152308[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	...
	mov	DWORD PTR $T152307[ebp], eax
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T152309[ebp]
...
; 792  : 		return (iterator(this->_Mylast, this));
	...
	mov	eax, DWORD PTR $T152344[ebp]
	or	eax, 1
	mov	DWORD PTR $T152344[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 537  : 		{	// construct empty writable character buffer
	...
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	mov	ecx, DWORD PTR $T152396[ebp]
	or	ecx, 1
	mov	DWORD PTR $T152396[ebp], ecx
$LN1@basic_ostr:
	push	0
	push	0
	mov	edx, DWORD PTR _this$[ebp]
...
__unwindfunclet$??0?$basic_ostringstream@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@H@Z$0:
	mov	eax, DWORD PTR $T152396[ebp]
	and	eax, 1
	je	$LN5@basic_ostr
	and	DWORD PTR $T152396[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 80					; 00000050H
...
; 593  : 		return (_Stringbuffer.str());
	...
	mov	ecx, DWORD PTR $T152426[ebp]
	or	ecx, 1
	mov	DWORD PTR $T152426[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 359  : 			? _Traits::eof() : _Traits::to_int_type(*_Gninc()));
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	DWORD PTR $T152460[ebp], eax
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T152461[ebp], eax
	lea	ecx, DWORD PTR $T152460[ebp]
	push	ecx
	lea	edx, DWORD PTR $T152461[ebp]
	push	edx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	eax, al
...
; 408  : 				overflow(_Traits::to_int_type(*_Ptr))))
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	DWORD PTR $T152477[ebp], eax
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T152478[ebp], eax
	lea	ecx, DWORD PTR $T152477[ebp]
	push	ecx
	lea	edx, DWORD PTR $T152478[ebp]
	push	edx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	eax, al
...
; 123  : 				return (_Refs == 0 ? this : 0);
	...
	mov	DWORD PTR $T152518[ebp], eax
	lea	ecx, DWORD PTR __Lock$104593[ebp]
	call	??1_Lockit@std@@QAE@XZ			; std::_Lockit::~_Lockit
	mov	eax, DWORD PTR $T152518[ebp]
...
tv195 = -32						; size = 4
$T152527 = -28						; size = 4
__Oldptr$148447 = -24					; size = 4
__Newptr$148446 = -20					; size = 4
__Inc$148441 = -16					; size = 4
__Newsize$148440 = -12					; size = 4
__Oldsize$148439 = -8					; size = 4
_this$ = -4						; size = 4
__Meta$ = 8						; size = 4
...
; 125  : 		if (_Traits::eq_int_type(_Traits::eof(), _Meta))
	...
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T152527[ebp], eax
	lea	edx, DWORD PTR __Meta$[ebp]
	push	edx
	lea	eax, DWORD PTR $T152527[ebp]
	push	eax
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	ecx, al
...
$LN22@overflow:
	...
	mov	DWORD PTR __Oldsize$148439[ebp], eax

; 139  : 			size_t _Newsize = _Oldsize;

	mov	ecx, DWORD PTR __Oldsize$148439[ebp]
	mov	DWORD PTR __Newsize$148440[ebp], ecx

; 140  : 			size_t _Inc = _Newsize / 2 < _MINSIZE
; 141  : 				? _MINSIZE : _Newsize / 2;	// grow by 50 per cent

	mov	edx, DWORD PTR __Newsize$148440[ebp]
	shr	edx, 1
...
$LN23@overflow:
	mov	eax, DWORD PTR __Newsize$148440[ebp]
	shr	eax, 1
	mov	DWORD PTR tv199[ebp], eax
$LN24@overflow:
	mov	ecx, DWORD PTR tv199[ebp]
	mov	DWORD PTR __Inc$148441[ebp], ecx
$LN11@overflow:

; 142  : 
; 143  : 			while (0 < _Inc && INT_MAX - _Inc < _Newsize)

	cmp	DWORD PTR __Inc$148441[ebp], 0
	jbe	SHORT $LN10@overflow
	mov	edx, 2147483647				; 7fffffffH
	sub	edx, DWORD PTR __Inc$148441[ebp]
	cmp	edx, DWORD PTR __Newsize$148440[ebp]
	jae	SHORT $LN10@overflow

; 144  : 				_Inc /= 2;	// increment causes overflow, halve it

	mov	eax, DWORD PTR __Inc$148441[ebp]
	shr	eax, 1
	mov	DWORD PTR __Inc$148441[ebp], eax
...
; 148  : 			_Newsize += _Inc;
	...
	mov	ecx, DWORD PTR __Newsize$148440[ebp]
	add	ecx, DWORD PTR __Inc$148441[ebp]
	mov	DWORD PTR __Newsize$148440[ebp], ecx
...
; 150  : 			_Elem *_Newptr = _Al.allocate(_Newsize);
	...
	call	?allocate@?$allocator@D@std@@QAEPADI@Z	; std::allocator<char>::allocate
	mov	DWORD PTR __Newptr$148446[ebp], eax

; 151  : 			_Elem *_Oldptr = _Mysb::eback();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?eback@?$basic_streambuf@DU?$char_traits@D@std@@@std@@IBEPADXZ ; std::basic_streambuf<char,std::char_traits<char> >::eback
	mov	DWORD PTR __Oldptr$148447[ebp], eax

; 152  : 
; 153  : 			if (0 < _Oldsize)

	cmp	DWORD PTR __Oldsize$148439[ebp], 0
	jbe	SHORT $LN8@overflow

; 154  : 				_Traits::copy(_Newptr, _Oldptr, _Oldsize);

	mov	eax, DWORD PTR __Oldsize$148439[ebp]
	push	eax
	mov	ecx, DWORD PTR __Oldptr$148447[ebp]
	push	ecx
	mov	edx, DWORD PTR __Newptr$148446[ebp]
	push	edx
	call	?copy@?$char_traits@D@std@@SAPADPADPBDI@Z ; std::char_traits<char>::copy
	add	esp, 12					; 0000000cH
$LN8@overflow:
...
; 158  : 				_Seekhigh = _Newptr;
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR __Newptr$148446[ebp]
	mov	DWORD PTR [eax+60], ecx

; 159  : 				_Mysb::setp(_Newptr, _Newptr + _Newsize);

	mov	edx, DWORD PTR __Newptr$148446[ebp]
	add	edx, DWORD PTR __Newsize$148440[ebp]
	push	edx
	mov	eax, DWORD PTR __Newptr$148446[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 167  : 				_Seekhigh = _Newptr + (_Seekhigh - _Oldptr);
	...
	sub	eax, DWORD PTR __Oldptr$148447[ebp]
	add	eax, DWORD PTR __Newptr$148446[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
...
; 180  : 				_Al.deallocate(_Oldptr, _Oldsize);
	...
	mov	ecx, DWORD PTR __Oldsize$148439[ebp]
	push	ecx
	mov	edx, DWORD PTR __Oldptr$148447[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 68					; 00000044H
	call	?deallocate@?$allocator@D@std@@QAEXPADI@Z ; std::allocator<char>::deallocate
...
; 194  : 			&& _Mystate & _Constant)
	...
	call	?to_char_type@?$char_traits@D@std@@SADABH@Z ; std::char_traits<char>::to_char_type
	add	esp, 4
	mov	BYTE PTR $T152547[ebp], al
	mov	ecx, DWORD PTR _this$[ebp]
	call	?gptr@?$basic_streambuf@DU?$char_traits@D@std@@@std@@IBEPADXZ ; std::basic_streambuf<char,std::char_traits<char> >::gptr
	sub	eax, 1
	push	eax
	lea	ecx, DWORD PTR $T152547[ebp]
	push	ecx
...
; 199  : 			if (!_Traits::eq_int_type(_Traits::eof(), _Meta))
	...
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T152548[ebp], eax
	lea	edx, DWORD PTR __Meta$[ebp]
	push	edx
	lea	eax, DWORD PTR $T152548[ebp]
	push	eax
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	ecx, al
...
; 46   : 	explicit __CLR_OR_THIS_CALL basic_ostream(
	...
	call	??0?$basic_ios@DU?$char_traits@D@std@@@std@@IAE@XZ ; std::basic_ios<char,std::char_traits<char> >::basic_ios<char,std::char_traits<char> >
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	mov	ecx, DWORD PTR $T152575[ebp]
	or	ecx, 1
	mov	DWORD PTR $T152575[ebp], ecx
$LN1@basic_ostr@2:
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx]
...
__unwindfunclet$??0?$basic_ostream@DU?$char_traits@D@std@@@std@@QAE@PAV?$basic_streambuf@DU?$char_traits@D@std@@@1@_N@Z$0:
	mov	eax, DWORD PTR $T152575[ebp]
	and	eax, 1
	je	$LN5@basic_ostr@2
	and	DWORD PTR $T152575[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 8
	jmp	??1?$basic_ios@DU?$char_traits@D@std@@@std@@UAE@XZ ; std::basic_ios<char,std::char_traits<char> >::~basic_ios<char,std::char_traits<char> >
$LN5@basic_ostr@2:
...
; 376  : 		return (_Tmp -= _Off);
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QAE@ABV01@@Z
	mov	edx, DWORD PTR $T152605[ebp]
	or	edx, 1
	mov	DWORD PTR $T152605[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Tmp$[ebp]
	call	??1?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QAE@XZ
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
__unwindfunclet$??G?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QBE?AV01@H@Z$1:
	mov	eax, DWORD PTR $T152605[ebp]
	and	eax, 1
	je	$LN5@operator@5
	and	DWORD PTR $T152605[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QAE@XZ
$LN5@operator@5:
	ret	0
...
tv91 = -148						; size = 4
$T152645 = -144						; size = 4
__Nul$148628 = -136					; size = 32
__Str$148626 = -96					; size = 32
__Str$148623 = -56					; size = 32
_this$ = -20						; size = 4
__$ArrayPad$ = -16					; size = 4
__$EHRec$ = -12						; size = 12
___$ReturnUdt$ = 8					; size = 4
...
$LN8@str:
	...
	call	?pbase@?$basic_streambuf@DU?$char_traits@D@std@@@std@@IBEPADXZ ; std::basic_streambuf<char,std::char_traits<char> >::pbase
	push	eax
	lea	ecx, DWORD PTR __Str$148623[ebp]
...
; 98   : 			return (_Str);
	...
	lea	eax, DWORD PTR __Str$148623[ebp]
	push	eax
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@$$QAV01@@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	ecx, DWORD PTR $T152645[ebp]
	or	ecx, 1
	mov	DWORD PTR $T152645[ebp], ecx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Str$148623[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 102  : 			_Mystr _Str(_Mysb::eback(), _Mysb::egptr() - _Mysb::eback());
	...
	call	?eback@?$basic_streambuf@DU?$char_traits@D@std@@@std@@IBEPADXZ ; std::basic_streambuf<char,std::char_traits<char> >::eback
	push	eax
	lea	ecx, DWORD PTR __Str$148626[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBDI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
...
; 103  : 			return (_Str);
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@$$QAV01@@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	edx, DWORD PTR $T152645[ebp]
	or	edx, 1
	mov	DWORD PTR $T152645[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Str$148626[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 107  : 			_Mystr _Nul;
	...
	lea	ecx, DWORD PTR __Nul$148628[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	DWORD PTR __$EHRec$[ebp+8], 3

; 108  : 			return (_Nul);

	lea	eax, DWORD PTR __Nul$148628[ebp]
	push	eax
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@$$QAV01@@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	ecx, DWORD PTR $T152645[ebp]
...
__unwindfunclet$?str@?$basic_stringbuf@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBE?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@2@XZ$1:
	mov	eax, DWORD PTR $T152645[ebp]
	and	eax, 1
	je	$LN11@str
	and	DWORD PTR $T152645[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
$LN11@str:
	ret	0
...
PUBLIC	??_C@_0EI@NOBAPJGH@C?3?2Program?5Files?5?$CIx86?$CJ?2Microsoft@ ; `string'
...
;	COMDAT ??_C@_0EI@NOBAPJGH@C?3?2Program?5Files?5?$CIx86?$CJ?2Microsoft@
; File c:\program files (x86)\microsoft visual studio 10.0\vc\include\xiosbase
CONST	SEGMENT
??_C@_0EI@NOBAPJGH@C?3?2Program?5Files?5?$CIx86?$CJ?2Microsoft@ DB 'C:\Pr'
...
; 564  : 		_Ploc = _NEW_CRT locale;
	...
	push	564					; 00000234H
	push	OFFSET ??_C@_0EI@NOBAPJGH@C?3?2Program?5Files?5?$CIx86?$CJ?2Microsoft@
	...
	add	esp, 16					; 00000010H
	mov	DWORD PTR $T152712[ebp], eax
	cmp	DWORD PTR $T152712[ebp], 0
	je	SHORT $LN3@Init
	mov	ecx, DWORD PTR $T152712[ebp]
...
PUBLIC	??_C@_0EJ@BBJHPHNJ@C?3?2Program?5Files?5?$CIx86?$CJ?2Microsoft@ ; `string'
EXTRN	??0_Mutex@std@@QAE@XZ:PROC			; std::_Mutex::_Mutex
;	COMDAT ??_C@_0EJ@BBJHPHNJ@C?3?2Program?5Files?5?$CIx86?$CJ?2Microsoft@
; File c:\program files (x86)\microsoft visual studio 10.0\vc\include\streambuf
CONST	SEGMENT
??_C@_0EJ@BBJHPHNJ@C?3?2Program?5Files?5?$CIx86?$CJ?2Microsoft@ DB 'C:\Pr'
...
; 25   : 		{	// construct with no buffers
	...
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	push	24					; 00000018H
	push	OFFSET ??_C@_0EJ@BBJHPHNJ@C?3?2Program?5Files?5?$CIx86?$CJ?2Microsoft@
	call	?_DebugHeapTag_func@std@@YAABU_DebugHeapTag_t@1@XZ ; std::_DebugHeapTag_func
	push	eax
	push	4
	call	??2@YAPAXIABU_DebugHeapTag_t@std@@PADH@Z ; operator new
	add	esp, 16					; 00000010H
	mov	DWORD PTR $T152727[ebp], eax
	cmp	DWORD PTR $T152727[ebp], 0
	je	SHORT $LN3@basic_stre
	mov	ecx, DWORD PTR $T152727[ebp]
	call	??0locale@std@@QAE@XZ			; std::locale::locale
	mov	DWORD PTR tv79[ebp], eax
...
_TEXT	SEGMENT
__Size$148666 = -28					; size = 4
__Ptr$148659 = -24					; size = 4
_this$ = -20						; size = 4
__$EHRec$ = -16						; size = 16
__Count$ = 8						; size = 4
...
; 751  : 			pointer _Ptr = this->_Alval.allocate(_Count);
	...
	mov	DWORD PTR __Ptr$148659[ebp], eax
...
; 754  : 			_Umove(this->_Myfirst, this->_Mylast, _Ptr);
	...
	mov	ecx, DWORD PTR __Ptr$148659[ebp]
	push	ecx
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+8]
	push	eax
...
; 760  : 			size_type _Size = size();
	...
	mov	ecx, DWORD PTR _this$[ebp]
	call	?size@?$vector@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@QBEIXZ ; std::vector<std::basic_string<char,std::char_traits<char>,std::allocator<char> >,std::allocator<std::basic_string<char,std::char_traits<char>,std::allocator<char> > > >::size
	mov	DWORD PTR __Size$148666[ebp], eax
...
; 769  : 			this->_Myend = _Ptr + _Count;
	...
	mov	eax, DWORD PTR __Count$[ebp]
	shl	eax, 5
	add	eax, DWORD PTR __Ptr$148659[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [ecx+12], eax

; 770  : 			this->_Mylast = _Ptr + _Size;

	mov	edx, DWORD PTR __Size$148666[ebp]
	shl	edx, 5
	add	edx, DWORD PTR __Ptr$148659[ebp]
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+8], edx
...
; 771  : 			this->_Myfirst = _Ptr;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR __Ptr$148659[ebp]
	mov	DWORD PTR [ecx+4], edx
$LN7@reserve:
...
; 88   : 	_Destroy_range(_First, _Last, _Al, _Ptr_cat(_First, _Last));
	...
	add	esp, 8
	mov	BYTE PTR $T152758[ebp], al
	movzx	edx, BYTE PTR $T152758[ebp]
	push	edx
...
; 320  : 			_Elem *_Pnew = _Al.allocate(_Count);
	...
	add	ecx, 68					; 00000044H
	call	?allocate@?$allocator@D@std@@QAEPADI@Z	; std::allocator<char>::allocate
	mov	DWORD PTR __Pnew$148733[ebp], eax
...
; 321  : 			_Traits::copy(_Pnew, _Ptr, _Count);
	...
	mov	ecx, DWORD PTR __Ptr$[ebp]
	push	ecx
	mov	edx, DWORD PTR __Pnew$148733[ebp]
	push	edx
	call	?copy@?$char_traits@D@std@@SAPADPADPBDI@Z ; std::char_traits<char>::copy
	add	esp, 12					; 0000000cH
...
; 322  : 			_Seekhigh = _Pnew + _Count;
	...
	mov	eax, DWORD PTR __Pnew$148733[ebp]
	add	eax, DWORD PTR __Count$[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [ecx+60], eax
...
; 326  : 					_Pnew + _Count);	// setup read buffer
	...
	mov	ecx, DWORD PTR __Pnew$148733[ebp]
...
; 452  : 		return (*_Ploc);
	...
	mov	edx, DWORD PTR $T152800[ebp]
	or	edx, 1
	mov	DWORD PTR $T152800[ebp], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
$T152807 = -64						; size = 4
$T152806 = -60						; size = 12
__Pfmod$146582 = -48					; size = 4
__Pf$146566 = -44					; size = 4
__Id$146565 = -40					; size = 4
__Psave$146553 = -32					; size = 4
__Lock$146552 = -20					; size = 4
__$EHRec$ = -12						; size = 12
__Loc$ = 8						; size = 4
...
; 505  : 	_BEGIN_LOCK(_LOCK_LOCALE)	// the thread lock, make get atomic
	...
	push	0
	lea	ecx, DWORD PTR __Lock$146552[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
	mov	DWORD PTR __$EHRec$[ebp+8], 0
...
; 507  : 			_Facetptr<_Facet>::_Psave;	// static pointer to lazy facet
	...
	mov	DWORD PTR __Psave$146553[ebp], eax
...
; 514  : 		else if (_Psave != 0)
	...
	cmp	DWORD PTR __Psave$146553[ebp], 0
	je	SHORT $LN4@use_facet

; 515  : 			_Pf = _Psave;	// lazy facet already allocated

	mov	edx, DWORD PTR __Psave$146553[ebp]
	mov	DWORD PTR __Pf$146566[ebp], edx
	jmp	SHORT $LN5@use_facet
$LN4@use_facet:
...
; 516  : 		else if (_Facet::_Getcat(&_Psave, &_Loc) == (size_t)(-1))
	...
	push	eax
	lea	ecx, DWORD PTR __Psave$146553[ebp]
	push	ecx
...
; 520  : 			_THROW_NCEE(bad_cast, _EMPTY_ARGUMENT);	// lazy disallowed
	...
	lea	ecx, DWORD PTR $T152806[ebp]
	call	??0bad_cast@std@@QAE@PBD@Z		; std::bad_cast::bad_cast
	push	OFFSET __TI2?AVbad_cast@std@@
	lea	edx, DWORD PTR $T152806[ebp]
	push	edx
	call	__CxxThrowException@8
...
; 528  : 			_Pf = _Psave;
	...
	mov	eax, DWORD PTR __Psave$146553[ebp]
	mov	DWORD PTR __Pf$146566[ebp], eax

; 529  : 			_Facetptr<_Facet>::_Psave = _Psave;

	mov	ecx, DWORD PTR __Psave$146553[ebp]
...
; 531  : 			locale::facet *_Pfmod = (_Facet *)_Psave;
	...
	mov	edx, DWORD PTR __Psave$146553[ebp]
	mov	DWORD PTR __Pfmod$146582[ebp], edx

; 532  : 			_Pfmod->_Incref();

	mov	ecx, DWORD PTR __Pfmod$146582[ebp]
	call	?_Incref@facet@locale@std@@QAEXXZ	; std::locale::facet::_Incref
...
; 536  : 		return ((const _Facet&)(*_Pf));	// should be dynamic_cast
	...
	mov	eax, DWORD PTR __Pf$146566[ebp]
	mov	DWORD PTR $T152807[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Lock$146552[ebp]
	call	??1_Lockit@std@@QAE@XZ			; std::_Lockit::~_Lockit
	mov	eax, DWORD PTR $T152807[ebp]
$LN8@use_facet:
...
PUBLIC	??_C@_0EH@KCJCAGHF@C?3?2Program?5Files?5?$CIx86?$CJ?2Microsoft@ ; `string'
;	COMDAT ??_C@_0EH@KCJCAGHF@C?3?2Program?5Files?5?$CIx86?$CJ?2Microsoft@
CONST	SEGMENT
??_C@_0EH@KCJCAGHF@C?3?2Program?5Files?5?$CIx86?$CJ?2Microsoft@ DB 'C:\Pr'
...
$LN5@Getcat:
	...
	mov	DWORD PTR __$EHRec$[ebp+8], 2
	mov	eax, DWORD PTR __Ppf$[ebp]
	mov	ecx, DWORD PTR $T152836[ebp]
	mov	DWORD PTR [eax], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	edx, DWORD PTR $T152843[ebp]
	and	edx, 1
	je	SHORT $LN1@Getcat
	and	DWORD PTR $T152843[ebp], -2		; fffffffeH
	lea	ecx, DWORD PTR $T152839[ebp]
...
; 118  : 		return (::_Getctype());
	...
	lea	eax, DWORD PTR $T152917[ebp]
	push	eax
	call	__Getctype
	add	esp, 4
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR $T152916[ebp], ecx
	mov	edx, DWORD PTR [eax+4]
	mov	DWORD PTR $T152916[ebp+4], edx
	mov	ecx, DWORD PTR [eax+8]
	mov	DWORD PTR $T152916[ebp+8], ecx
	mov	edx, DWORD PTR [eax+12]
	mov	DWORD PTR $T152916[ebp+12], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
	mov	ecx, DWORD PTR $T152916[ebp]
	mov	DWORD PTR [eax], ecx
	mov	edx, DWORD PTR $T152916[ebp+4]
	mov	DWORD PTR [eax+4], edx
	mov	ecx, DWORD PTR $T152916[ebp+8]
	mov	DWORD PTR [eax+8], ecx
	mov	edx, DWORD PTR $T152916[ebp+12]
...
PUBLIC	??_C@_1IO@BKHIAHLO@?$AAC?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?5?$AA?$CI?$AAx?$AA8?$AA6?$AA?$CJ?$AA?2?$AAM?$AAi?$AAc?$AAr?$AAo?$AAs?$AAo?$AAf?$AAt@ ; `string'
;	COMDAT ??_C@_1IO@BKHIAHLO@?$AAC?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?5?$AA?$CI?$AAx?$AA8?$AA6?$AA?$CJ?$AA?2?$AAM?$AAi?$AAc?$AAr?$AAo?$AAs?$AAo?$AAf?$AAt@
CONST	SEGMENT
??_C@_1IO@BKHIAHLO@?$AAC?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?5?$AA?$CI?$AAx?$AA8?$AA6?$AA?$CJ?$AA?2?$AAM?$AAi?$AAc?$AAr?$AAo?$AAs?$AAo?$AAf?$AAt@ DB 'C'
	DB	00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H, 'g', 00H
	DB	'r', 00H, 'a', 00H, 'm', 00H, ' ', 00H, 'F', 00H, 'i', 00H, 'l'
	DB	00H, 'e', 00H, 's', 00H, ' ', 00H, '(', 00H, 'x', 00H, '8', 00H
	DB	'6', 00H, ')', 00H, '\', 00H, 'M', 00H, 'i', 00H, 'c', 00H, 'r'
...
; 2419 : 		_DEBUG_RANGE((const _Elem *)_First, _Last);
	...
	push	2419					; 00000973H
	push	OFFSET ??_C@_1IO@BKHIAHLO@?$AAC?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?5?$AA?$CI?$AAx?$AA8?$AA6?$AA?$CJ?$AA?2?$AAM?$AAi?$AAc?$AAr?$AAo?$AAs?$AAo?$AAf?$AAt@
	mov	eax, DWORD PTR __Last$[ebp]
	push	eax
	mov	ecx, DWORD PTR __First$[ebp]
	push	ecx
...
; 471  : 		_Val_type(_First), _Ptr_cat(_First, _Dest)));
	...
	call	??$_Ptr_cat@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V12@@std@@YA?AU_Nonscalar_ptr_iterator_tag@0@PAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@0@Z ; std::_Ptr_cat<std::basic_string<char,std::char_traits<char>,std::allocator<char> >,std::basic_string<char,std::char_traits<char>,std::allocator<char> > >
	add	esp, 8
	mov	BYTE PTR $T153037[ebp], al
	movzx	edx, BYTE PTR $T153037[ebp]
	push	edx
	mov	eax, DWORD PTR __First$[ebp]
	push	eax
