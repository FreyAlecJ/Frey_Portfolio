#ifndef TARGETING_SYSTEM_ENEMYRANGE_H
#define TARGETING_SYSTEM_ENEMYRANGE_H
...
class Raven_TargetingSystem_EnemyRange :
	public Raven_TargetingSystem
{

public:

	Raven_TargetingSystem_EnemyRange(Raven_Bot* owner);
