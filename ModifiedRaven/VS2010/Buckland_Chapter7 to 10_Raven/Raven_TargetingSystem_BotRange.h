#ifndef TARGETING_SYSTEM_BOTRANGE_H
#define TARGETING_SYSTEM_BOTRANGE_H
...
class Raven_TargetingSystem_BotRange :
	public Raven_TargetingSystem
{

public:

	Raven_TargetingSystem_BotRange(Raven_Bot* owner);
