; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.30319.01 
	...
	TITLE	C:\Users\Alec\Desktop\GameAISource\VS2010\Buckland_Chapter7 to 10_Raven\triggers\Trigger_HealthGiver.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_colors	DD	0ffH
	...
	DD	0c8c8c8H
	DD	0e6e6ffH
$SG132524 DB	'DefaultGiverTriggerRange', 00H
	ORG $+3
$SG132526 DB	'Health_RespawnDelay', 00H
CONST	ENDS
...
; File c:\users\alec\desktop\gameaisource\vs2010\buckland_chapter7 to 10_raven\triggers\trigger_healthgiver.cpp
rdata$r	SEGMENT
...
; 36   :     const int sz = 5;
	...
	mov	DWORD PTR _sz$132407[ebp], 5
...
; 57   :   AddCircularTriggerRegion(Pos(), script->GetDouble("DefaultGiverTriggerRange"));
	...
	push	OFFSET $SG132524
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	sub	esp, 8
	fstp	QWORD PTR [esp]
	lea	edx, DWORD PTR $T141086[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Pos@BaseGameEntity@@QBE?AUVector2D@@XZ	; BaseGameEntity::Pos
	sub	esp, 16					; 00000010H
...
; Function compile flags: /Odtp /RTCsu
; File c:\users\alec\desktop\gameaisource\vs2010\common\script\scriptor.h
...
$T141110 = -76						; size = 8
$T141107 = -68						; size = 4
__Nget_fac$132990 = -64					; size = 4
__Tmp$132989 = -56					; size = 4
__Ok$ = -44						; size = 8
__State$ = -28						; size = 4
_this$ = -20						; size = 4
__$EHRec$ = -16						; size = 16
...
; 279  : 			long _Tmp = 0;
	...
	mov	DWORD PTR __Tmp$132989[ebp], 0
...
; 280  : 			const _Nget& _Nget_fac = _USE(ios_base::getloc(), _Nget);
	...
	add	esp, 4
	mov	DWORD PTR __Nget_fac$132990[ebp], eax
...
$LN9@operator:
	...
	lea	eax, DWORD PTR __Tmp$132989[ebp]
	push	eax
	...
	mov	edx, DWORD PTR [eax]
	push	edx
	lea	eax, DWORD PTR $T141112[ebp]
	push	eax
	mov	ecx, DWORD PTR __Nget_fac$132990[ebp]
...
; 288  : 				|| _Tmp < INT_MIN || INT_MAX < _Tmp)
	...
	cmp	DWORD PTR __Tmp$132989[ebp], -2147483648 ; 80000000H
	jl	SHORT $LN2@operator
	cmp	DWORD PTR __Tmp$132989[ebp], 2147483647	; 7fffffffH
...
; 291  : 				_Val = _Tmp;
	...
	mov	eax, DWORD PTR __Tmp$132989[ebp]
...
; 123  : 				return (_Refs == 0 ? this : 0);
	...
	mov	DWORD PTR $T141138[ebp], eax
	lea	ecx, DWORD PTR __Lock$32796[ebp]
	call	??1_Lockit@std@@QAE@XZ			; std::_Lockit::~_Lockit
	mov	eax, DWORD PTR $T141138[ebp]
...
; 452  : 		return (*_Ploc);
	...
	mov	edx, DWORD PTR $T141146[ebp]
	or	edx, 1
	mov	DWORD PTR $T141146[ebp], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 417  : 			const _Nget& _Nget_fac = _USE(ios_base::getloc(), _Nget);
	...
	call	??$use_facet@V?$num_get@DV?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@@std@@YAABV?$num_get@DV?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@@0@ABVlocale@0@@Z ; std::use_facet<std::num_get<char,std::istreambuf_iterator<char,std::char_traits<char> > > >
	add	esp, 4
	mov	DWORD PTR __Nget_fac$133262[ebp], eax
	mov	BYTE PTR __$EHRec$[ebp+12], 0
	lea	ecx, DWORD PTR $T141167[ebp]
	call	??1locale@std@@QAE@XZ			; std::locale::~locale
...
$LN6@operator@2:
	...
	push	eax
	lea	ecx, DWORD PTR $T141171[ebp]
	call	??0?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@QAE@PAV?$basic_streambuf@DU?$char_traits@D@std@@@1@@Z ; std::istreambuf_iterator<char,std::char_traits<char> >::istreambuf_iterator<char,std::char_traits<char> >
	mov	ecx, DWORD PTR [eax+4]
	push	ecx
	mov	edx, DWORD PTR [eax]
	push	edx
	lea	eax, DWORD PTR $T141172[ebp]
	push	eax
	mov	ecx, DWORD PTR __Nget_fac$133262[ebp]
...
; 426  : 		return (*this);
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR $T141173[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+12], -1
	lea	ecx, DWORD PTR __Ok$[ebp]
	call	??1sentry@?$basic_istream@DU?$char_traits@D@std@@@std@@QAE@XZ
	mov	eax, DWORD PTR $T141173[ebp]
...
; Function compile flags: /Odtp /RTCsu
; File c:\users\alec\desktop\gameaisource\vs2010\common\triggers\trigger_respawning.h
...
; 37   :     m_iNumUpdatesRemainingUntilRespawn = m_iNumUpdatesBetweenRespawns;
...
PUBLIC	?ToggleAboutToSpawn@?$Trigger@VRaven_Bot@@@@QAEXXZ ; Trigger<Raven_Bot>::ToggleAboutToSpawn
; Function compile flags: /Odtp /RTCsu
...
; 58   : 	  if (--m_iNumUpdatesRemainingUntilRespawn == 15)
...
; 59   : 	  {
; 60   : 		  Trigger<entity_type>::ToggleAboutToSpawn();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?ToggleAboutToSpawn@?$Trigger@VRaven_Bot@@@@QAEXXZ ; Trigger<Raven_Bot>::ToggleAboutToSpawn
	jmp	SHORT $LN4@Update
$LN3@Update:

; 61   : 	   }
; 62   :     else if ( (--m_iNumUpdatesRemainingUntilRespawn <= 0) && !isActive())
...
; 65   : 	  Trigger<entity_type>::ToggleAboutToSpawn();
...
; 70   :   {m_iNumUpdatesBetweenRespawns = numTicks;}
...
; Function compile flags: /Odtp /RTCsu
; File c:\users\alec\desktop\gameaisource\vs2010\common\triggers\trigger.h
_TEXT	ENDS
...
; 46   :   void SetGraphNodeIndex(int idx){m_iGraphNodeIndex = idx;}
...
; 77   :   virtual ~Trigger(){delete m_pRegionOfInfluence;}
	...
	mov	DWORD PTR $T141225[ebp], edx
	mov	eax, DWORD PTR $T141225[ebp]
	mov	DWORD PTR $T141224[ebp], eax
	cmp	DWORD PTR $T141224[ebp], 0
	je	SHORT $LN3@Trigger
	mov	esi, esp
	push	1
	mov	ecx, DWORD PTR $T141224[ebp]
	mov	edx, DWORD PTR [ecx]
	mov	ecx, DWORD PTR $T141224[ebp]
	mov	eax, DWORD PTR [edx]
	call	eax
...
; 319  : 			_THROW_NCEE(failure, "ios_base::failbit set");
	...
	push	1
	lea	edx, DWORD PTR $T141257[ebp]
	push	edx
	call	?make_error_code@std@@YA?AVerror_code@1@W4io_errc@31@@Z ; std::make_error_code
	add	esp, 8
	push	eax
	push	OFFSET ??_C@_0BG@FMKFHCIL@ios_base?3?3failbit?5set?$AA@
	lea	ecx, DWORD PTR $T141256[ebp]
	call	??0failure@ios_base@std@@QAE@PBDABVerror_code@2@@Z ; std::ios_base::failure::failure
	push	OFFSET __TI4?AVfailure@ios_base@std@@
	lea	eax, DWORD PTR $T141256[ebp]
	push	eax
	call	__CxxThrowException@8
...
; 321  : 			_THROW_NCEE(failure, "ios_base::eofbit set");
	...
	push	1
	lea	ecx, DWORD PTR $T141259[ebp]
	push	ecx
	call	?make_error_code@std@@YA?AVerror_code@1@W4io_errc@31@@Z ; std::make_error_code
	add	esp, 8
	push	eax
	push	OFFSET ??_C@_0BF@OOHOMBOF@ios_base?3?3eofbit?5set?$AA@
	lea	ecx, DWORD PTR $T141258[ebp]
	call	??0failure@ios_base@std@@QAE@PBDABVerror_code@2@@Z ; std::ios_base::failure::failure
	push	OFFSET __TI4?AVfailure@ios_base@std@@
	lea	edx, DWORD PTR $T141258[ebp]
	push	edx
	call	__CxxThrowException@8
$LN10@clear@2:
...
$T141308 = -44						; size = 4
$T141307 = -40						; size = 4
__Meta$134496 = -32					; size = 4
__Ctype_fac$134492 = -24				; size = 4
_this$ = -20						; size = 4
__$EHRec$ = -16						; size = 16
__Noskip$ = 8						; size = 1
...
; 124  : 				const _Ctype& _Ctype_fac = _USE(ios_base::getloc(), _Ctype);
	...
	add	esp, 4
	mov	DWORD PTR __Ctype_fac$134492[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+12], -1
	lea	ecx, DWORD PTR $T141307[ebp]
	call	??1locale@std@@QAE@XZ			; std::locale::~locale
...
; 127  : 				int_type _Meta = _Myios::rdbuf()->sgetc();
	...
	mov	DWORD PTR __Meta$134496[ebp], ecx
	jmp	SHORT $LN7@Ipfx
$LN6@Ipfx:
...
; 130  : 					if (_Traits::eq_int_type(_Traits::eof(), _Meta))
	...
	mov	DWORD PTR $T141308[ebp], edx
	lea	eax, DWORD PTR __Meta$134496[ebp]
	push	eax
...
; 136  : 						_Traits::to_char_type(_Meta)))
	...
	push	ecx
	push	72					; 00000048H
	mov	ecx, DWORD PTR __Ctype_fac$134492[ebp]
...
$LN5@snextc:
	...
	mov	DWORD PTR $T141351[ebp], eax
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T141352[ebp], eax
	lea	eax, DWORD PTR $T141351[ebp]
	push	eax
	lea	ecx, DWORD PTR $T141352[ebp]
	push	ecx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	edx, al
...
; 49   :   void SetInactive(){m_bActive = false;}
...
; 50   :   void SetActive(){m_bActive = true;}
...
; 70   :   {
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	BYTE PTR [ecx+70], 1
	mov	edx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [edx+72], -1

; 71   : 	  aboutToSpawn = false;
...
; Function compile flags: /Odtp /RTCsu
_TEXT	ENDS
;	COMDAT ?ToggleAboutToSpawn@?$Trigger@VRaven_Bot@@@@QAEXXZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?ToggleAboutToSpawn@?$Trigger@VRaven_Bot@@@@QAEXXZ PROC	; Trigger<Raven_Bot>::ToggleAboutToSpawn, COMDAT
; _this$ = ecx

; 74   :   void ToggleAboutToSpawn() { aboutToSpawn = !aboutToSpawn; }
	...
	pop	ebp
	ret	0
?ToggleAboutToSpawn@?$Trigger@VRaven_Bot@@@@QAEXXZ ENDP	; Trigger<Raven_Bot>::ToggleAboutToSpawn
; Function compile flags: /Odtp /RTCsu
...
$T141399 = -64						; size = 4
$T141398 = -60						; size = 12
__Pfmod$136390 = -48					; size = 4
__Pf$136374 = -44					; size = 4
__Id$136373 = -40					; size = 4
__Psave$136361 = -32					; size = 4
__Lock$136360 = -20					; size = 4
__$EHRec$ = -12						; size = 12
__Loc$ = 8						; size = 4
...
; 505  : 	_BEGIN_LOCK(_LOCK_LOCALE)	// the thread lock, make get atomic
	...
	push	0
	lea	ecx, DWORD PTR __Lock$136360[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
	mov	DWORD PTR __$EHRec$[ebp+8], 0
...
; 507  : 			_Facetptr<_Facet>::_Psave;	// static pointer to lazy facet
	...
	mov	DWORD PTR __Psave$136361[ebp], eax
...
; 514  : 		else if (_Psave != 0)
	...
	cmp	DWORD PTR __Psave$136361[ebp], 0
	je	SHORT $LN4@use_facet

; 515  : 			_Pf = _Psave;	// lazy facet already allocated

	mov	edx, DWORD PTR __Psave$136361[ebp]
	mov	DWORD PTR __Pf$136374[ebp], edx
	jmp	SHORT $LN5@use_facet
$LN4@use_facet:
...
; 516  : 		else if (_Facet::_Getcat(&_Psave, &_Loc) == (size_t)(-1))
	...
	push	eax
	lea	ecx, DWORD PTR __Psave$136361[ebp]
	push	ecx
...
; 520  : 			_THROW_NCEE(bad_cast, _EMPTY_ARGUMENT);	// lazy disallowed
	...
	lea	ecx, DWORD PTR $T141398[ebp]
	call	??0bad_cast@std@@QAE@PBD@Z		; std::bad_cast::bad_cast
	push	OFFSET __TI2?AVbad_cast@std@@
	lea	edx, DWORD PTR $T141398[ebp]
	push	edx
	call	__CxxThrowException@8
...
; 528  : 			_Pf = _Psave;
	...
	mov	eax, DWORD PTR __Psave$136361[ebp]
	mov	DWORD PTR __Pf$136374[ebp], eax

; 529  : 			_Facetptr<_Facet>::_Psave = _Psave;

	mov	ecx, DWORD PTR __Psave$136361[ebp]
...
; 531  : 			locale::facet *_Pfmod = (_Facet *)_Psave;
	...
	mov	edx, DWORD PTR __Psave$136361[ebp]
	mov	DWORD PTR __Pfmod$136390[ebp], edx

; 532  : 			_Pfmod->_Incref();

	mov	ecx, DWORD PTR __Pfmod$136390[ebp]
	call	?_Incref@facet@locale@std@@QAEXXZ	; std::locale::facet::_Incref
...
; 536  : 		return ((const _Facet&)(*_Pf));	// should be dynamic_cast
	...
	mov	eax, DWORD PTR __Pf$136374[ebp]
	mov	DWORD PTR $T141399[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Lock$136360[ebp]
	call	??1_Lockit@std@@QAE@XZ			; std::_Lockit::~_Lockit
	mov	eax, DWORD PTR $T141399[ebp]
$LN8@use_facet:
...
; 2374 : 				_Locinfo(_Ploc->c_str()));
	...
	add	esp, 16					; 00000010H
	mov	DWORD PTR $T141429[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T141429[ebp], 0
	je	SHORT $LN4@Getcat
	push	0
	mov	ecx, DWORD PTR __Ploc$[ebp]
	call	?c_str@locale@std@@QBEPBDXZ		; std::locale::c_str
	push	eax
	lea	ecx, DWORD PTR $T141431[ebp]
	call	??0_Locinfo@std@@QAE@PBD@Z		; std::_Locinfo::_Locinfo
	mov	DWORD PTR tv138[ebp], eax
	mov	edx, DWORD PTR tv138[ebp]
	mov	DWORD PTR tv133[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 1
	mov	eax, DWORD PTR $T141435[ebp]
	or	eax, 1
	mov	DWORD PTR $T141435[ebp], eax
	mov	ecx, DWORD PTR tv133[ebp]
	push	ecx
	mov	ecx, DWORD PTR $T141429[ebp]
...
$LN5@Getcat:
	...
	mov	DWORD PTR $T141428[ebp], edx
	mov	DWORD PTR __$EHRec$[ebp+8], 2
	mov	eax, DWORD PTR __Ppf$[ebp]
	mov	ecx, DWORD PTR $T141428[ebp]
	mov	DWORD PTR [eax], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	edx, DWORD PTR $T141435[ebp]
	and	edx, 1
	je	SHORT $LN1@Getcat
	and	DWORD PTR $T141435[ebp], -2		; fffffffeH
	lea	ecx, DWORD PTR $T141431[ebp]
...
; 78   :             _THROW_NCEE(runtime_error, "bad locale name");
	...
	lea	ecx, DWORD PTR $T141447[ebp]
	call	??0runtime_error@std@@QAE@PBD@Z		; std::runtime_error::runtime_error
	push	OFFSET __TI2?AVruntime_error@std@@
	lea	eax, DWORD PTR $T141447[ebp]
	push	eax
	call	__CxxThrowException@8
$LN1@Locinfo:
...
; 118  : 		return (::_Getctype());
	...
	lea	eax, DWORD PTR $T141509[ebp]
	push	eax
	call	__Getctype
	add	esp, 4
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR $T141508[ebp], ecx
	mov	edx, DWORD PTR [eax+4]
	mov	DWORD PTR $T141508[ebp+4], edx
	mov	ecx, DWORD PTR [eax+8]
	mov	DWORD PTR $T141508[ebp+8], ecx
	mov	edx, DWORD PTR [eax+12]
	mov	DWORD PTR $T141508[ebp+12], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
	mov	ecx, DWORD PTR $T141508[ebp]
	mov	DWORD PTR [eax], ecx
	mov	edx, DWORD PTR $T141508[ebp+4]
	mov	DWORD PTR [eax+4], edx
	mov	ecx, DWORD PTR $T141508[ebp+8]
	mov	DWORD PTR [eax+8], ecx
	mov	edx, DWORD PTR $T141508[ebp+12]
	mov	DWORD PTR [eax+12], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 2408 : 			delete[] (void *)_Ctype._Table;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+16]
	mov	DWORD PTR $T141539[ebp], edx
	mov	eax, DWORD PTR $T141539[ebp]
	push	eax
...
; 125  :   {
; 126  :     return m_pRegionOfInfluence->isTouching(EntityPos, EntityRadius);
...
; 100  :   //if this replaces an existing region, tidy up memory
; 101  :   if (m_pRegionOfInfluence) delete m_pRegionOfInfluence;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+64]
	mov	DWORD PTR $T141560[ebp], edx
	mov	eax, DWORD PTR $T141560[ebp]
	mov	DWORD PTR $T141559[ebp], eax
	cmp	DWORD PTR $T141559[ebp], 0
	je	SHORT $LN4@AddCircula
	mov	esi, esp
	push	1
	mov	ecx, DWORD PTR $T141559[ebp]
	mov	edx, DWORD PTR [ecx]
	mov	ecx, DWORD PTR $T141559[ebp]
	mov	eax, DWORD PTR [edx]
	call	eax
...
; 102  : 
; 103  :   m_pRegionOfInfluence = new TriggerRegion_Circle(center, radius);

	push	32					; 00000020H
	call	??2@YAPAXI@Z				; operator new
	add	esp, 4
	mov	DWORD PTR $T141564[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T141564[ebp], 0
...
$LN7@AddCircula:
	...
	mov	DWORD PTR $T141563[ebp], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR $T141563[ebp]
...
; File c:\users\alec\desktop\gameaisource\vs2010\common\triggers\triggerregion.h
rdata$r	SEGMENT
...
; File c:\users\alec\desktop\gameaisource\vs2010\common\lua-5.1.3\include\luahelperfunctions.h
CONST	SEGMENT
...
; 64   :     std::string err("<PopLuaNumber> Cannot retrieve: ");
	...
	lea	ecx, DWORD PTR _err$136935[ebp]
...
; 66   :     throw std::runtime_error(err + name);
	...
	mov	ecx, DWORD PTR _name$[ebp]
	push	ecx
	lea	edx, DWORD PTR _err$136935[ebp]
	push	edx
	lea	eax, DWORD PTR $T136936[ebp]
	push	eax
...
; 165  : 		{	// construct from message string
	...
	mov	DWORD PTR $T141611[ebp], eax
	lea	eax, DWORD PTR $T141611[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	??0exception@std@@QAE@ABQBD@Z		; std::exception::exception
	mov	ecx, DWORD PTR _this$[ebp]
...
; 1993 : 			_Elem *_Ptr = this->_Bx._Ptr;
	...
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+4]
	mov	DWORD PTR __Ptr$134197[ebp], eax
...
; 1995 : 				_Traits::copy(this->_Bx._Buf, _Ptr, _Newsize);
	...
	push	ecx
	mov	edx, DWORD PTR __Ptr$134197[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	add	eax, 4
	push	eax
...
; 1996 : 			this->_Alval.deallocate(_Ptr, this->_Myres + 1);
	...
	add	edx, 1
	push	edx
	mov	eax, DWORD PTR __Ptr$134197[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 28					; 0000001cH
...
; 1954 : 		_Traits::assign(_Myptr()[this->_Mysize = _Newsize], _Elem());
	...
	mov	BYTE PTR $T141691[ebp], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR __Newsize$[ebp]
	mov	DWORD PTR [eax+20], ecx
	lea	edx, DWORD PTR $T141691[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Myptr@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEPADXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Myptr
...
; 1118 : 			size_type _Newsize = this->_Mysize - _Count;
	...
	mov	DWORD PTR __Newsize$134176[ebp], eax

; 1119 : 			_Eos(_Newsize);

	mov	ecx, DWORD PTR __Newsize$134176[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Eos@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Eos
$LN1@erase:
...
; 69   : 	return (_Ans);
	...
	mov	ecx, DWORD PTR $T141757[ebp]
	or	ecx, 1
	mov	DWORD PTR $T141757[ebp], ecx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Ans$[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
__unwindfunclet$??$?HDU?$char_traits@D@std@@V?$allocator@D@1@@std@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@ABV10@PBD@Z$1:
	mov	eax, DWORD PTR $T141757[ebp]
	and	eax, 1
	je	$LN5@operator@4
	and	DWORD PTR $T141757[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
$LN5@operator@4:
	ret	0
...
$T141821 = -64						; size = 4
$T141820 = -60						; size = 12
__Pfmod$136979 = -48					; size = 4
__Pf$136968 = -44					; size = 4
__Id$136967 = -40					; size = 4
__Psave$136955 = -32					; size = 4
__Lock$136954 = -20					; size = 4
__$EHRec$ = -12						; size = 12
__Loc$ = 8						; size = 4
...
; 505  : 	_BEGIN_LOCK(_LOCK_LOCALE)	// the thread lock, make get atomic
	...
	push	0
	lea	ecx, DWORD PTR __Lock$136954[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
	mov	DWORD PTR __$EHRec$[ebp+8], 0
...
; 507  : 			_Facetptr<_Facet>::_Psave;	// static pointer to lazy facet
	...
	mov	DWORD PTR __Psave$136955[ebp], eax
...
; 509  : 		size_t _Id = _Facet::id;
	...
	call	??Bid@locale@std@@QAEIXZ		; std::locale::id::operator unsigned int
	mov	DWORD PTR __Id$136967[ebp], eax

; 510  : 		const locale::facet *_Pf = _Loc._Getfacet(_Id);

	mov	ecx, DWORD PTR __Id$136967[ebp]
	push	ecx
	mov	ecx, DWORD PTR __Loc$[ebp]
	call	?_Getfacet@locale@std@@QBEPBVfacet@12@I@Z ; std::locale::_Getfacet
	mov	DWORD PTR __Pf$136968[ebp], eax

; 511  : 
; 512  : 		if (_Pf != 0)

	cmp	DWORD PTR __Pf$136968[ebp], 0
...
; 514  : 		else if (_Psave != 0)
	...
	cmp	DWORD PTR __Psave$136955[ebp], 0
	je	SHORT $LN4@use_facet@2

; 515  : 			_Pf = _Psave;	// lazy facet already allocated

	mov	edx, DWORD PTR __Psave$136955[ebp]
	mov	DWORD PTR __Pf$136968[ebp], edx
	jmp	SHORT $LN5@use_facet@2
$LN4@use_facet@2:
...
; 516  : 		else if (_Facet::_Getcat(&_Psave, &_Loc) == (size_t)(-1))
	...
	mov	eax, DWORD PTR __Loc$[ebp]
	push	eax
	lea	ecx, DWORD PTR __Psave$136955[ebp]
	push	ecx
...
; 520  : 			_THROW_NCEE(bad_cast, _EMPTY_ARGUMENT);	// lazy disallowed
	...
	push	OFFSET ??_C@_08EPJLHIJG@bad?5cast?$AA@
	lea	ecx, DWORD PTR $T141820[ebp]
	call	??0bad_cast@std@@QAE@PBD@Z		; std::bad_cast::bad_cast
	push	OFFSET __TI2?AVbad_cast@std@@
	lea	edx, DWORD PTR $T141820[ebp]
	push	edx
	call	__CxxThrowException@8
...
; 528  : 			_Pf = _Psave;
	...
	mov	eax, DWORD PTR __Psave$136955[ebp]
	mov	DWORD PTR __Pf$136968[ebp], eax

; 529  : 			_Facetptr<_Facet>::_Psave = _Psave;

	mov	ecx, DWORD PTR __Psave$136955[ebp]
...
; 531  : 			locale::facet *_Pfmod = (_Facet *)_Psave;
	...
	mov	edx, DWORD PTR __Psave$136955[ebp]
	mov	DWORD PTR __Pfmod$136979[ebp], edx

; 532  : 			_Pfmod->_Incref();

	mov	ecx, DWORD PTR __Pfmod$136979[ebp]
	call	?_Incref@facet@locale@std@@QAEXXZ	; std::locale::facet::_Incref
...
; 536  : 		return ((const _Facet&)(*_Pf));	// should be dynamic_cast
	...
	mov	eax, DWORD PTR __Pf$136968[ebp]
	mov	DWORD PTR $T141821[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Lock$136954[ebp]
	call	??1_Lockit@std@@QAE@XZ			; std::_Lockit::~_Lockit
	mov	eax, DWORD PTR $T141821[ebp]
$LN8@use_facet@2:
...
; 1543 : 			size_type _Size = this->_Mysize;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+20]
	mov	DWORD PTR __Size$137544[ebp], edx
...
; 1545 : 				_Eos(_Size);
	...
	mov	edx, DWORD PTR __Size$137544[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Eos@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Eos
$LN3@reserve:
...
; 246  : 				_Locinfo(_Ploc->c_str()));
	...
	call	?_DebugHeapTag_func@std@@YAABU_DebugHeapTag_t@1@XZ ; std::_DebugHeapTag_func
	mov	DWORD PTR $T141867[ebp], eax
	push	245					; 000000f5H
	push	OFFSET ??_C@_0EH@CBNPAENE@C?3?2Program?5Files?5?$CIx86?$CJ?2Microsoft@
	mov	ecx, DWORD PTR $T141867[ebp]
	push	ecx
	push	16					; 00000010H
	call	??2facet@locale@std@@SAPAXIABU_DebugHeapTag_t@2@PADH@Z ; std::locale::facet::operator new
	add	esp, 16					; 00000010H
	mov	DWORD PTR $T141866[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T141866[ebp], 0
	...
	mov	DWORD PTR tv133[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 1
	mov	eax, DWORD PTR $T141872[ebp]
	or	eax, 1
	mov	DWORD PTR $T141872[ebp], eax
	mov	ecx, DWORD PTR tv133[ebp]
	push	ecx
	mov	ecx, DWORD PTR $T141866[ebp]
...
$LN5@Getcat@2:
	mov	edx, DWORD PTR tv92[ebp]
	mov	DWORD PTR $T141865[ebp], edx
	mov	DWORD PTR __$EHRec$[ebp+8], 2
	mov	eax, DWORD PTR __Ppf$[ebp]
	mov	ecx, DWORD PTR $T141865[ebp]
	mov	DWORD PTR [eax], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	edx, DWORD PTR $T141872[ebp]
	and	edx, 1
	je	SHORT $LN1@Getcat@2
	and	DWORD PTR $T141872[ebp], -2		; fffffffeH
	lea	ecx, DWORD PTR $T141868[ebp]
	call	??1_Locinfo@std@@QAE@XZ			; std::_Locinfo::~_Locinfo
$LN1@Getcat@2:
...
$T141916 = -208						; size = 4
$T141915 = -204						; size = 4
__Ulo$135029 = -200					; size = 4
__Errno$135028 = -192					; size = 4
__Ep$135027 = -180					; size = 4
__Ac$135026 = -168					; size = 32
$T135015 = -132						; size = 32
$T135013 = -100						; size = 32
__Str$134957 = -64					; size = 32
__Punct_fac$134948 = -28				; size = 4
__Ans$ = -24						; size = 4
_this$ = -20						; size = 4
__$ArrayPad$ = -16					; size = 4
__$EHRec$ = -12						; size = 12
...
; 372  : 			const _Mypunct& _Punct_fac = _USE(_Iosbase.getloc(), _Mypunct);
	...
	add	esp, 4
	mov	DWORD PTR __Punct_fac$134948[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR $T141915[ebp]
	call	??1locale@std@@QAE@XZ			; std::locale::~locale
...
; 373  : 			_Mystr _Str((_Mystrsize)1, (char_type)0);
	...
	push	0
	push	1
	lea	ecx, DWORD PTR __Str$134957[ebp]
...
; 374  : 			_Str += _Punct_fac.falsename();
	...
	lea	ecx, DWORD PTR $T135013[ebp]
	push	ecx
	mov	ecx, DWORD PTR __Punct_fac$134948[ebp]
...
; 385  : 					_Iosbase.getloc()), &_Errno);
	...
	lea	edx, DWORD PTR __First$[ebp]
	push	edx
	lea	eax, DWORD PTR __Ac$135026[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	push	ecx
	...
	add	esp, 24					; 00000018H
	push	eax
	lea	edx, DWORD PTR __Ep$135027[ebp]
	push	edx
	lea	eax, DWORD PTR __Ac$135026[ebp]
	push	eax
	call	__Stoulx
	add	esp, 16					; 00000010H
	mov	DWORD PTR __Ulo$135029[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR $T141916[ebp]
	call	??1locale@std@@QAE@XZ			; std::locale::~locale
...
; 386  : 			if (_Ep != _Ac && _Errno == 0 && _Ulo <= 1)
	...
	mov	ecx, DWORD PTR __Ep$135027[ebp]
	lea	edx, DWORD PTR __Ac$135026[ebp]
	cmp	ecx, edx
	je	SHORT $LN5@do_get
	cmp	DWORD PTR __Errno$135028[ebp], 0
	jne	SHORT $LN5@do_get
	cmp	DWORD PTR __Ulo$135029[ebp], 1
	ja	SHORT $LN5@do_get

; 387  : 				_Ans = _Ulo;

	mov	eax, DWORD PTR __Ulo$135029[ebp]
	mov	DWORD PTR __Ans$[ebp], eax
$LN5@do_get:
...
tv75 = -137						; size = 1
$T142123 = -136						; size = 4
__Pg$135515 = -132					; size = 4
__Pe$135489 = -128					; size = 4
__Group$ = -124						; size = 4
...
; 672  : 		for (char *const _Pe = &_Ac[_MAX_INT_DIG - 1];
	...
	mov	DWORD PTR __Pe$135489[ebp], edx
...
$LN22@Getifld:
	mov	eax, DWORD PTR __Ptr$[ebp]
	cmp	eax, DWORD PTR __Pe$135489[ebp]
...
; 700  : 		for (const char *_Pg = _Grouping.c_str(); _Seendigit && 0 < _Group; )
	...
	lea	ecx, DWORD PTR __Grouping$[ebp]
	call	?c_str@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::c_str
	mov	DWORD PTR __Pg$135515[ebp], eax
$LN12@Getifld:
...
; 701  : 			if (*_Pg == CHAR_MAX)
	...
	mov	eax, DWORD PTR __Pg$135515[ebp]
...
; 707  : 				++_Pg;	// group size okay, advance to next test
	...
	mov	edx, DWORD PTR __Pg$135515[ebp]
	add	edx, 1
	mov	DWORD PTR __Pg$135515[ebp], edx
$LN9@Getifld:
...
$T142142 = -140						; size = 4
$T142139 = -136						; size = 4
__Pg$135588 = -132					; size = 4
__Group$135567 = -128					; size = 4
__Groups$135566 = -120					; size = 32
__Kseparator$135563 = -81				; size = 1
__Pten$ = -80						; size = 4
...
$LN73@Getffld:
	...
	mov	BYTE PTR __Kseparator$135563[ebp], al

; 759  : 			string _Groups((size_t)1, '\0');

	push	0
	push	1
	lea	ecx, DWORD PTR __Groups$135566[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@ID@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	BYTE PTR __$EHRec$[ebp+8], 2

; 760  : 			size_t _Group = 0;

	mov	DWORD PTR __Group$135567[ebp], 0
...
; 775  : 					if (_Groups[_Group] != CHAR_MAX)
	...
	mov	eax, DWORD PTR __Group$135567[ebp]
	push	eax
	lea	ecx, DWORD PTR __Groups$135566[ebp]
	call	??A?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAADI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::operator[]
	movsx	ecx, BYTE PTR [eax]
...
; 776  : 						++_Groups[_Group];
	...
	mov	edx, DWORD PTR __Group$135567[ebp]
	push	edx
	lea	ecx, DWORD PTR __Groups$135566[ebp]
	call	??A?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAADI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::operator[]
...
; 780  : 					|| *_First != _Kseparator)
	...
	movsx	edx, BYTE PTR __Kseparator$135563[ebp]
	test	edx, edx
	je	SHORT $LN42@Getffld
	mov	ecx, DWORD PTR __First$[ebp]
	call	??D?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@QBEDXZ ; std::istreambuf_iterator<char,std::char_traits<char> >::operator*
	movsx	eax, al
	movsx	ecx, BYTE PTR __Kseparator$135563[ebp]
	cmp	eax, ecx
...
; 785  : 					++_Group;
	...
	mov	edx, DWORD PTR __Group$135567[ebp]
	add	edx, 1
	mov	DWORD PTR __Group$135567[ebp], edx
$LN44@Getffld:
...
; 787  : 			if (_Group == 0)
	...
	cmp	DWORD PTR __Group$135567[ebp], 0
...
; 794  : 			for (const char *_Pg = _Grouping.c_str();
	...
	lea	ecx, DWORD PTR __Grouping$[ebp]
	call	?c_str@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::c_str
	mov	DWORD PTR __Pg$135588[ebp], eax
$LN36@Getffld:
...
; 796  : 				if (*_Pg == CHAR_MAX)
	...
	mov	ecx, DWORD PTR __Pg$135588[ebp]
	movsx	edx, BYTE PTR [ecx]
	cmp	edx, 127				; 0000007fH
...
; 799  : 					|| 0 == _Group && *_Pg < _Groups[_Group])
	...
	mov	eax, DWORD PTR __Group$135567[ebp]
	sub	eax, 1
	mov	DWORD PTR __Group$135567[ebp], eax
...
; 802  : 					++_Pg;	// group size okay, advance to next test
	...
	mov	eax, DWORD PTR __Pg$135588[ebp]
	add	eax, 1
	mov	DWORD PTR __Pg$135588[ebp], eax
$LN33@Getffld:
...
; 859  : 		return (_Pten);
	...
	mov	ecx, DWORD PTR __Pten$[ebp]
	mov	DWORD PTR $T142142[ebp], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Grouping$[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR $T142142[ebp]
$LN70@Getffld:
...
; 84   : 		return (do_falsename());
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	ecx, DWORD PTR $T142159[ebp]
	or	ecx, 1
	mov	DWORD PTR $T142159[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 89   : 		return (do_truename());
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	ecx, DWORD PTR $T142164[ebp]
	or	ecx, 1
	mov	DWORD PTR $T142164[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
$T142174 = -148						; size = 4
$T142171 = -144						; size = 4
__Pg$135879 = -140					; size = 4
__Group$135859 = -136					; size = 4
__Groups$135858 = -128					; size = 32
__Kseparator$135855 = -89				; size = 1
__Phex$ = -88						; size = 4
...
$LN78@Getffldx:
	...
	mov	BYTE PTR __Kseparator$135855[ebp], cl

; 928  : 			string _Groups((size_t)1, '\0');

	push	0
	push	1
	lea	ecx, DWORD PTR __Groups$135858[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@ID@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	BYTE PTR __$EHRec$[ebp+8], 2

; 929  : 			size_t _Group = 0;

	mov	DWORD PTR __Group$135859[ebp], 0
...
; 944  : 					if (_Groups[_Group] != CHAR_MAX)
	...
	mov	eax, DWORD PTR __Group$135859[ebp]
	push	eax
	lea	ecx, DWORD PTR __Groups$135858[ebp]
	call	??A?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAADI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::operator[]
	movsx	ecx, BYTE PTR [eax]
...
; 945  : 						++_Groups[_Group];
	...
	mov	edx, DWORD PTR __Group$135859[ebp]
	push	edx
	lea	ecx, DWORD PTR __Groups$135858[ebp]
	call	??A?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAADI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::operator[]
...
; 949  : 					|| *_First != _Kseparator)
	...
	movsx	edx, BYTE PTR __Kseparator$135855[ebp]
	test	edx, edx
	je	SHORT $LN42@Getffldx
	mov	ecx, DWORD PTR __First$[ebp]
	call	??D?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@QBEDXZ ; std::istreambuf_iterator<char,std::char_traits<char> >::operator*
	movsx	eax, al
	movsx	ecx, BYTE PTR __Kseparator$135855[ebp]
	cmp	eax, ecx
...
; 954  : 					++_Group;
	...
	mov	edx, DWORD PTR __Group$135859[ebp]
	add	edx, 1
	mov	DWORD PTR __Group$135859[ebp], edx
$LN44@Getffldx:
...
; 956  : 			if (_Group == 0)
	...
	cmp	DWORD PTR __Group$135859[ebp], 0
...
; 963  : 			for (const char *_Pg = _Grouping.c_str();
	...
	lea	ecx, DWORD PTR __Grouping$[ebp]
	call	?c_str@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::c_str
	mov	DWORD PTR __Pg$135879[ebp], eax
$LN36@Getffldx:
...
; 965  : 				if (*_Pg == CHAR_MAX)
	...
	mov	ecx, DWORD PTR __Pg$135879[ebp]
	movsx	edx, BYTE PTR [ecx]
	cmp	edx, 127				; 0000007fH
...
; 968  : 					|| 0 == _Group && *_Pg < _Groups[_Group])
	...
	mov	eax, DWORD PTR __Group$135859[ebp]
	sub	eax, 1
	mov	DWORD PTR __Group$135859[ebp], eax
...
; 971  : 					++_Pg;	// group size okay, advance to next test
	...
	mov	eax, DWORD PTR __Pg$135879[ebp]
	add	eax, 1
	mov	DWORD PTR __Pg$135879[ebp], eax
$LN33@Getffldx:
...
; 1029 : 		return (0);	// power of 10 multiplier
	...
	mov	DWORD PTR $T142174[ebp], 0
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Grouping$[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR $T142174[ebp]
...
; 79   : 		return (do_grouping());
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	ecx, DWORD PTR $T142199[ebp]
	or	ecx, 1
	mov	DWORD PTR $T142199[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 548  : 				_Strbuf->sbumpc()))
	...
	mov	ecx, DWORD PTR [ecx]
	call	?sbumpc@?$basic_streambuf@DU?$char_traits@D@std@@@std@@QAEHXZ ; std::basic_streambuf<char,std::char_traits<char> >::sbumpc
	mov	DWORD PTR $T142205[ebp], eax
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T142206[ebp], eax
	lea	edx, DWORD PTR $T142205[ebp]
	push	edx
...
; 559  : 				_Meta = _Strbuf->sgetc()))
	...
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T142209[ebp], eax
	lea	edx, DWORD PTR __Meta$[ebp]
	push	edx
	lea	eax, DWORD PTR $T142209[ebp]
	push	eax
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	ecx, al
...
; 728  : 	_Debug_range2(_First, _Last, _File, _Line, _Iter_cat(_First));
	...
	add	esp, 4
	mov	BYTE PTR $T142215[ebp], al
	movzx	ecx, BYTE PTR $T142215[ebp]
	push	ecx
...
$T142219 = -64						; size = 4
$T142218 = -60						; size = 12
__Pfmod$137156 = -48					; size = 4
__Pf$137145 = -44					; size = 4
__Id$137144 = -40					; size = 4
__Psave$137132 = -32					; size = 4
__Lock$137131 = -20					; size = 4
__$EHRec$ = -12						; size = 12
__Loc$ = 8						; size = 4
...
; 505  : 	_BEGIN_LOCK(_LOCK_LOCALE)	// the thread lock, make get atomic
	...
	push	0
	lea	ecx, DWORD PTR __Lock$137131[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
	mov	DWORD PTR __$EHRec$[ebp+8], 0
...
; 507  : 			_Facetptr<_Facet>::_Psave;	// static pointer to lazy facet
	...
	mov	DWORD PTR __Psave$137132[ebp], eax
...
; 509  : 		size_t _Id = _Facet::id;
	...
	call	??Bid@locale@std@@QAEIXZ		; std::locale::id::operator unsigned int
	mov	DWORD PTR __Id$137144[ebp], eax

; 510  : 		const locale::facet *_Pf = _Loc._Getfacet(_Id);

	mov	ecx, DWORD PTR __Id$137144[ebp]
	push	ecx
	mov	ecx, DWORD PTR __Loc$[ebp]
	call	?_Getfacet@locale@std@@QBEPBVfacet@12@I@Z ; std::locale::_Getfacet
	mov	DWORD PTR __Pf$137145[ebp], eax

; 511  : 
; 512  : 		if (_Pf != 0)

	cmp	DWORD PTR __Pf$137145[ebp], 0
...
; 514  : 		else if (_Psave != 0)
	...
	cmp	DWORD PTR __Psave$137132[ebp], 0
	je	SHORT $LN4@use_facet@3

; 515  : 			_Pf = _Psave;	// lazy facet already allocated

	mov	edx, DWORD PTR __Psave$137132[ebp]
	mov	DWORD PTR __Pf$137145[ebp], edx
	jmp	SHORT $LN5@use_facet@3
$LN4@use_facet@3:
...
; 516  : 		else if (_Facet::_Getcat(&_Psave, &_Loc) == (size_t)(-1))
	...
	mov	eax, DWORD PTR __Loc$[ebp]
	push	eax
	lea	ecx, DWORD PTR __Psave$137132[ebp]
	push	ecx
...
; 520  : 			_THROW_NCEE(bad_cast, _EMPTY_ARGUMENT);	// lazy disallowed
	...
	push	OFFSET ??_C@_08EPJLHIJG@bad?5cast?$AA@
	lea	ecx, DWORD PTR $T142218[ebp]
	call	??0bad_cast@std@@QAE@PBD@Z		; std::bad_cast::bad_cast
	push	OFFSET __TI2?AVbad_cast@std@@
	lea	edx, DWORD PTR $T142218[ebp]
	push	edx
	call	__CxxThrowException@8
...
; 528  : 			_Pf = _Psave;
	...
	mov	eax, DWORD PTR __Psave$137132[ebp]
	mov	DWORD PTR __Pf$137145[ebp], eax

; 529  : 			_Facetptr<_Facet>::_Psave = _Psave;

	mov	ecx, DWORD PTR __Psave$137132[ebp]
...
; 531  : 			locale::facet *_Pfmod = (_Facet *)_Psave;
	...
	mov	edx, DWORD PTR __Psave$137132[ebp]
	mov	DWORD PTR __Pfmod$137156[ebp], edx

; 532  : 			_Pfmod->_Incref();

	mov	ecx, DWORD PTR __Pfmod$137156[ebp]
	call	?_Incref@facet@locale@std@@QAEXXZ	; std::locale::facet::_Incref
...
; 536  : 		return ((const _Facet&)(*_Pf));	// should be dynamic_cast
	...
	mov	eax, DWORD PTR __Pf$137145[ebp]
	mov	DWORD PTR $T142219[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Lock$137131[ebp]
	call	??1_Lockit@std@@QAE@XZ			; std::_Lockit::~_Lockit
	mov	eax, DWORD PTR $T142219[ebp]
$LN8@use_facet@3:
...
tv144 = -88						; size = 4
$T142239 = -84						; size = 4
__Field$137175 = -80					; size = 4
__Off$137174 = -76					; size = 4
__Prefix$137173 = -69					; size = 1
__Column$137169 = -68					; size = 4
__Ans$ = -64						; size = 4
__Str$ = -56						; size = 32
__Off$137161 = -20					; size = 4
__$ArrayPad$ = -16					; size = 4
__$EHRec$ = -12						; size = 12
__First$ = 8						; size = 4
__Last$ = 12						; size = 4
...
; 546  : 	for (size_t _Off = 0; _Ptr[_Off] != (_Elem)0; ++_Off)
	...
	mov	DWORD PTR __Off$137161[ebp], 0
	jmp	SHORT $LN23@Getloctxt
$LN22@Getloctxt:
	mov	eax, DWORD PTR __Off$137161[ebp]
	add	eax, 1
	mov	DWORD PTR __Off$137161[ebp], eax
$LN23@Getloctxt:
	mov	ecx, DWORD PTR __Ptr$[ebp]
	add	ecx, DWORD PTR __Off$137161[ebp]
	movsx	edx, BYTE PTR [ecx]
	test	edx, edx
...
; 547  : 		if (_Ptr[_Off] == _Ptr[0])
	...
	mov	eax, DWORD PTR __Ptr$[ebp]
	add	eax, DWORD PTR __Off$137161[ebp]
	movsx	ecx, BYTE PTR [eax]
	mov	edx, DWORD PTR __Ptr$[ebp]
...
; 552  : 	for (size_t _Column = 1; ; ++_Column, ++_First, _Ans = -1)
	...
	mov	DWORD PTR __Column$137169[ebp], 1
	jmp	SHORT $LN19@Getloctxt
$LN18@Getloctxt:
	mov	eax, DWORD PTR __Column$137169[ebp]
	add	eax, 1
	mov	DWORD PTR __Column$137169[ebp], eax
	mov	ecx, DWORD PTR __First$[ebp]
	call	??E?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@QAEAAV01@XZ ; std::istreambuf_iterator<char,std::char_traits<char> >::operator++
	mov	DWORD PTR __Ans$[ebp], -1
$LN19@Getloctxt:
...
; 554  : 		bool _Prefix = false;	// seen at least one valid prefix
	...
	mov	BYTE PTR __Prefix$137173[ebp], 0

; 555  : 		size_t _Off = 0;	// offset into fields

	mov	DWORD PTR __Off$137174[ebp], 0

; 556  : 		size_t _Field = 0;	// current field number

	mov	DWORD PTR __Field$137175[ebp], 0
...
$LN15@Getloctxt:
	mov	ecx, DWORD PTR __Field$137175[ebp]
	add	ecx, 1
	mov	DWORD PTR __Field$137175[ebp], ecx
$LN16@Getloctxt:
	mov	edx, DWORD PTR __Field$137175[ebp]
...
$LN12@Getloctxt:
	mov	eax, DWORD PTR __Off$137174[ebp]
	add	eax, 1
	mov	DWORD PTR __Off$137174[ebp], eax
$LN13@Getloctxt:
	mov	ecx, DWORD PTR __Ptr$[ebp]
	add	ecx, DWORD PTR __Off$137174[ebp]
	movsx	edx, BYTE PTR [ecx]
	test	edx, edx
	je	SHORT $LN11@Getloctxt
	mov	eax, DWORD PTR __Ptr$[ebp]
	add	eax, DWORD PTR __Off$137174[ebp]
	movsx	ecx, BYTE PTR [eax]
	mov	edx, DWORD PTR __Ptr$[ebp]
	movsx	eax, BYTE PTR [edx]
	cmp	ecx, eax
...
; 564  : 				_Off += _Str[_Field];	// skip tested columns in field
	...
	mov	eax, DWORD PTR __Field$137175[ebp]
	push	eax
	lea	ecx, DWORD PTR __Str$[ebp]
	call	??A?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAADI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::operator[]
	movsx	ecx, BYTE PTR [eax]
	add	ecx, DWORD PTR __Off$137174[ebp]
	mov	DWORD PTR __Off$137174[ebp], ecx
...
; 566  : 				|| _Ptr[_Off] == (_Elem)0)
	...
	mov	edx, DWORD PTR __Off$137174[ebp]
	add	edx, DWORD PTR __Column$137169[ebp]
	mov	DWORD PTR __Off$137174[ebp], edx
	mov	eax, DWORD PTR __Ptr$[ebp]
	add	eax, DWORD PTR __Off$137174[ebp]
	movsx	ecx, BYTE PTR [eax]
	mov	edx, DWORD PTR __Ptr$[ebp]
...
; 569  : 					? _Column : 127);	// save skip count if small enough
	...
	cmp	DWORD PTR __Column$137169[ebp], 127	; 0000007fH
...
; 576  : 				_Prefix = true;	// still a valid prefix
	...
	mov	BYTE PTR __Prefix$137173[ebp], 1
$LN9@Getloctxt:
...
; 579  : 		if (!_Prefix || _First == _Last)
	...
	movzx	eax, BYTE PTR __Prefix$137173[ebp]
	test	eax, eax
...
; 582  : 	return (_Ans);	// return field number or negative value on failure
	...
	mov	ecx, DWORD PTR __Ans$[ebp]
	mov	DWORD PTR $T142239[ebp], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Str$[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR $T142239[ebp]
...
; 114  : 				_Locinfo(_Ploc->c_str()), 0, true);
	...
	call	?_DebugHeapTag_func@std@@YAABU_DebugHeapTag_t@1@XZ ; std::_DebugHeapTag_func
	mov	DWORD PTR $T142268[ebp], eax
	push	113					; 00000071H
	push	OFFSET ??_C@_0EH@CBNPAENE@C?3?2Program?5Files?5?$CIx86?$CJ?2Microsoft@
	mov	ecx, DWORD PTR $T142268[ebp]
	push	ecx
	push	24					; 00000018H
	call	??2facet@locale@std@@SAPAXIABU_DebugHeapTag_t@2@PADH@Z ; std::locale::facet::operator new
	add	esp, 16					; 00000010H
	mov	DWORD PTR $T142267[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T142267[ebp], 0
	...
	mov	DWORD PTR tv134[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 1
	mov	eax, DWORD PTR $T142273[ebp]
	or	eax, 1
	mov	DWORD PTR $T142273[ebp], eax
	mov	ecx, DWORD PTR tv134[ebp]
	push	ecx
	mov	ecx, DWORD PTR $T142267[ebp]
...
$LN5@Getcat@3:
	...
	mov	DWORD PTR $T142266[ebp], edx
	mov	DWORD PTR __$EHRec$[ebp+8], 2
	mov	eax, DWORD PTR __Ppf$[ebp]
	mov	ecx, DWORD PTR $T142266[ebp]
	mov	DWORD PTR [eax], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	edx, DWORD PTR $T142273[ebp]
	and	edx, 1
	je	SHORT $LN1@Getcat@3
	and	DWORD PTR $T142273[ebp], -2		; fffffffeH
	lea	ecx, DWORD PTR $T142269[ebp]
	call	??1_Locinfo@std@@QAE@XZ			; std::_Locinfo::~_Locinfo
$LN1@Getcat@3:
...
; 174  : 		return (string(_Grouping));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	edx, DWORD PTR $T142299[ebp]
	or	edx, 1
	mov	DWORD PTR $T142299[ebp], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 184  : 		return (string_type(_Truename));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	edx, DWORD PTR $T142309[ebp]
	or	edx, 1
	mov	DWORD PTR $T142309[ebp], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 123  : 		return (::_Getcvt());
	...
	call	__Getcvt
	mov	DWORD PTR $T142331[ebp], eax
	mov	DWORD PTR $T142331[ebp+4], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
	mov	ecx, DWORD PTR $T142331[ebp]
	mov	DWORD PTR [eax], ecx
	mov	edx, DWORD PTR $T142331[ebp+4]
	mov	DWORD PTR [eax+4], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 660  : 	_Elem *_Ptrdest = _NEW_CRT _Elem[_Count];
	...
	add	esp, 16					; 00000010H
	mov	DWORD PTR $T142384[ebp], eax
	mov	edx, DWORD PTR $T142384[ebp]
...
; 664  : 	for (_Elem *_Ptrnext = _Ptrdest; 0 < _Count; --_Count, ++_Ptrnext, ++_Ptr)
	...
	mov	DWORD PTR __Ptrnext$138632[ebp], eax
	jmp	SHORT $LN3@Maklocstr
$LN2@Maklocstr:
	mov	ecx, DWORD PTR __Count$[ebp]
	sub	ecx, 1
	mov	DWORD PTR __Count$[ebp], ecx
	mov	edx, DWORD PTR __Ptrnext$138632[ebp]
	add	edx, 1
	mov	DWORD PTR __Ptrnext$138632[ebp], edx
	mov	eax, DWORD PTR __Ptr$[ebp]
	add	eax, 1
	mov	DWORD PTR __Ptr$[ebp], eax
$LN3@Maklocstr:
...
; 665  : 		*_Ptrnext = (_Elem)(unsigned char)*_Ptr;
	...
	mov	ecx, DWORD PTR __Ptrnext$138632[ebp]
	mov	edx, DWORD PTR __Ptr$[ebp]
	mov	al, BYTE PTR [edx]
	mov	BYTE PTR [ecx], al
