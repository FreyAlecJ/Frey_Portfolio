; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.30319.01 
	...
	TITLE	C:\Users\Alec\Desktop\GameAISource\VS2010\Buckland_Chapter7 to 10_Raven\armory\Projectile_Pellet.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_colors	DD	0ffH
	...
	DD	0c8c8c8H
	DD	0e6e6ffH
$SG138632 DB	'Pellet_Mass', 00H
_SmallestDelay DQ 03fd0000000000000r		; 0.25
_SEND_MSG_IMMEDIATELY DQ 00000000000000000r	; 0
$SG138631 DB	'Pellet_MaxForce', 00H
$SG138633 DB	'Pellet_MaxSpeed', 00H
$SG138634 DB	'Pellet_Scale', 00H
	ORG $+3
$SG138635 DB	'Pellet_Damage', 00H
	ORG $+2
$SG138636 DB	'Pellet_Persistance', 00H
CONST	ENDS
...
; File c:\users\alec\desktop\gameaisource\vs2010\buckland_chapter7 to 10_raven\armory\projectile_pellet.cpp
rdata$r	SEGMENT
...
$T148998 = -108						; size = 16
$T148997 = -92						; size = 16
_accel$138655 = -72					; size = 16
_sf$138652 = -48					; size = 16
_DesiredVelocity$138647 = -24				; size = 16
_this$ = -4						; size = 4
...
; 45   :     Vector2D DesiredVelocity = Vec2DNormalize(m_vTarget - Pos()) * MaxSpeed();
	...
	push	edx
	lea	eax, DWORD PTR $T148998[ebp]
	push	eax
	call	??G@YA?AUVector2D@@ABU0@0@Z		; operator-
	add	esp, 12					; 0000000cH
	push	eax
	lea	ecx, DWORD PTR $T148999[ebp]
	push	ecx
	call	?Vec2DNormalize@@YA?AUVector2D@@ABU1@@Z	; Vec2DNormalize
	add	esp, 8
	push	eax
	lea	edx, DWORD PTR _DesiredVelocity$138647[ebp]
	push	edx
...
; 47   :     Vector2D sf = DesiredVelocity - Velocity();
	...
	lea	eax, DWORD PTR $T149000[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Velocity@MovingEntity@@QBE?AUVector2D@@XZ ; MovingEntity::Velocity
	push	eax
	lea	ecx, DWORD PTR _DesiredVelocity$138647[ebp]
	push	ecx
	lea	edx, DWORD PTR _sf$138652[ebp]
	push	edx
	call	??G@YA?AUVector2D@@ABU0@0@Z		; operator-
	add	esp, 12					; 0000000cH
...
; 50   :     Vector2D accel = sf / m_dMass;
	...
	fstp	QWORD PTR [esp]
	lea	ecx, DWORD PTR _sf$138652[ebp]
	push	ecx
	lea	edx, DWORD PTR _accel$138655[ebp]
	push	edx
...
; 52   :     m_vVelocity += accel;
	...
	lea	eax, DWORD PTR _accel$138655[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 64					; 00000040H
...
; Function compile flags: /Odtp /RTCsu
; File c:\users\alec\desktop\gameaisource\vs2010\buckland_chapter7 to 10_raven\armory\projectile_pellet.h
_TEXT	ENDS
...
; 33   :   bool  isVisibleToPlayer()const{return Clock->GetCurrentTime() < m_dTimeOfCreation + m_dTimeShotIsVisible;}
...
; 98   : 
; 99   :   agressor->IncreasePain(this->m_iDamageInflicted); 
...
; 100  : 
; 101  :   //send a message to the bot to let it know it's been hit, and who the
; 102  :   //shot came from
; 103  :   Dispatcher->DispatchMsg(SEND_MSG_IMMEDIATELY,
; 104  :                               m_iShooterID,
; 105  :                               hit->ID(),
; 106  :                               Msg_TakeThatMF,
; 107  :                               (void*)&m_iDamageInflicted);
...
; 114  :   if ( isVisibleToPlayer() && m_bImpacted)
...
; 117  :     gdi->Line(m_vOrigin, m_vImpactPoint);
...
; 120  :     gdi->Circle(m_vImpactPoint, 3);
...
; 64   :     std::string err("<PopLuaNumber> Cannot retrieve: ");
	...
	lea	ecx, DWORD PTR _err$144166[ebp]
...
; 66   :     throw std::runtime_error(err + name);
	...
	mov	ecx, DWORD PTR _name$[ebp]
	push	ecx
	lea	edx, DWORD PTR _err$144166[ebp]
	push	edx
...
; 1993 : 			_Elem *_Ptr = this->_Bx._Ptr;
	...
	mov	DWORD PTR __Ptr$140737[ebp], eax
...
; 1995 : 				_Traits::copy(this->_Bx._Buf, _Ptr, _Newsize);
	...
	push	ecx
	mov	edx, DWORD PTR __Ptr$140737[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	add	eax, 4
	push	eax
...
; 1996 : 			this->_Alval.deallocate(_Ptr, this->_Myres + 1);
	...
	add	edx, 1
	push	edx
	mov	eax, DWORD PTR __Ptr$140737[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 1118 : 			size_type _Newsize = this->_Mysize - _Count;
	...
	mov	DWORD PTR __Newsize$140716[ebp], eax

; 1119 : 			_Eos(_Newsize);

	mov	ecx, DWORD PTR __Newsize$140716[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Eos@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Eos
$LN1@erase:
...
; 69   : 	return (_Ans);
	...
	mov	ecx, DWORD PTR $T149292[ebp]
	or	ecx, 1
	mov	DWORD PTR $T149292[ebp], ecx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Ans$[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
__unwindfunclet$??$?HDU?$char_traits@D@std@@V?$allocator@D@1@@std@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@ABV10@PBD@Z$1:
	mov	eax, DWORD PTR $T149292[ebp]
	and	eax, 1
	je	$LN5@operator@5
	and	DWORD PTR $T149292[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
$LN5@operator@5:
	ret	0
...
; 64   :     std::string err("<PopLuaNumber> Cannot retrieve: ");
	...
	push	OFFSET ??_C@_0CB@NOKEJIID@?$DMPopLuaNumber?$DO?5Cannot?5retrieve?3?5@
	lea	ecx, DWORD PTR _err$144183[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	DWORD PTR __$EHRec$[ebp+8], 0
...
; 66   :     throw std::runtime_error(err + name);
	...
	mov	ecx, DWORD PTR _name$[ebp]
	push	ecx
	lea	edx, DWORD PTR _err$144183[ebp]
	push	edx
...
$T149357 = -88						; size = 12
$T149356 = -73						; size = 1
_point$144545 = -68					; size = 16
_dist$144544 = -44					; size = 8
_curWall$ = -28						; size = 12
__$EHRec$ = -12						; size = 12
_A$ = 8							; size = 16
_B$ = 24						; size = 16
...
$LN6@FindCloses:
	...
	movzx	edx, BYTE PTR $T149356[ebp]
	test	edx, edx
	je	$LN4@FindCloses
...
; 100  :     double dist = 0.0;
	...
	fldz
	fstp	QWORD PTR _dist$144544[ebp]

; 101  :     Vector2D point;

	lea	ecx, DWORD PTR _point$144545[ebp]
	call	??0Vector2D@@QAE@XZ			; Vector2D::Vector2D

; 102  : 
; 103  :     if (LineIntersection2D(A, B, (*curWall)->From(), (*curWall)->To(), dist, point))

	lea	eax, DWORD PTR _point$144545[ebp]
	push	eax
	lea	ecx, DWORD PTR _dist$144544[ebp]
	push	ecx
...
; 105  :       if (dist < distance)
	...
	fld	QWORD PTR [edx]
	fcomp	QWORD PTR _dist$144544[ebp]
	fnstsw	ax
	test	ah, 65					; 00000041H
...
; 107  :         distance = dist;
	...
	mov	eax, DWORD PTR _distance$[ebp]
	fld	QWORD PTR _dist$144544[ebp]
	fstp	QWORD PTR [eax]

; 108  :         ip = point;

	mov	ecx, DWORD PTR _ip$[ebp]
	mov	edx, DWORD PTR _point$144545[ebp]
	mov	DWORD PTR [ecx], edx
	mov	eax, DWORD PTR _point$144545[ebp+4]
	mov	DWORD PTR [ecx+4], eax
	mov	edx, DWORD PTR _point$144545[ebp+8]
	mov	DWORD PTR [ecx+8], edx
	mov	eax, DWORD PTR _point$144545[ebp+12]
	mov	DWORD PTR [ecx+12], eax
$LN2@FindCloses:
...
; 113  :   if (distance < MaxDouble) return true;
	...
	mov	BYTE PTR $T149360[ebp], 1
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _curWall$[ebp]
	call	??1?$_Vector_const_iterator@V?$_Vector_val@PAVWall2D@@V?$allocator@PAVWall2D@@@std@@@std@@@std@@QAE@XZ
	mov	al, BYTE PTR $T149360[ebp]
...
; 115  :   return false;
	...
	mov	BYTE PTR $T149361[ebp], 0
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _curWall$[ebp]
	call	??1?$_Vector_const_iterator@V?$_Vector_val@PAVWall2D@@V?$allocator@PAVWall2D@@@std@@@std@@@std@@QAE@XZ
	mov	al, BYTE PTR $T149361[ebp]
$LN7@FindCloses:
...
; 1543 : 			size_type _Size = this->_Mysize;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+20]
	mov	DWORD PTR __Size$145486[ebp], edx
...
; 1545 : 				_Eos(_Size);
	...
	mov	edx, DWORD PTR __Size$145486[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Eos@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Eos
$LN3@reserve:
...
; 787  : 		return (const_iterator(this->_Myfirst, this));
	...
	mov	eax, DWORD PTR $T149451[ebp]
	or	eax, 1
	mov	DWORD PTR $T149451[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 797  : 		return (const_iterator(this->_Mylast, this));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_Vector_const_iterator@V?$_Vector_val@PAVWall2D@@V?$allocator@PAVWall2D@@@std@@@std@@@std@@QAE@PAPAVWall2D@@PBU_Container_base12@1@@Z ; std::_Vector_const_iterator<std::_Vector_val<Wall2D *,std::allocator<Wall2D *> > >::_Vector_const_iterator<std::_Vector_val<Wall2D *,std::allocator<Wall2D *> > >
	mov	eax, DWORD PTR $T149456[ebp]
	or	eax, 1
	mov	DWORD PTR $T149456[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 202  : 		::new ((void _FARQ *)_Ptr) _Ty(_STD forward<_Ty>(_Val));
	...
	add	esp, 8
	mov	DWORD PTR $T149461[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T149461[ebp], 0
