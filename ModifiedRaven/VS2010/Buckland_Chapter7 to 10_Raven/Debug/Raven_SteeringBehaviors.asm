; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.30319.01 
	...
	TITLE	C:\Users\Alec\Desktop\GameAISource\VS2010\Buckland_Chapter7 to 10_Raven\Raven_SteeringBehaviors.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_colors	DD	0ffH
	...
	DD	0c8c8c8H
	DD	0e6e6ffH
$SG138691 DB	'WallDetectionFeelerLength', 00H
	ORG $+2
_SmallestDelay DQ 03fd0000000000000r		; 0.25
$SG138692 DB	'SeparationWeight', 00H
	ORG $+3
$SG138693 DB	'WanderWeight', 00H
	ORG $+3
$SG138694 DB	'WallAvoidanceWeight', 00H
$SG138695 DB	'SeekWeight', 00H
	ORG $+1
$SG138696 DB	'ArriveWeight', 00H
	ORG $+3
$SG138697 DB	'ViewDistance', 00H
CONST	ENDS
...
; File c:\users\alec\desktop\gameaisource\vs2010\buckland_chapter7 to 10_raven\raven_steeringbehaviors.cpp
rdata$r	SEGMENT
...
; 47   : {
	...
	push	OFFSET $SG138693
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	mov	eax, DWORD PTR _this$[ebp]
	fstp	QWORD PTR [eax+136]
	push	OFFSET $SG138694
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	mov	ecx, DWORD PTR _this$[ebp]
	fstp	QWORD PTR [ecx+144]
	push	OFFSET $SG138695
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	mov	edx, DWORD PTR _this$[ebp]
	fstp	QWORD PTR [edx+152]
	push	OFFSET $SG138696
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	mov	eax, DWORD PTR _this$[ebp]
	fstp	QWORD PTR [eax+160]
	push	OFFSET $SG138697
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	mov	ecx, DWORD PTR _this$[ebp]
...
; Function compile flags: /Odtp /RTCsu
; File c:\users\alec\desktop\gameaisource\vs2010\buckland_chapter7 to 10_raven\raven_steeringbehaviors.h
_TEXT	ENDS
...
; 132  :   bool      On(behavior_type bt){return (m_iFlags & bt) == bt;}
...
; Function compile flags: /Odtp /RTCsu
; File c:\users\alec\desktop\gameaisource\vs2010\common\game\movingentity.h
_TEXT	ENDS
...
; 138  :     RunningTot += (Vec2DNormalize(ForceToAdd) * MagnitudeToAdd); 
	...
	push	edx
	lea	eax, DWORD PTR $T149112[ebp]
	push	eax
	call	?Vec2DNormalize@@YA?AUVector2D@@ABU1@@Z	; Vec2DNormalize
	add	esp, 8
	push	eax
	lea	ecx, DWORD PTR $T149113[ebp]
	push	ecx
...
PUBLIC	?Evade@Raven_Steering@@AAE?AUVector2D@@PBVRaven_Bot@@@Z ; Raven_Steering::Evade
...
; 177  : 	{
; 178  : 		Raven_Bot* enemy = m_pRaven_Bot->GetTargetBot();

	mov	ecx, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [ecx+8]
	call	?GetTargetBot@Raven_Bot@@QBEQAV1@XZ	; Raven_Bot::GetTargetBot
	mov	DWORD PTR _enemy$138748[ebp], eax

; 179  : 		force = Evade(enemy);

	mov	edx, DWORD PTR _enemy$138748[ebp]
	push	edx
	lea	eax, DWORD PTR $T149142[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Evade@Raven_Steering@@AAE?AUVector2D@@PBVRaven_Bot@@@Z ; Raven_Steering::Evade
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR _force$[ebp], ecx
	mov	edx, DWORD PTR [eax+4]
	mov	DWORD PTR _force$[ebp+4], edx
...
; 180  : 		if (!AccumulateForce(m_vSteeringForce, force)) return m_vSteeringForce;
...
; 184  :   {
; 185  :     force = Seek(m_vTarget) * m_dWeightSeek;
...
; 186  : 
; 187  :     if (!AccumulateForce(m_vSteeringForce, force)) return m_vSteeringForce;
...
; 192  :   {
; 193  :     force = Arrive(m_vTarget, m_Deceleration) * m_dWeightArrive;
...
; 194  : 
; 195  :     if (!AccumulateForce(m_vSteeringForce, force)) return m_vSteeringForce;
...
; 199  :   {
; 200  :     force = Wander() * m_dWeightWander;

	mov	edx, DWORD PTR _this$[ebp]
	sub	esp, 8
	fld	QWORD PTR [edx+136]
	fstp	QWORD PTR [esp]
	lea	eax, DWORD PTR $T149147[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Wander@Raven_Steering@@AAE?AUVector2D@@XZ ; Raven_Steering::Wander
	push	eax
	lea	ecx, DWORD PTR $T149148[ebp]
	push	ecx
	call	??D@YA?AUVector2D@@ABU0@N@Z		; operator*
	add	esp, 16					; 00000010H
	mov	edx, DWORD PTR [eax]
...
; 201  : 
; 202  :     if (!AccumulateForce(m_vSteeringForce, force)) return m_vSteeringForce;
	...
	mov	DWORD PTR [ecx+12], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	SHORT $LN13@CalculateP
$LN1@CalculateP:

; 203  :   }
; 204  : 
; 205  : 
; 206  :   return m_vSteeringForce;
...
; 207  : }
	...
	mov	ecx, ebp
	push	eax
	lea	edx, DWORD PTR $LN17@CalculateP
	call	@_RTC_CheckStackVars@8
	pop	eax
	pop	edx
	pop	edi
...
; 270  :   Raven_Bot* const                   GetTargetBot()const{return m_pTargSys->GetTarget();}
...
; Function compile flags: /Odtp /RTCsu
; File c:\users\alec\desktop\gameaisource\vs2010\buckland_chapter7 to 10_raven\raven_map.h
_TEXT	ENDS
...
; 219  :  
; 220  :   Vector2D DesiredVelocity = Vec2DNormalize(target - m_pRaven_Bot->Pos())
; 221  :                             * m_pRaven_Bot->MaxSpeed();
	...
	push	eax
	lea	ecx, DWORD PTR $T149164[ebp]
	push	ecx
	call	??G@YA?AUVector2D@@ABU0@0@Z		; operator-
	add	esp, 12					; 0000000cH
	push	eax
	lea	edx, DWORD PTR $T149165[ebp]
	push	edx
	call	?Vec2DNormalize@@YA?AUVector2D@@ABU1@@Z	; Vec2DNormalize
	add	esp, 8
	push	eax
...
; 222  : 
; 223  :   return (DesiredVelocity - m_pRaven_Bot->Velocity());

	lea	ecx, DWORD PTR $T149166[ebp]
	push	ecx
	mov	edx, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [edx+8]
...
_TEXT	ENDS
PUBLIC	?Flee@Raven_Steering@@AAE?AUVector2D@@U2@@Z	; Raven_Steering::Flee
...
$T149183 = -68						; size = 16
$T149182 = -52						; size = 16
_LookAheadTime$ = -36					; size = 8
_ToPursuer$ = -24					; size = 16
_this$ = -4						; size = 4
___$ReturnUdt$ = 8					; size = 4
_pursuer$ = 12						; size = 4
?Evade@Raven_Steering@@AAE?AUVector2D@@PBVRaven_Bot@@@Z PROC ; Raven_Steering::Evade
; _this$ = ecx
...
; 231  : 	if (pursuer == NULL)
	...
	cmp	DWORD PTR _pursuer$[ebp], 0
	jne	SHORT $LN1@Evade

; 232  : 	{
; 233  : 		return Vector2D(0, 0);
...
; 234  : 	}
; 235  : 
; 236  : 	Vector2D ToPursuer = pursuer->Pos() - m_pRaven_Bot->Pos();
	...
	call	?Pos@BaseGameEntity@@QBE?AUVector2D@@XZ	; BaseGameEntity::Pos
	push	eax
	lea	edx, DWORD PTR $T149183[ebp]
	push	edx
	mov	ecx, DWORD PTR _pursuer$[ebp]
	call	?Pos@BaseGameEntity@@QBE?AUVector2D@@XZ	; BaseGameEntity::Pos
	push	eax
	lea	eax, DWORD PTR _ToPursuer$[ebp]
	push	eax
	call	??G@YA?AUVector2D@@ABU0@0@Z		; operator-
	add	esp, 12					; 0000000cH

; 237  : 
; 238  : 	double LookAheadTime = ToPursuer.Length() /
; 239  : 		(m_pRaven_Bot->MaxSpeed() + pursuer->Speed());

	lea	ecx, DWORD PTR _ToPursuer$[ebp]
	call	?Length@Vector2D@@QBENXZ		; Vector2D::Length
	mov	ecx, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [ecx+8]
	...
	fadd	QWORD PTR tv209[ebp]
	fdivr	QWORD PTR tv207[ebp]
	fstp	QWORD PTR _LookAheadTime$[ebp]

; 240  : 
; 241  : 	return Flee(pursuer->Pos() + pursuer->Velocity() * LookAheadTime);

	sub	esp, 8
	fld	QWORD PTR _LookAheadTime$[ebp]
	fstp	QWORD PTR [esp]
	lea	edx, DWORD PTR $T149184[ebp]
	push	edx
	mov	ecx, DWORD PTR _pursuer$[ebp]
	call	?Velocity@MovingEntity@@QBE?AUVector2D@@XZ ; MovingEntity::Velocity
	push	eax
	lea	eax, DWORD PTR $T149185[ebp]
	push	eax
	call	??D@YA?AUVector2D@@ABU0@N@Z		; operator*
	add	esp, 16					; 00000010H
	push	eax
	lea	ecx, DWORD PTR $T149186[ebp]
	push	ecx
	mov	ecx, DWORD PTR _pursuer$[ebp]
	call	?Pos@BaseGameEntity@@QBE?AUVector2D@@XZ	; BaseGameEntity::Pos
	push	eax
	lea	edx, DWORD PTR $T149187[ebp]
	push	edx
	...
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Flee@Raven_Steering@@AAE?AUVector2D@@U2@@Z ; Raven_Steering::Flee
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
$LN2@Evade:
...
$LN4@Evade:
	...
	DB	114					; 00000072H
	DB	0
?Evade@Raven_Steering@@AAE?AUVector2D@@PBVRaven_Bot@@@Z ENDP ; Raven_Steering::Evade
; Function compile flags: /Odtp /RTCsu
; File c:\users\alec\desktop\gameaisource\vs2010\common\2d\vector2d.h
_TEXT	ENDS
...
_this$ = -4						; size = 4
___$ReturnUdt$ = 8					; size = 4
_TargetPos$ = 12					; size = 16
?Flee@Raven_Steering@@AAE?AUVector2D@@U2@@Z PROC	; Raven_Steering::Flee
; _this$ = ecx
...
; 249  : 	Vector2D DesiredVelocity = Vec2DNormalize(m_pRaven_Bot->Pos() - TargetPos);
	...
	call	?Pos@BaseGameEntity@@QBE?AUVector2D@@XZ	; BaseGameEntity::Pos
	push	eax
	lea	eax, DWORD PTR $T149200[ebp]
	push	eax
	call	??G@YA?AUVector2D@@ABU0@0@Z		; operator-
	add	esp, 12					; 0000000cH
	push	eax
	lea	ecx, DWORD PTR _DesiredVelocity$[ebp]
	push	ecx
	call	?Vec2DNormalize@@YA?AUVector2D@@ABU1@@Z	; Vec2DNormalize
	add	esp, 8

; 250  : 	return (DesiredVelocity - m_pRaven_Bot->Velocity());

	lea	edx, DWORD PTR $T149201[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+8]
	call	?Velocity@MovingEntity@@QBE?AUVector2D@@XZ ; MovingEntity::Velocity
...
$LN3@Flee:
	...
	DB	121					; 00000079H
	DB	0
?Flee@Raven_Steering@@AAE?AUVector2D@@U2@@Z ENDP	; Raven_Steering::Flee
_TEXT	ENDS
...
$T149207 = -108						; size = 8
$T149206 = -100						; size = 16
_DesiredVelocity$138823 = -80				; size = 16
_speed$138815 = -56					; size = 8
_DecelerationTweaker$138814 = -44			; size = 8
_dist$ = -36						; size = 8
...
; 262  :   Vector2D ToTarget = target - m_pRaven_Bot->Pos();

	lea	eax, DWORD PTR $T149206[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [ecx+8]
	call	?Pos@BaseGameEntity@@QBE?AUVector2D@@XZ	; BaseGameEntity::Pos
...
; 263  : 
; 264  :   //calculate the distance to the target
; 265  :   double dist = ToTarget.Length();
...
; 268  :   {
; 269  :     //because Deceleration is enumerated as an int, this value is required
; 270  :     //to provide fine tweaking of the deceleration..
; 271  :     const double DecelerationTweaker = 0.3;

	fld	QWORD PTR __real@3fd3333333333333
	fstp	QWORD PTR _DecelerationTweaker$138814[ebp]

; 272  : 
; 273  :     //calculate the speed required to reach the target given the desired
; 274  :     //deceleration
; 275  :     double speed =  dist / ((double)deceleration * DecelerationTweaker);     

	fild	DWORD PTR _deceleration$[ebp]
	fmul	QWORD PTR _DecelerationTweaker$138814[ebp]
	fdivr	QWORD PTR _dist$[ebp]
	fstp	QWORD PTR _speed$138815[ebp]

; 276  : 
; 277  :     //make sure the velocity does not exceed the max
; 278  :     speed = MinOf(speed, m_pRaven_Bot->MaxSpeed());

	mov	ecx, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [ecx+8]
	call	?MaxSpeed@MovingEntity@@QBENXZ		; MovingEntity::MaxSpeed
	fstp	QWORD PTR $T149207[ebp]
	lea	edx, DWORD PTR $T149207[ebp]
	push	edx
	lea	eax, DWORD PTR _speed$138815[ebp]
	push	eax
...
; 279  : 
; 280  :     //from here proceed just like Seek except we don't need to normalize 
; 281  :     //the ToTarget vector because we have already gone to the trouble
; 282  :     //of calculating its length: dist. 
; 283  :     Vector2D DesiredVelocity =  ToTarget * speed / dist;

	sub	esp, 8
	fld	QWORD PTR _dist$[ebp]
	fstp	QWORD PTR [esp]
	sub	esp, 8
	fld	QWORD PTR _speed$138815[ebp]
	fstp	QWORD PTR [esp]
	lea	ecx, DWORD PTR _ToTarget$[ebp]
	push	ecx
	lea	edx, DWORD PTR $T149208[ebp]
	push	edx
	call	??D@YA?AUVector2D@@ABU0@N@Z		; operator*
	add	esp, 16					; 00000010H
	push	eax
	lea	eax, DWORD PTR _DesiredVelocity$138823[ebp]
	push	eax
	call	??K@YA?AUVector2D@@ABU0@N@Z		; operator/
	add	esp, 16					; 00000010H

; 284  : 
; 285  :     return (DesiredVelocity - m_pRaven_Bot->Velocity());

	lea	ecx, DWORD PTR $T149209[ebp]
	push	ecx
	mov	edx, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [edx+8]
	call	?Velocity@MovingEntity@@QBE?AUVector2D@@XZ ; MovingEntity::Velocity
...
; 299  :   //first, add a small random vector to the target's position
; 300  :   m_vWanderTarget += Vector2D(RandomClamped() * m_dWanderJitter,
; 301  :                               RandomClamped() * m_dWanderJitter);
...
; 302  : 
; 303  :   //reproject this new vector back on to a unit circle
; 304  :   m_vWanderTarget.Normalize();
...
; 305  : 
; 306  :   //increase the length of the vector to the same as the radius
; 307  :   //of the wander circle
; 308  :   m_vWanderTarget *= m_dWanderRadius;
...
; 309  : 
; 310  :   //move the target into a position WanderDist in front of the agent
; 311  :   Vector2D target = m_vWanderTarget + Vector2D(m_dWanderDistance, 0);
...
; 312  : 
; 313  :   //project the target into world space
; 314  :   Vector2D Target = PointToWorldSpace(target,
; 315  :                                        m_pRaven_Bot->Heading(),
; 316  :                                        m_pRaven_Bot->Side(), 
; 317  :                                        m_pRaven_Bot->Pos());

	lea	eax, DWORD PTR $T149225[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [ecx+8]
	call	?Pos@BaseGameEntity@@QBE?AUVector2D@@XZ	; BaseGameEntity::Pos
	push	eax
	lea	edx, DWORD PTR $T149226[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+8]
	call	?Side@MovingEntity@@QBE?AUVector2D@@XZ	; MovingEntity::Side
	push	eax
	lea	ecx, DWORD PTR $T149227[ebp]
	push	ecx
	mov	edx, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [edx+8]
	call	?Heading@MovingEntity@@QBE?AUVector2D@@XZ ; MovingEntity::Heading
...
; 318  : 
; 319  :   //and steer towards it
; 320  :   return Target - m_pRaven_Bot->Pos(); 

	lea	edx, DWORD PTR $T149228[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+8]
	call	?Pos@BaseGameEntity@@QBE?AUVector2D@@XZ	; BaseGameEntity::Pos
...
; Function compile flags: /Odtp /RTCsu
; File c:\users\alec\desktop\gameaisource\vs2010\common\2d\transformations.h
...
; Function compile flags: /Odtp /RTCsu
; File c:\users\alec\desktop\gameaisource\vs2010\common\2d\c2dmatrix.h
...
$T149270 = -168						; size = 16
$T149269 = -152						; size = 16
_OverShoot$138873 = -132				; size = 16
_w$138863 = -112					; size = 4
_flr$138859 = -108					; size = 4
...
; 331  :   //the feelers are contained in a std::vector, m_Feelers
; 332  :   CreateFeelers();
...
; 333  :   
; 334  :   double DistToThisIP    = 0.0;

	fldz
	fstp	QWORD PTR _DistToThisIP$[ebp]

; 335  :   double DistToClosestIP = MaxDouble;

	fld	QWORD PTR _MaxDouble
	fstp	QWORD PTR _DistToClosestIP$[ebp]

; 336  : 
; 337  :   //this will hold an index into the vector of walls
; 338  :   int ClosestWall = -1;

	mov	DWORD PTR _ClosestWall$[ebp], -1

; 339  : 
; 340  :   Vector2D SteeringForce,

	lea	ecx, DWORD PTR _SteeringForce$[ebp]
	call	??0Vector2D@@QAE@XZ			; Vector2D::Vector2D

; 341  :             point,         //used for storing temporary info

	lea	ecx, DWORD PTR _point$[ebp]
	call	??0Vector2D@@QAE@XZ			; Vector2D::Vector2D

; 342  :             ClosestPoint;  //holds the closest intersection point

	lea	ecx, DWORD PTR _ClosestPoint$[ebp]
	call	??0Vector2D@@QAE@XZ			; Vector2D::Vector2D

; 343  : 
; 344  :   //examine each feeler in turn
; 345  :   for (unsigned int flr=0; flr<m_Feelers.size(); ++flr)

	mov	DWORD PTR _flr$138859[ebp], 0
	jmp	SHORT $LN9@WallAvoida
$LN8@WallAvoida:
	mov	eax, DWORD PTR _flr$138859[ebp]
	add	eax, 1
	mov	DWORD PTR _flr$138859[ebp], eax
$LN9@WallAvoida:
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 56					; 00000038H
	call	?size@?$vector@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@QBEIXZ ; std::vector<Vector2D,std::allocator<Vector2D> >::size
	cmp	DWORD PTR _flr$138859[ebp], eax
	jae	$LN7@WallAvoida

; 346  :   {
; 347  :     //run through each wall checking for any intersection points
; 348  :     for (unsigned int w=0; w<walls.size(); ++w)

	mov	DWORD PTR _w$138863[ebp], 0
	jmp	SHORT $LN6@WallAvoida
$LN5@WallAvoida:
	mov	ecx, DWORD PTR _w$138863[ebp]
	add	ecx, 1
	mov	DWORD PTR _w$138863[ebp], ecx
$LN6@WallAvoida:
	...
	cmp	DWORD PTR _w$138863[ebp], eax
	jae	$LN4@WallAvoida

; 349  :     {
; 350  :       if (LineIntersection2D(m_pRaven_Bot->Pos(),
; 351  :                              m_Feelers[flr],
; 352  :                              walls[w]->From(),
; 353  :                              walls[w]->To(),
; 354  :                              DistToThisIP,
; 355  :                              point))
	...
	push	eax
	lea	ecx, DWORD PTR $T149269[ebp]
	push	ecx
	mov	edx, DWORD PTR _w$138863[ebp]
	push	edx
	mov	ecx, DWORD PTR _walls$[ebp]
	...
	mov	eax, DWORD PTR [eax+12]
	mov	DWORD PTR [ecx+12], eax
	mov	ecx, DWORD PTR _flr$138859[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 56					; 00000038H
...
; 356  :       {
; 357  :         //is this the closest found so far? If so keep a record
; 358  :         if (DistToThisIP < DistToClosestIP)
...
; 359  :         {
; 360  :           DistToClosestIP = DistToThisIP;
...
; 368  : 
; 369  :   
; 370  :     //if an intersection point has been detected, calculate a force  
; 371  :     //that will direct the agent away
; 372  :     if (ClosestWall >=0)

	cmp	DWORD PTR _ClosestWall$[ebp], 0
	jl	SHORT $LN1@WallAvoida

; 373  :     {
; 374  :       //calculate by what distance the projected position of the agent
; 375  :       //will overshoot the wall
; 376  :       Vector2D OverShoot = m_Feelers[flr] - ClosestPoint;

	lea	ecx, DWORD PTR _ClosestPoint$[ebp]
	push	ecx
	mov	edx, DWORD PTR _flr$138859[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 56					; 00000038H
	call	??A?$vector@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@QAEAAUVector2D@@I@Z ; std::vector<Vector2D,std::allocator<Vector2D> >::operator[]
	push	eax
	lea	eax, DWORD PTR _OverShoot$138873[ebp]
	push	eax
	call	??G@YA?AUVector2D@@ABU0@0@Z		; operator-
	add	esp, 12					; 0000000cH

; 377  : 
; 378  :       //create a force in the direction of the wall normal, with a 
; 379  :       //magnitude of the overshoot
; 380  :       SteeringForce = walls[ClosestWall]->Normal() * OverShoot.Length();

	lea	ecx, DWORD PTR _OverShoot$138873[ebp]
	call	?Length@Vector2D@@QBENXZ		; Vector2D::Length
	sub	esp, 8
	fstp	QWORD PTR [esp]
	lea	ecx, DWORD PTR $T149272[ebp]
	push	ecx
...
; Function compile flags: /Odtp /RTCsu
; File c:\users\alec\desktop\gameaisource\vs2010\common\2d\geometry.h
...
; 394  :   //feeler pointing straight in front
; 395  :   m_Feelers[0] = m_pRaven_Bot->Pos() + m_dWallDetectionFeelerLength *
; 396  :                  m_pRaven_Bot->Heading() * m_pRaven_Bot->Speed();
...
; 397  : 
; 398  :   //feeler to left
; 399  :   Vector2D temp = m_pRaven_Bot->Heading();
...
; 400  :   Vec2DRotateAroundOrigin(temp, HalfPi * 3.5);
...
; 401  :   m_Feelers[1] = m_pRaven_Bot->Pos() + m_dWallDetectionFeelerLength/2.0 * temp;
	...
	sub	esp, 8
	fstp	QWORD PTR [esp]
	lea	edx, DWORD PTR $T149305[ebp]
	push	edx
	call	??D@YA?AUVector2D@@NABU0@@Z		; operator*
	add	esp, 16					; 00000010H
	push	eax
	lea	eax, DWORD PTR $T149306[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [ecx+8]
	call	?Pos@BaseGameEntity@@QBE?AUVector2D@@XZ	; BaseGameEntity::Pos
	push	eax
	lea	edx, DWORD PTR $T149307[ebp]
	push	edx
	call	??H@YA?AUVector2D@@ABU0@0@Z		; operator+
	add	esp, 12					; 0000000cH
	mov	esi, eax
...
; 402  : 
; 403  :   //feeler to right
; 404  :   temp = m_pRaven_Bot->Heading();

	lea	eax, DWORD PTR $T149308[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [ecx+8]
	call	?Heading@MovingEntity@@QBE?AUVector2D@@XZ ; MovingEntity::Heading
...
; 405  :   Vec2DRotateAroundOrigin(temp, HalfPi * 0.5);
...
; 406  :   m_Feelers[2] = m_pRaven_Bot->Pos() + m_dWallDetectionFeelerLength/2.0 * temp;
...
; 416  :   //iterate through all the neighbors and calculate the vector from the
; 417  :   Vector2D SteeringForce;
...
; 420  :   for (it; it != neighbors.end(); ++it)
...
$LN4@Separation:
	...
	mov	BYTE PTR $T149332[ebp], al
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T149333[ebp]
	call	??1?$_List_const_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@XZ
	movzx	ecx, BYTE PTR $T149332[ebp]
	test	ecx, ecx
	je	$LN2@Separation

; 421  :   {
; 422  :     //make sure this agent isn't included in the calculations and that
; 423  :     //the agent being examined is close enough. ***also make sure it doesn't
; 424  :     //include the evade target ***
; 425  :     if((*it != m_pRaven_Bot) && (*it)->IsTagged() &&
; 426  :       (*it != m_pTargetAgent1))
...
; 427  :     {
; 428  :       Vector2D ToAgent = m_pRaven_Bot->Pos() - (*it)->Pos();

	lea	ecx, DWORD PTR $T149334[ebp]
	push	ecx
	lea	ecx, DWORD PTR _it$[ebp]
	call	??D?$_List_const_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QBEABQAVRaven_Bot@@XZ ; std::_List_const_iterator<std::_List_val<Raven_Bot *,std::allocator<Raven_Bot *> > >::operator*
	mov	ecx, DWORD PTR [eax]
	call	?Pos@BaseGameEntity@@QBE?AUVector2D@@XZ	; BaseGameEntity::Pos
	push	eax
	lea	edx, DWORD PTR $T149335[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+8]
	call	?Pos@BaseGameEntity@@QBE?AUVector2D@@XZ	; BaseGameEntity::Pos
	push	eax
	lea	ecx, DWORD PTR _ToAgent$139046[ebp]
	push	ecx
	call	??G@YA?AUVector2D@@ABU0@0@Z		; operator-
	add	esp, 12					; 0000000cH

; 429  : 
; 430  :       //scale the force inversely proportional to the agents distance  
; 431  :       //from its neighbor.
; 432  :       SteeringForce += Vec2DNormalize(ToAgent)/ToAgent.Length();

	lea	ecx, DWORD PTR _ToAgent$139046[ebp]
	call	?Length@Vector2D@@QBENXZ		; Vector2D::Length
	sub	esp, 8
	fstp	QWORD PTR [esp]
	lea	edx, DWORD PTR _ToAgent$139046[ebp]
	push	edx
	lea	eax, DWORD PTR $T149336[ebp]
	push	eax
	call	?Vec2DNormalize@@YA?AUVector2D@@ABU1@@Z	; Vec2DNormalize
	add	esp, 8
	push	eax
	lea	ecx, DWORD PTR $T149337[ebp]
	push	ecx
	call	??K@YA?AUVector2D@@ABU0@N@Z		; operator/
	add	esp, 16					; 00000010H
	push	eax
...
; 787  : 		return (const_iterator(this->_Nextnode(this->_Myhead), this));
	...
	mov	ecx, DWORD PTR $T149401[ebp]
	or	ecx, 1
	mov	DWORD PTR $T149401[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 797  : 		return (const_iterator(this->_Myhead, this));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_List_const_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@PAU_Node@?$_List_nod@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@1@PBV?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@1@@Z ; std::_List_const_iterator<std::_List_val<Raven_Bot *,std::allocator<Raven_Bot *> > >::_List_const_iterator<std::_List_val<Raven_Bot *,std::allocator<Raven_Bot *> > >
	mov	eax, DWORD PTR $T149406[ebp]
	or	eax, 1
	mov	DWORD PTR $T149406[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 859  : 			erase(begin() + _Newsize, end());
	...
	push	ecx
	lea	edx, DWORD PTR $T149434[ebp]
	push	edx
	lea	eax, DWORD PTR $T149433[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	...
	sub	esp, 12					; 0000000cH
	mov	ecx, esp
	mov	DWORD PTR $T149432[ebp], esp
	mov	eax, DWORD PTR tv198[ebp]
	push	eax
	call	??0?$_Vector_const_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@std@@QAE@ABV01@@Z
	mov	DWORD PTR tv201[ebp], eax
	lea	ecx, DWORD PTR $T149435[ebp]
	push	ecx
	...
	lea	ecx, DWORD PTR $T149434[ebp]
	call	??1?$_Vector_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@std@@QAE@XZ
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T149433[ebp]
	call	??1?$_Vector_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@std@@QAE@XZ
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR $T149431[ebp]
	call	??1?$_Vector_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@std@@QAE@XZ
...
_TEXT	SEGMENT
__Size$142672 = -28					; size = 4
__Ptr$142665 = -24					; size = 4
_this$ = -20						; size = 4
__$EHRec$ = -16						; size = 16
__Count$ = 8						; size = 4
...
; 751  : 			pointer _Ptr = this->_Alval.allocate(_Count);
	...
	mov	DWORD PTR __Ptr$142665[ebp], eax
...
; 754  : 			_Umove(this->_Myfirst, this->_Mylast, _Ptr);
	...
	mov	ecx, DWORD PTR __Ptr$142665[ebp]
	push	ecx
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+8]
	push	eax
...
; 760  : 			size_type _Size = size();
	...
	mov	ecx, DWORD PTR _this$[ebp]
	call	?size@?$vector@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@QBEIXZ ; std::vector<Vector2D,std::allocator<Vector2D> >::size
	mov	DWORD PTR __Size$142672[ebp], eax
...
; 769  : 			this->_Myend = _Ptr + _Count;
	...
	mov	eax, DWORD PTR __Count$[ebp]
	shl	eax, 4
	add	eax, DWORD PTR __Ptr$142665[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [ecx+12], eax

; 770  : 			this->_Mylast = _Ptr + _Size;

	mov	edx, DWORD PTR __Size$142672[ebp]
	shl	edx, 4
	add	edx, DWORD PTR __Ptr$142665[ebp]
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+8], edx
...
; 771  : 			this->_Myfirst = _Ptr;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR __Ptr$142665[ebp]
	mov	DWORD PTR [ecx+4], edx
$LN7@reserve:
...
; 782  : 		return (iterator(this->_Myfirst, this));
	...
	mov	eax, DWORD PTR $T149556[ebp]
	or	eax, 1
	mov	DWORD PTR $T149556[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 792  : 		return (iterator(this->_Mylast, this));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_Vector_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@std@@QAE@PAUVector2D@@PBU_Container_base12@1@@Z ; std::_Vector_iterator<std::_Vector_val<Vector2D,std::allocator<Vector2D> > >::_Vector_iterator<std::_Vector_val<Vector2D,std::allocator<Vector2D> > >
	mov	eax, DWORD PTR $T149561[ebp]
	or	eax, 1
	mov	DWORD PTR $T149561[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 1202 : 				_VIPTR(_First));
	...
	add	esp, 12					; 0000000cH
	mov	DWORD PTR __Ptr$142701[ebp], eax
...
; 1210 : 			_Destroy(_Ptr, this->_Mylast);
	...
	mov	edx, DWORD PTR [ecx+8]
	push	edx
	mov	eax, DWORD PTR __Ptr$142701[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Destroy@?$vector@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@IAEXPAUVector2D@@0@Z ; std::vector<Vector2D,std::allocator<Vector2D> >::_Destroy
...
; 1211 : 			this->_Mylast = _Ptr;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR __Ptr$142701[ebp]
	mov	DWORD PTR [ecx+8], edx
$LN3@erase:
...
; 1213 : 		return (_First);
	...
	mov	ecx, DWORD PTR $T149576[ebp]
	or	ecx, 1
	mov	DWORD PTR $T149576[ebp], ecx
	mov	BYTE PTR __$EHRec$[ebp+8], 3
	lea	ecx, DWORD PTR __Last$[ebp]
	call	??1?$_Vector_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@std@@QAE@XZ
	mov	BYTE PTR __$EHRec$[ebp+8], 2
...
__unwindfunclet$?erase@?$vector@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@QAE?AV?$_Vector_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@2@V?$_Vector_const_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@2@0@Z$6:
	mov	eax, DWORD PTR $T149576[ebp]
	and	eax, 1
	je	$LN13@erase
	and	DWORD PTR $T149576[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_Vector_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@std@@QAE@XZ
$LN13@erase:
	ret	0
...
; 365  : 		return (_Tmp += _Off);
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_Vector_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@std@@QAE@ABV01@@Z
	mov	edx, DWORD PTR $T149639[ebp]
	or	edx, 1
	mov	DWORD PTR $T149639[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Tmp$[ebp]
	call	??1?$_Vector_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@std@@QAE@XZ
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
__unwindfunclet$??H?$_Vector_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@std@@QBE?AV01@H@Z$1:
	mov	eax, DWORD PTR $T149639[ebp]
	and	eax, 1
	je	$LN5@operator@12
	and	DWORD PTR $T149639[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_Vector_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@std@@QAE@XZ
$LN5@operator@12:
	ret	0
...
; 802  : 		return (iterator(_Where._Ptr, this));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_Vector_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@std@@QAE@PAUVector2D@@PBU_Container_base12@1@@Z ; std::_Vector_iterator<std::_Vector_val<Vector2D,std::allocator<Vector2D> > >::_Vector_iterator<std::_Vector_val<Vector2D,std::allocator<Vector2D> > >
	mov	edx, DWORD PTR $T149662[ebp]
	or	edx, 1
	mov	DWORD PTR $T149662[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
...
__unwindfunclet$?_Make_iter@?$vector@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@QBE?AV?$_Vector_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@2@V?$_Vector_const_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@2@@Z$1:
	mov	eax, DWORD PTR $T149662[ebp]
	and	eax, 1
	je	$LN5@Make_iter
	and	DWORD PTR $T149662[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_Vector_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@std@@QAE@XZ
$LN5@Make_iter:
	ret	0
...
;	COMDAT xdata$x
; File c:\users\alec\desktop\gameaisource\vs2010\common\game\entityfunctiontemplates.h
xdata$x	SEGMENT
...
$T149706 = -77						; size = 1
$T149705 = -76						; size = 12
_range$144501 = -64					; size = 8
_to$144497 = -52					; size = 16
_it$ = -28						; size = 12
__$EHRec$ = -12						; size = 12
_entity$ = 8						; size = 4
_others$ = 12						; size = 4
...
$LN4@TagNeighbo:
	...
	lea	ecx, DWORD PTR _it$[ebp]
	call	??9?$_List_const_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QBE_NABV01@@Z ; std::_List_const_iterator<std::_List_val<Raven_Bot *,std::allocator<Raven_Bot *> > >::operator!=
	mov	BYTE PTR $T149706[ebp], al
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T149707[ebp]
	call	??1?$_List_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@XZ
	movzx	eax, BYTE PTR $T149706[ebp]
	test	eax, eax
	je	$LN2@TagNeighbo
...
; 56   :     Vector2D to = (*it)->Pos() - entity->Pos();
	...
	lea	ecx, DWORD PTR $T149708[ebp]
	push	ecx
	mov	ecx, DWORD PTR _entity$[ebp]
	call	?Pos@BaseGameEntity@@QBE?AUVector2D@@XZ	; BaseGameEntity::Pos
	push	eax
	lea	edx, DWORD PTR $T149709[ebp]
	push	edx
	lea	ecx, DWORD PTR _it$[ebp]
	call	??D?$_List_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QBEAAPAVRaven_Bot@@XZ ; std::_List_iterator<std::_List_val<Raven_Bot *,std::allocator<Raven_Bot *> > >::operator*
	mov	ecx, DWORD PTR [eax]
	call	?Pos@BaseGameEntity@@QBE?AUVector2D@@XZ	; BaseGameEntity::Pos
	push	eax
	lea	eax, DWORD PTR _to$144497[ebp]
	push	eax
	call	??G@YA?AUVector2D@@ABU0@0@Z		; operator-
	add	esp, 12					; 0000000cH
...
; 60   :     double range = radius + (*it)->BRadius();
	...
	fstp	QWORD PTR _range$144501[ebp]
...
; 63   :     if ( ((*it) != entity) && (to.LengthSq() < range*range))
	...
	lea	ecx, DWORD PTR _to$144497[ebp]
	call	?LengthSq@Vector2D@@QBENXZ		; Vector2D::LengthSq
	fld	QWORD PTR _range$144501[ebp]
	fmul	QWORD PTR _range$144501[ebp]
	fcompp
	fnstsw	ax
	test	ah, 65					; 00000041H
...
; 64   :     std::string err("<PopLuaNumber> Cannot retrieve: ");
	...
	lea	ecx, DWORD PTR _err$144755[ebp]
...
; 66   :     throw std::runtime_error(err + name);
	...
	mov	ecx, DWORD PTR _name$[ebp]
	push	ecx
	lea	edx, DWORD PTR _err$144755[ebp]
	push	edx
	lea	eax, DWORD PTR $T144756[ebp]
	push	eax
	...
	lea	eax, DWORD PTR $T149734[ebp]
	push	eax
	call	__CxxThrowException@8
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T144756[ebp]
...
; 165  : 		{	// construct from message string
	...
	mov	DWORD PTR $T149748[ebp], eax
	lea	eax, DWORD PTR $T149748[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 1993 : 			_Elem *_Ptr = this->_Bx._Ptr;
	...
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+4]
	mov	DWORD PTR __Ptr$141153[ebp], eax
...
; 1995 : 				_Traits::copy(this->_Bx._Buf, _Ptr, _Newsize);
	...
	mov	ecx, DWORD PTR __Newsize$[ebp]
	push	ecx
	mov	edx, DWORD PTR __Ptr$141153[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	add	eax, 4
	push	eax
...
; 1996 : 			this->_Alval.deallocate(_Ptr, this->_Myres + 1);
	...
	add	edx, 1
	push	edx
	mov	eax, DWORD PTR __Ptr$141153[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 1954 : 		_Traits::assign(_Myptr()[this->_Mysize = _Newsize], _Elem());
	...
	mov	BYTE PTR $T149824[ebp], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR __Newsize$[ebp]
	mov	DWORD PTR [eax+20], ecx
	lea	edx, DWORD PTR $T149824[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Myptr@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEPADXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Myptr
...
; 1118 : 			size_type _Newsize = this->_Mysize - _Count;
	...
	mov	eax, DWORD PTR [edx+20]
	sub	eax, DWORD PTR __Count$[ebp]
	mov	DWORD PTR __Newsize$141132[ebp], eax

; 1119 : 			_Eos(_Newsize);

	mov	ecx, DWORD PTR __Newsize$141132[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Eos@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Eos
$LN1@erase@2:
...
; 69   : 	return (_Ans);
	...
	mov	ecx, DWORD PTR $T149886[ebp]
	or	ecx, 1
	mov	DWORD PTR $T149886[ebp], ecx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Ans$[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
__unwindfunclet$??$?HDU?$char_traits@D@std@@V?$allocator@D@1@@std@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@ABV10@PBD@Z$1:
	...
	and	eax, 1
	je	$LN5@operator@14
	and	DWORD PTR $T149886[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
$LN5@operator@14:
	ret	0
...
; 672  : 		_Val_type(_First), _Ptr_cat(_First, _First));
	...
	add	esp, 8
	mov	BYTE PTR $T149951[ebp], al
	movzx	edx, BYTE PTR $T149951[ebp]
	push	edx
	mov	eax, DWORD PTR __First$[ebp]
	push	eax
...
; 2535 : 		_Dest, _Ptr_cat(_First, _Dest)));
	...
	call	??$_Ptr_cat@UVector2D@@U1@@std@@YA?AU_Nonscalar_ptr_iterator_tag@0@PAUVector2D@@0@Z ; std::_Ptr_cat<Vector2D,Vector2D>
	add	esp, 8
	mov	BYTE PTR $T149958[ebp], al
	movzx	edx, BYTE PTR $T149958[ebp]
	push	edx
	mov	eax, DWORD PTR __Dest$[ebp]
	push	eax
	mov	ecx, DWORD PTR __Last$[ebp]
...
; 88   : 	_Destroy_range(_First, _Last, _Al, _Ptr_cat(_First, _Last));
	...
	call	??$_Ptr_cat@UVector2D@@U1@@std@@YA?AU_Nonscalar_ptr_iterator_tag@0@PAUVector2D@@0@Z ; std::_Ptr_cat<Vector2D,Vector2D>
	add	esp, 8
	mov	BYTE PTR $T149961[ebp], al
	movzx	edx, BYTE PTR $T149961[ebp]
	push	edx
...
; 1543 : 			size_type _Size = this->_Mysize;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+20]
	mov	DWORD PTR __Size$145775[ebp], edx
...
; 1545 : 				_Eos(_Size);
	...
	mov	edx, DWORD PTR __Size$145775[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Eos@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Eos
$LN3@reserve@2:
...
; 782  : 		return (iterator(this->_Nextnode(this->_Myhead), this));
	...
	mov	ecx, DWORD PTR $T150002[ebp]
	or	ecx, 1
	mov	DWORD PTR $T150002[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 792  : 		return (iterator(this->_Myhead, this));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_List_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@PAU_Node@?$_List_nod@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@1@PBV?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@1@@Z ; std::_List_iterator<std::_List_val<Raven_Bot *,std::allocator<Raven_Bot *> > >::_List_iterator<std::_List_val<Raven_Bot *,std::allocator<Raven_Bot *> > >
	mov	eax, DWORD PTR $T150007[ebp]
	or	eax, 1
	mov	DWORD PTR $T150007[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 202  : 		::new ((void _FARQ *)_Ptr) _Ty(_STD forward<_Ty>(_Val));
	...
	add	esp, 8
	mov	DWORD PTR $T150012[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T150012[ebp], 0
	...
	mov	ecx, DWORD PTR $T150012[ebp]
	mov	DWORD PTR [ecx], edx
	mov	DWORD PTR [ecx+4], eax
	mov	edx, DWORD PTR $T150012[ebp]
...
; 202  : 		::new ((void _FARQ *)_Ptr) _Ty(_STD forward<_Ty>(_Val));
	...
	call	??2@YAPAXIPAX@Z				; operator new
	add	esp, 8
	mov	DWORD PTR $T150078[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T150078[ebp], 0
	je	SHORT $LN3@construct@2
	mov	ecx, DWORD PTR __Val$[ebp]
	push	ecx
	call	??$forward@UVector2D@@@std@@YA$$QAUVector2D@@AAU1@@Z ; std::forward<Vector2D>
	add	esp, 4
	mov	edx, DWORD PTR $T150078[ebp]
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR [edx], ecx
	mov	ecx, DWORD PTR [eax+4]
	mov	DWORD PTR [edx+4], ecx
...
; 471  : 		_Val_type(_First), _Ptr_cat(_First, _Dest)));
	...
	call	??$_Ptr_cat@UVector2D@@U1@@std@@YA?AU_Nonscalar_ptr_iterator_tag@0@PAUVector2D@@0@Z ; std::_Ptr_cat<Vector2D,Vector2D>
	add	esp, 8
	mov	BYTE PTR $T150090[ebp], al
	movzx	edx, BYTE PTR $T150090[ebp]
	push	edx
	mov	eax, DWORD PTR __First$[ebp]
	push	eax
	call	??$_Val_type@PAUVector2D@@@std@@YAPAUVector2D@@PAU1@@Z ; std::_Val_type<Vector2D *>
