#ifndef TARGETING_SYSTEM_DEVIATION_H
#define TARGETING_SYSTEM_DEVIATION_H
...
class Raven_TargetingSystem_Deviation :
...
public:
	...
	Raven_TargetingSystem_Deviation(Raven_Bot* owner);
