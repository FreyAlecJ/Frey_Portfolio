; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.30319.01 
	...
	TITLE	C:\Users\Alec\Desktop\GameAISource\VS2010\Buckland_Chapter7 to 10_Raven\goals\AggressiveDefense_Evaluator.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?CalculateDesirability@AggressiveDefense_Evaluator@@UAENPAVRaven_Bot@@@Z ; AggressiveDefense_Evaluator::CalculateDesirability
...
EXTRN	?RecentDamage@Raven_Bot@@QAEHH@Z:PROC		; Raven_Bot::RecentDamage
EXTRN	?InCombat@Raven_Bot@@QAE_NXZ:PROC		; Raven_Bot::InCombat
EXTRN	?HighestRecentDamage@Raven_Bot@@QAEHXZ:PROC	; Raven_Bot::HighestRecentDamage
EXTRN	__fltused:DWORD
EXTRN	__RTC_CheckEsp:PROC
EXTRN	__RTC_Shutdown:PROC
EXTRN	__RTC_InitBase:PROC
;	COMDAT __real@4008000000000000
; File c:\users\alec\desktop\gameaisource\vs2010\buckland_chapter7 to 10_raven\goals\aggressivedefense_evaluator.cpp
CONST	SEGMENT
...
tv143 = -36						; size = 4
tv141 = -32						; size = 4
_damage$136245 = -28					; size = 4
_Tweaker$136244 = -24					; size = 8
_mostDangerous$ = -16					; size = 4
_Desirability$ = -12					; size = 8
_this$ = -4						; size = 4
_pBot$ = 8						; size = 4
?CalculateDesirability@AggressiveDefense_Evaluator@@UAENPAVRaven_Bot@@@Z PROC ; AggressiveDefense_Evaluator::CalculateDesirability
; _this$ = ecx
...
; 21   : 
; 22   : 	int mostDangerous = pBot->HighestRecentDamage();

	mov	ecx, DWORD PTR _pBot$[ebp]
	call	?HighestRecentDamage@Raven_Bot@@QAEHXZ	; Raven_Bot::HighestRecentDamage
	mov	DWORD PTR _mostDangerous$[ebp], eax

; 23   : 	//debug_con << "Most dangerous: " << mostDangerous << " for bot : " << pBot->ID() << "";
; 24   : 
; 25   : 
; 26   : 	//only do the calculation if the bot has 
; 27   : 	if (pBot->Health() <= 70 && pBot->Health() > 40 && pBot->InCombat())
	...
	jle	SHORT $LN1@CalculateD
	mov	ecx, DWORD PTR _pBot$[ebp]
	call	?InCombat@Raven_Bot@@QAE_NXZ		; Raven_Bot::InCombat
	movzx	eax, al
	test	eax, eax
	je	SHORT $LN1@CalculateD

; 28   : 	{
; 29   : 		const double Tweaker = 3.0;

	fld	QWORD PTR __real@4008000000000000
	fstp	QWORD PTR _Tweaker$136244[ebp]

; 30   : 
; 31   : 		float damage = pBot->RecentDamage(mostDangerous);

	mov	ecx, DWORD PTR _mostDangerous$[ebp]
	push	ecx
	mov	ecx, DWORD PTR _pBot$[ebp]
	call	?RecentDamage@Raven_Bot@@QAEHH@Z	; Raven_Bot::RecentDamage
	mov	DWORD PTR tv141[ebp], eax
	fild	DWORD PTR tv141[ebp]
	fstp	DWORD PTR _damage$136245[ebp]

; 32   : 		damage = damage / pBot->MaxHealth(); //creates a fraction of how much damage the enemy has 

	mov	ecx, DWORD PTR _pBot$[ebp]
	call	?MaxHealth@Raven_Bot@@QBEHXZ		; Raven_Bot::MaxHealth
	mov	DWORD PTR tv143[ebp], eax
	fild	DWORD PTR tv143[ebp]
	fdivr	DWORD PTR _damage$136245[ebp]
	fstp	DWORD PTR _damage$136245[ebp]

; 33   : 											 //done relative to the bot
; 34   : 
; 35   : 		Desirability = Tweaker *
; 36   : 			Raven_Feature::Health(pBot) *
; 37   : 			Raven_Feature::TotalWeaponStrength(pBot) +
; 38   : 			damage;
	...
	add	esp, 4
	fmul	QWORD PTR _Tweaker$136244[ebp]
	...
	add	esp, 4
	fmul	QWORD PTR tv157[ebp]
	fadd	DWORD PTR _damage$136245[ebp]
	fstp	QWORD PTR _Desirability$[ebp]

; 39   : 
; 40   : 		//debug_con << "Health: " << Raven_Feature::Health(pBot) << " Weapon Strngth: " << Raven_Feature::TotalWeaponStrength(pBot)
; 41   : 		//	<< "Damage: " << damage << " bot: " << pBot->ID() << "";
; 42   : 
; 43   : 
; 44   : 		//bias the value according to the personality of the bot
; 45   : 		Desirability *= m_dCharacterBias;
...
; 46   : 	}
; 47   : 
; 48   : 	//debug_con << Desirability << " " << pBot->ID() << "";
; 49   : 
...
; 51   : }
	...
	pop	ebp
	ret	4
?CalculateDesirability@AggressiveDefense_Evaluator@@UAENPAVRaven_Bot@@@Z ENDP ; AggressiveDefense_Evaluator::CalculateDesirability
; Function compile flags: /Odtp /RTCsu
...
; 186  :   int           Health()const{return m_iHealth;}
...
; 187  :   int           MaxHealth()const{return m_iMaxHealth;}
...
PUBLIC	?SetGoal@AggressiveDefense_Evaluator@@UAEXPAVRaven_Bot@@@Z ; AggressiveDefense_Evaluator::SetGoal
EXTRN	?AddGoal_AttackTarget@Goal_Think@@QAEXXZ:PROC	; Goal_Think::AddGoal_AttackTarget
EXTRN	?SetNewTarget@Raven_TargetingSystem@@QAEXH@Z:PROC ; Raven_TargetingSystem::SetNewTarget
; Function compile flags: /Odtp /RTCsu
; File c:\users\alec\desktop\gameaisource\vs2010\buckland_chapter7 to 10_raven\goals\aggressivedefense_evaluator.cpp
_TEXT	SEGMENT
_targetId$ = -8						; size = 4
_this$ = -4						; size = 4
_pBot$ = 8						; size = 4
?SetGoal@AggressiveDefense_Evaluator@@UAEXPAVRaven_Bot@@@Z PROC ; AggressiveDefense_Evaluator::SetGoal
; _this$ = ecx
...
; 57   : 	//debug_con << "Attempting to Agress" << "";
; 58   : 	int targetId = pBot->HighestRecentDamage(); //changes the target to the bot w/ most rec damage

	mov	ecx, DWORD PTR _pBot$[ebp]
	call	?HighestRecentDamage@Raven_Bot@@QAEHXZ	; Raven_Bot::HighestRecentDamage
	mov	DWORD PTR _targetId$[ebp], eax

; 59   : 	pBot->GetTargetSys()->SetNewTarget(targetId);
	...
	mov	ecx, eax
	call	?SetNewTarget@Raven_TargetingSystem@@QAEXH@Z ; Raven_TargetingSystem::SetNewTarget

; 60   : 	pBot->GetBrain()->AddGoal_AttackTarget(); //begins attacking that bot
...
; 61   : 	//debug_con << "The best defense is a good offense! GET AGGRESSIVE! " << pBot->ID() <<  "";
; 62   : }
	...
	pop	ebp
	ret	4
?SetGoal@AggressiveDefense_Evaluator@@UAEXPAVRaven_Bot@@@Z ENDP ; AggressiveDefense_Evaluator::SetGoal
; Function compile flags: /Odtp /RTCsu
; File c:\users\alec\desktop\gameaisource\vs2010\buckland_chapter7 to 10_raven\raven_bot.h
_TEXT	ENDS
...
; 267  :   Goal_Think* const                  GetBrain(){return m_pBrain;}
...
; 269  :   Raven_TargetingSystem* const       GetTargetSys(){return m_pTargSys;}
...
PUBLIC	__$ArrayPad$
PUBLIC	?RenderInfo@AggressiveDefense_Evaluator@@UAEXUVector2D@@PAVRaven_Bot@@@Z ; AggressiveDefense_Evaluator::RenderInfo
...
CONST	ENDS
xdata$x	SEGMENT
__ehfuncinfo$?RenderInfo@AggressiveDefense_Evaluator@@UAEXUVector2D@@PAVRaven_Bot@@@Z DD 019930522H
	DD	09H
	DD	FLAT:__unwindtable$?RenderInfo@AggressiveDefense_Evaluator@@UAEXUVector2D@@PAVRaven_Bot@@@Z
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	01H
__unwindtable$?RenderInfo@AggressiveDefense_Evaluator@@UAEXUVector2D@@PAVRaven_Bot@@@Z DD 0ffffffffH
	DD	FLAT:__unwindfunclet$?RenderInfo@AggressiveDefense_Evaluator@@UAEXUVector2D@@PAVRaven_Bot@@@Z$0
	DD	00H
	DD	FLAT:__unwindfunclet$?RenderInfo@AggressiveDefense_Evaluator@@UAEXUVector2D@@PAVRaven_Bot@@@Z$1
	DD	0ffffffffH
	DD	FLAT:__unwindfunclet$?RenderInfo@AggressiveDefense_Evaluator@@UAEXUVector2D@@PAVRaven_Bot@@@Z$2
	DD	02H
	DD	FLAT:__unwindfunclet$?RenderInfo@AggressiveDefense_Evaluator@@UAEXUVector2D@@PAVRaven_Bot@@@Z$3
	DD	03H
	DD	FLAT:__unwindfunclet$?RenderInfo@AggressiveDefense_Evaluator@@UAEXUVector2D@@PAVRaven_Bot@@@Z$4
	DD	04H
	DD	FLAT:__unwindfunclet$?RenderInfo@AggressiveDefense_Evaluator@@UAEXUVector2D@@PAVRaven_Bot@@@Z$5
	DD	03H
	DD	FLAT:__unwindfunclet$?RenderInfo@AggressiveDefense_Evaluator@@UAEXUVector2D@@PAVRaven_Bot@@@Z$5
	DD	02H
	DD	FLAT:__unwindfunclet$?RenderInfo@AggressiveDefense_Evaluator@@UAEXUVector2D@@PAVRaven_Bot@@@Z$5
...
_Position$ = 8						; size = 16
_pBot$ = 24						; size = 4
?RenderInfo@AggressiveDefense_Evaluator@@UAEXUVector2D@@PAVRaven_Bot@@@Z PROC ; AggressiveDefense_Evaluator::RenderInfo
; _this$ = ecx
...
; 67   : {
	...
	mov	ebp, esp
	push	-1
	push	__ehhandler$?RenderInfo@AggressiveDefense_Evaluator@@UAEXUVector2D@@PAVRaven_Bot@@@Z
...
; 68   : 	gdi->TextAtPos(Position, "AT: " + ttos(CalculateDesirability(pBot), 2));
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	fstp	QWORD PTR $T147475[ebp]
	push	2
	lea	ecx, DWORD PTR $T147475[ebp]
	push	ecx
	lea	edx, DWORD PTR $T136262[ebp]
	push	edx
	...
	lea	ecx, DWORD PTR $T136289[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR $T136262[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
...
; 70   : 
; 71   : 	std::string s = ttos(Raven_Feature::Health(pBot)) + ", " + ttos(Raven_Feature::TotalWeaponStrength(pBot));

	mov	edx, DWORD PTR _pBot$[ebp]
	push	edx
	call	?TotalWeaponStrength@Raven_Feature@@SANPAVRaven_Bot@@@Z ; Raven_Feature::TotalWeaponStrength
	add	esp, 4
	fstp	QWORD PTR $T147476[ebp]
	mov	eax, DWORD PTR _pBot$[ebp]
	push	eax
	call	?Health@Raven_Feature@@SANPAVRaven_Bot@@@Z ; Raven_Feature::Health
	add	esp, 4
	fstp	QWORD PTR $T147477[ebp]
	push	2
	lea	ecx, DWORD PTR $T147476[ebp]
	push	ecx
	lea	edx, DWORD PTR $T136322[ebp]
	push	edx
	call	??$ttos@N@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@ABNH@Z ; ttos<double>
	add	esp, 12					; 0000000cH
	...
	push	ecx
	push	OFFSET $SG136388
	push	2
	lea	edx, DWORD PTR $T147477[ebp]
	push	edx
	...
	lea	ecx, DWORD PTR $T136320[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	BYTE PTR __$EHRec$[ebp+8], 7
	lea	ecx, DWORD PTR $T136293[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	BYTE PTR __$EHRec$[ebp+8], 8
	lea	ecx, DWORD PTR $T136322[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >

; 72   : 	gdi->TextAtPos(Position + Vector2D(0, 12), s);
...
_TEXT	ENDS
text$x	SEGMENT
__unwindfunclet$?RenderInfo@AggressiveDefense_Evaluator@@UAEXUVector2D@@PAVRaven_Bot@@@Z$0:
	lea	ecx, DWORD PTR $T136262[ebp]
	jmp	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
__unwindfunclet$?RenderInfo@AggressiveDefense_Evaluator@@UAEXUVector2D@@PAVRaven_Bot@@@Z$1:
	lea	ecx, DWORD PTR $T136289[ebp]
	jmp	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
__unwindfunclet$?RenderInfo@AggressiveDefense_Evaluator@@UAEXUVector2D@@PAVRaven_Bot@@@Z$2:
	lea	ecx, DWORD PTR $T136322[ebp]
	jmp	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
__unwindfunclet$?RenderInfo@AggressiveDefense_Evaluator@@UAEXUVector2D@@PAVRaven_Bot@@@Z$3:
	lea	ecx, DWORD PTR $T136293[ebp]
	jmp	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
__unwindfunclet$?RenderInfo@AggressiveDefense_Evaluator@@UAEXUVector2D@@PAVRaven_Bot@@@Z$4:
	lea	ecx, DWORD PTR $T136320[ebp]
	jmp	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
__unwindfunclet$?RenderInfo@AggressiveDefense_Evaluator@@UAEXUVector2D@@PAVRaven_Bot@@@Z$5:
	lea	ecx, DWORD PTR _s$[ebp]
	jmp	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
__ehhandler$?RenderInfo@AggressiveDefense_Evaluator@@UAEXUVector2D@@PAVRaven_Bot@@@Z:
	...
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$?RenderInfo@AggressiveDefense_Evaluator@@UAEXUVector2D@@PAVRaven_Bot@@@Z
	jmp	___CxxFrameHandler3
text$x	ENDS
?RenderInfo@AggressiveDefense_Evaluator@@UAEXUVector2D@@PAVRaven_Bot@@@Z ENDP ; AggressiveDefense_Evaluator::RenderInfo
; Function compile flags: /Odtp /RTCsu
...
; 1993 : 			_Elem *_Ptr = this->_Bx._Ptr;
	...
	mov	eax, DWORD PTR [edx+4]
	mov	DWORD PTR __Ptr$138284[ebp], eax
...
; 1995 : 				_Traits::copy(this->_Bx._Buf, _Ptr, _Newsize);
	...
	push	ecx
	mov	edx, DWORD PTR __Ptr$138284[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	add	eax, 4
	push	eax
...
; 1996 : 			this->_Alval.deallocate(_Ptr, this->_Myres + 1);
	...
	add	edx, 1
	push	edx
	mov	eax, DWORD PTR __Ptr$138284[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 1954 : 		_Traits::assign(_Myptr()[this->_Mysize = _Newsize], _Elem());
	...
	mov	BYTE PTR $T147553[ebp], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR __Newsize$[ebp]
	mov	DWORD PTR [eax+20], ecx
	lea	edx, DWORD PTR $T147553[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
...
;	COMDAT xdata$x
; File c:\users\alec\desktop\gameaisource\vs2010\common\misc\stream_utility_functions.h
xdata$x	SEGMENT
...
; 27   :   return buffer.str();
	...
	mov	eax, DWORD PTR $T147569[ebp]
	or	eax, 1
	mov	DWORD PTR $T147569[ebp], eax
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR _buffer$[ebp]
...
__unwindfunclet$??$ttos@N@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@ABNH@Z$1:
	...
	and	eax, 1
	je	$LN5@ttos
	and	DWORD PTR $T147569[ebp], -2		; fffffffeH
...
; 127  : 	return (_STD move(_Right.insert(0, _Left)));
	...
	mov	ecx, DWORD PTR $T147587[ebp]
	or	ecx, 1
	mov	DWORD PTR $T147587[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 1118 : 			size_type _Newsize = this->_Mysize - _Count;
	...
	mov	DWORD PTR __Newsize$138263[ebp], eax

; 1119 : 			_Eos(_Newsize);

	mov	ecx, DWORD PTR __Newsize$138263[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Eos@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Eos
$LN1@erase:
...
; 147  : 	return (_STD move(_Left.append(_Right)));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@$$QAV01@@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	ecx, DWORD PTR $T147678[ebp]
	or	ecx, 1
	mov	DWORD PTR $T147678[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 115  : 		return (_STD move(_Left.append(_Right)));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@$$QAV01@@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	ecx, DWORD PTR $T147683[ebp]
	or	ecx, 1
	mov	DWORD PTR $T147683[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 117  : 		return (_STD move(_Right.insert(0, _Left)));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@$$QAV01@@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR $T147683[ebp]
	or	eax, 1
	mov	DWORD PTR $T147683[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
$LN4@operator@2:
...
PUBLIC	??_C@_1IO@HJAGNPCA@?$AAC?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?5?$AA?$CI?$AAx?$AA8?$AA6?$AA?$CJ?$AA?2?$AAM?$AAi?$AAc?$AAr?$AAo?$AAs?$AAo?$AAf?$AAt@ ; `string'
;	COMDAT ??_C@_1IO@HJAGNPCA@?$AAC?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?5?$AA?$CI?$AAx?$AA8?$AA6?$AA?$CJ?$AA?2?$AAM?$AAi?$AAc?$AAr?$AAo?$AAs?$AAo?$AAf?$AAt@
; File c:\program files (x86)\microsoft visual studio 10.0\vc\include\ostream
CONST	SEGMENT
??_C@_1IO@HJAGNPCA@?$AAC?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?5?$AA?$CI?$AAx?$AA8?$AA6?$AA?$CJ?$AA?2?$AAM?$AAi?$AAc?$AAr?$AAo?$AAs?$AAo?$AAf?$AAt@ DB 'C'
	DB	00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H, 'g', 00H
	DB	'r', 00H, 'a', 00H, 'm', 00H, ' ', 00H, 'F', 00H, 'i', 00H, 'l'
	DB	00H, 'e', 00H, 's', 00H, ' ', 00H, '(', 00H, 'x', 00H, '8', 00H
	DB	'6', 00H, ')', 00H, '\', 00H, 'M', 00H, 'i', 00H, 'c', 00H, 'r'
...
; 201  : 		_DEBUG_POINTER(_Pfn);
	...
	push	201					; 000000c9H
	push	OFFSET ??_C@_1IO@HJAGNPCA@?$AAC?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?5?$AA?$CI?$AAx?$AA8?$AA6?$AA?$CJ?$AA?2?$AAM?$AAi?$AAc?$AAr?$AAo?$AAs?$AAo?$AAf?$AAt@
...
; 434  : 			const _Nput& _Nput_fac = _USE(ios_base::getloc(), _Nput);
	...
	add	esp, 4
	mov	DWORD PTR __Nput_fac$142521[ebp], eax
...
$LN7@operator@4:
	...
	mov	edx, DWORD PTR [eax]
	push	edx
	lea	eax, DWORD PTR $T147747[ebp]
	push	eax
	mov	ecx, DWORD PTR __Nput_fac$142521[ebp]
...
; 444  : 		return (*this);
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR $T147748[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+12], -1
	lea	ecx, DWORD PTR __Ok$[ebp]
	call	??1sentry@?$basic_ostream@DU?$char_traits@D@std@@@std@@QAE@XZ ; std::basic_ostream<char,std::char_traits<char> >::sentry::~sentry
	mov	eax, DWORD PTR $T147748[ebp]
...
; 120  : 			_BEGIN_LOCK(_LOCK_LOCALE)
	...
	push	0
	lea	ecx, DWORD PTR __Lock$33879[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
...
; 123  : 				return (_Refs == 0 ? this : 0);
	...
	mov	DWORD PTR $T147771[ebp], eax
	lea	ecx, DWORD PTR __Lock$33879[ebp]
	call	??1_Lockit@std@@QAE@XZ			; std::_Lockit::~_Lockit
	mov	eax, DWORD PTR $T147771[ebp]
...
; 452  : 		return (*_Ploc);
	...
	mov	edx, DWORD PTR $T147779[ebp]
	or	edx, 1
	mov	DWORD PTR $T147779[ebp], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 112  : 			_BEGIN_LOCK(_LOCK_LOCALE)
	...
	push	0
	lea	ecx, DWORD PTR __Lock$33874[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
...
; 319  : 			_THROW_NCEE(failure, "ios_base::failbit set");
	...
	push	1
	lea	edx, DWORD PTR $T147804[ebp]
	push	edx
	call	?make_error_code@std@@YA?AVerror_code@1@W4io_errc@31@@Z ; std::make_error_code
	add	esp, 8
	push	eax
	push	OFFSET ??_C@_0BG@FMKFHCIL@ios_base?3?3failbit?5set?$AA@
	lea	ecx, DWORD PTR $T147803[ebp]
	call	??0failure@ios_base@std@@QAE@PBDABVerror_code@2@@Z ; std::ios_base::failure::failure
	push	OFFSET __TI4?AVfailure@ios_base@std@@
	lea	eax, DWORD PTR $T147803[ebp]
	push	eax
	call	__CxxThrowException@8
...
; 321  : 			_THROW_NCEE(failure, "ios_base::eofbit set");
	...
	push	1
	lea	ecx, DWORD PTR $T147806[ebp]
	push	ecx
	call	?make_error_code@std@@YA?AVerror_code@1@W4io_errc@31@@Z ; std::make_error_code
	add	esp, 8
	push	eax
	push	OFFSET ??_C@_0BF@OOHOMBOF@ios_base?3?3eofbit?5set?$AA@
	lea	ecx, DWORD PTR $T147805[ebp]
	call	??0failure@ios_base@std@@QAE@PBDABVerror_code@2@@Z ; std::ios_base::failure::failure
	push	OFFSET __TI4?AVfailure@ios_base@std@@
	lea	edx, DWORD PTR $T147805[ebp]
	push	edx
	call	__CxxThrowException@8
$LN10@clear@2:
...
; 202  : 		::new ((void _FARQ *)_Ptr) _Ty(_STD forward<_Ty>(_Val));
	...
	add	esp, 8
	mov	DWORD PTR $T147908[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T147908[ebp], 0
	...
	mov	ecx, DWORD PTR $T147908[ebp]
	mov	DWORD PTR [ecx], edx
	mov	DWORD PTR [ecx+4], eax
	mov	edx, DWORD PTR $T147908[ebp]
...
__unwindfunclet$??0?$basic_ostringstream@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@H@Z$0:
	mov	eax, DWORD PTR $T147926[ebp]
	and	eax, 1
	je	$LN5@basic_ostr
	and	DWORD PTR $T147926[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 80					; 00000050H
...
; 593  : 		return (_Stringbuffer.str());
	...
	mov	ecx, DWORD PTR $T147956[ebp]
	or	ecx, 1
	mov	DWORD PTR $T147956[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 359  : 			? _Traits::eof() : _Traits::to_int_type(*_Gninc()));
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	DWORD PTR $T147992[ebp], eax
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T147993[ebp], eax
	lea	ecx, DWORD PTR $T147992[ebp]
	push	ecx
	lea	edx, DWORD PTR $T147993[ebp]
	push	edx
...
; 379  : 			else if (_Traits::eq_int_type(_Traits::eof(), _Meta = uflow()))
	...
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T148002[ebp], eax
	lea	ecx, DWORD PTR __Meta$[ebp]
	push	ecx
	lea	edx, DWORD PTR $T148002[ebp]
	push	edx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	eax, al
...
; 408  : 				overflow(_Traits::to_int_type(*_Ptr))))
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	DWORD PTR $T148013[ebp], eax
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T148014[ebp], eax
	lea	ecx, DWORD PTR $T148013[ebp]
	push	ecx
	lea	edx, DWORD PTR $T148014[ebp]
	push	edx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	eax, al
...
tv195 = -32						; size = 4
$T148056 = -28						; size = 4
__Oldptr$143115 = -24					; size = 4
__Newptr$143114 = -20					; size = 4
__Inc$143109 = -16					; size = 4
__Newsize$143108 = -12					; size = 4
__Oldsize$143107 = -8					; size = 4
_this$ = -4						; size = 4
__Meta$ = 8						; size = 4
...
; 125  : 		if (_Traits::eq_int_type(_Traits::eof(), _Meta))
	...
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T148056[ebp], eax
	lea	edx, DWORD PTR __Meta$[ebp]
	push	edx
	lea	eax, DWORD PTR $T148056[ebp]
	push	eax
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	ecx, al
...
$LN22@overflow:
	...
	mov	DWORD PTR __Oldsize$143107[ebp], eax

; 139  : 			size_t _Newsize = _Oldsize;

	mov	ecx, DWORD PTR __Oldsize$143107[ebp]
	mov	DWORD PTR __Newsize$143108[ebp], ecx

; 140  : 			size_t _Inc = _Newsize / 2 < _MINSIZE
; 141  : 				? _MINSIZE : _Newsize / 2;	// grow by 50 per cent

	mov	edx, DWORD PTR __Newsize$143108[ebp]
	shr	edx, 1
...
$LN23@overflow:
	mov	eax, DWORD PTR __Newsize$143108[ebp]
	shr	eax, 1
	mov	DWORD PTR tv199[ebp], eax
$LN24@overflow:
	mov	ecx, DWORD PTR tv199[ebp]
	mov	DWORD PTR __Inc$143109[ebp], ecx
$LN11@overflow:

; 142  : 
; 143  : 			while (0 < _Inc && INT_MAX - _Inc < _Newsize)

	cmp	DWORD PTR __Inc$143109[ebp], 0
	jbe	SHORT $LN10@overflow
	mov	edx, 2147483647				; 7fffffffH
	sub	edx, DWORD PTR __Inc$143109[ebp]
	cmp	edx, DWORD PTR __Newsize$143108[ebp]
	jae	SHORT $LN10@overflow

; 144  : 				_Inc /= 2;	// increment causes overflow, halve it

	mov	eax, DWORD PTR __Inc$143109[ebp]
	shr	eax, 1
	mov	DWORD PTR __Inc$143109[ebp], eax
...
; 148  : 			_Newsize += _Inc;
	...
	mov	ecx, DWORD PTR __Newsize$143108[ebp]
	add	ecx, DWORD PTR __Inc$143109[ebp]
	mov	DWORD PTR __Newsize$143108[ebp], ecx
...
; 150  : 			_Elem *_Newptr = _Al.allocate(_Newsize);
	...
	call	?allocate@?$allocator@D@std@@QAEPADI@Z	; std::allocator<char>::allocate
	mov	DWORD PTR __Newptr$143114[ebp], eax

; 151  : 			_Elem *_Oldptr = _Mysb::eback();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?eback@?$basic_streambuf@DU?$char_traits@D@std@@@std@@IBEPADXZ ; std::basic_streambuf<char,std::char_traits<char> >::eback
	mov	DWORD PTR __Oldptr$143115[ebp], eax

; 152  : 
; 153  : 			if (0 < _Oldsize)

	cmp	DWORD PTR __Oldsize$143107[ebp], 0
	jbe	SHORT $LN8@overflow

; 154  : 				_Traits::copy(_Newptr, _Oldptr, _Oldsize);

	mov	eax, DWORD PTR __Oldsize$143107[ebp]
	push	eax
	mov	ecx, DWORD PTR __Oldptr$143115[ebp]
	push	ecx
	mov	edx, DWORD PTR __Newptr$143114[ebp]
	push	edx
	call	?copy@?$char_traits@D@std@@SAPADPADPBDI@Z ; std::char_traits<char>::copy
	add	esp, 12					; 0000000cH
$LN8@overflow:
...
; 158  : 				_Seekhigh = _Newptr;
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR __Newptr$143114[ebp]
	mov	DWORD PTR [eax+60], ecx

; 159  : 				_Mysb::setp(_Newptr, _Newptr + _Newsize);

	mov	edx, DWORD PTR __Newptr$143114[ebp]
	add	edx, DWORD PTR __Newsize$143108[ebp]
	push	edx
	mov	eax, DWORD PTR __Newptr$143114[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 167  : 				_Seekhigh = _Newptr + (_Seekhigh - _Oldptr);
	...
	sub	eax, DWORD PTR __Oldptr$143115[ebp]
	add	eax, DWORD PTR __Newptr$143114[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
...
; 180  : 				_Al.deallocate(_Oldptr, _Oldsize);
	...
	mov	ecx, DWORD PTR __Oldsize$143107[ebp]
	push	ecx
	mov	edx, DWORD PTR __Oldptr$143115[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 68					; 00000044H
	call	?deallocate@?$allocator@D@std@@QAEXPADI@Z ; std::allocator<char>::deallocate
...
; 194  : 			&& _Mystate & _Constant)
	...
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T148077[ebp], eax
	lea	eax, DWORD PTR __Meta$[ebp]
	push	eax
	lea	ecx, DWORD PTR $T148077[ebp]
	push	ecx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	edx, al
...
; 46   : 	explicit __CLR_OR_THIS_CALL basic_ostream(
	...
	call	??0?$basic_ios@DU?$char_traits@D@std@@@std@@IAE@XZ ; std::basic_ios<char,std::char_traits<char> >::basic_ios<char,std::char_traits<char> >
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	mov	ecx, DWORD PTR $T148118[ebp]
	or	ecx, 1
	mov	DWORD PTR $T148118[ebp], ecx
$LN1@basic_ostr@2:
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx]
	mov	ecx, DWORD PTR [eax+4]
...
__unwindfunclet$??0?$basic_ostream@DU?$char_traits@D@std@@@std@@QAE@PAV?$basic_streambuf@DU?$char_traits@D@std@@@1@_N@Z$0:
	mov	eax, DWORD PTR $T148118[ebp]
	and	eax, 1
	je	$LN5@basic_ostr@2
	and	DWORD PTR $T148118[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 8
	jmp	??1?$basic_ios@DU?$char_traits@D@std@@@std@@UAE@XZ ; std::basic_ios<char,std::char_traits<char> >::~basic_ios<char,std::char_traits<char> >
$LN5@basic_ostr@2:
...
tv91 = -148						; size = 4
$T148156 = -144						; size = 4
__Nul$143470 = -136					; size = 32
__Str$143468 = -96					; size = 32
__Str$143465 = -56					; size = 32
_this$ = -20						; size = 4
__$ArrayPad$ = -16					; size = 4
__$EHRec$ = -12						; size = 12
___$ReturnUdt$ = 8					; size = 4
...
$LN8@str:
	...
	call	?pbase@?$basic_streambuf@DU?$char_traits@D@std@@@std@@IBEPADXZ ; std::basic_streambuf<char,std::char_traits<char> >::pbase
	push	eax
	lea	ecx, DWORD PTR __Str$143465[ebp]
...
; 98   : 			return (_Str);
	...
	lea	eax, DWORD PTR __Str$143465[ebp]
	push	eax
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@$$QAV01@@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	ecx, DWORD PTR $T148156[ebp]
	or	ecx, 1
	mov	DWORD PTR $T148156[ebp], ecx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Str$143465[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 102  : 			_Mystr _Str(_Mysb::eback(), _Mysb::egptr() - _Mysb::eback());
	...
	call	?eback@?$basic_streambuf@DU?$char_traits@D@std@@@std@@IBEPADXZ ; std::basic_streambuf<char,std::char_traits<char> >::eback
	push	eax
	lea	ecx, DWORD PTR __Str$143468[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBDI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	DWORD PTR __$EHRec$[ebp+8], 2
...
; 103  : 			return (_Str);
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@$$QAV01@@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	edx, DWORD PTR $T148156[ebp]
	or	edx, 1
	mov	DWORD PTR $T148156[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Str$143468[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 107  : 			_Mystr _Nul;
	...
	lea	ecx, DWORD PTR __Nul$143470[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	DWORD PTR __$EHRec$[ebp+8], 3

; 108  : 			return (_Nul);

	lea	eax, DWORD PTR __Nul$143470[ebp]
	push	eax
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@$$QAV01@@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	ecx, DWORD PTR $T148156[ebp]
...
__unwindfunclet$?str@?$basic_stringbuf@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBE?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@2@XZ$1:
	mov	eax, DWORD PTR $T148156[ebp]
	and	eax, 1
	je	$LN11@str
	and	DWORD PTR $T148156[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
$LN11@str:
	ret	0
...
; 564  : 		_Ploc = _NEW_CRT locale;
	...
	add	esp, 16					; 00000010H
	mov	DWORD PTR $T148207[ebp], eax
	cmp	DWORD PTR $T148207[ebp], 0
	je	SHORT $LN3@Init
	mov	ecx, DWORD PTR $T148207[ebp]
...
; 25   : 		{	// construct with no buffers
	...
	call	??2@YAPAXIABU_DebugHeapTag_t@std@@PADH@Z ; operator new
	add	esp, 16					; 00000010H
	mov	DWORD PTR $T148216[ebp], eax
	cmp	DWORD PTR $T148216[ebp], 0
	je	SHORT $LN3@basic_stre
	mov	ecx, DWORD PTR $T148216[ebp]
	call	??0locale@std@@QAE@XZ			; std::locale::locale
	mov	DWORD PTR tv79[ebp], eax
...
; 320  : 			_Elem *_Pnew = _Al.allocate(_Count);
	...
	add	ecx, 68					; 00000044H
	call	?allocate@?$allocator@D@std@@QAEPADI@Z	; std::allocator<char>::allocate
	mov	DWORD PTR __Pnew$143754[ebp], eax
...
; 321  : 			_Traits::copy(_Pnew, _Ptr, _Count);
	...
	mov	ecx, DWORD PTR __Ptr$[ebp]
	push	ecx
	mov	edx, DWORD PTR __Pnew$143754[ebp]
	push	edx
	call	?copy@?$char_traits@D@std@@SAPADPADPBDI@Z ; std::char_traits<char>::copy
	add	esp, 12					; 0000000cH
...
; 322  : 			_Seekhigh = _Pnew + _Count;
	...
	mov	eax, DWORD PTR __Pnew$143754[ebp]
	add	eax, DWORD PTR __Count$[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [ecx+60], eax
...
; 326  : 					_Pnew + _Count);	// setup read buffer
	...
	mov	ecx, DWORD PTR __Pnew$143754[ebp]
	add	ecx, DWORD PTR __Count$[ebp]
	push	ecx
	mov	edx, DWORD PTR __Pnew$143754[ebp]
	push	edx
...
$T148249 = -64						; size = 4
$T148248 = -60						; size = 12
__Pfmod$140866 = -48					; size = 4
__Pf$140850 = -44					; size = 4
__Id$140849 = -40					; size = 4
__Psave$140837 = -32					; size = 4
__Lock$140836 = -20					; size = 4
__$EHRec$ = -12						; size = 12
__Loc$ = 8						; size = 4
...
; 505  : 	_BEGIN_LOCK(_LOCK_LOCALE)	// the thread lock, make get atomic
	...
	push	0
	lea	ecx, DWORD PTR __Lock$140836[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
	mov	DWORD PTR __$EHRec$[ebp+8], 0
...
; 507  : 			_Facetptr<_Facet>::_Psave;	// static pointer to lazy facet
	...
	mov	DWORD PTR __Psave$140837[ebp], eax
...
; 514  : 		else if (_Psave != 0)
	...
	cmp	DWORD PTR __Psave$140837[ebp], 0
	je	SHORT $LN4@use_facet

; 515  : 			_Pf = _Psave;	// lazy facet already allocated

	mov	edx, DWORD PTR __Psave$140837[ebp]
	mov	DWORD PTR __Pf$140850[ebp], edx
	jmp	SHORT $LN5@use_facet
$LN4@use_facet:
...
; 516  : 		else if (_Facet::_Getcat(&_Psave, &_Loc) == (size_t)(-1))
	...
	push	eax
	lea	ecx, DWORD PTR __Psave$140837[ebp]
	push	ecx
...
; 520  : 			_THROW_NCEE(bad_cast, _EMPTY_ARGUMENT);	// lazy disallowed
	...
	lea	ecx, DWORD PTR $T148248[ebp]
	call	??0bad_cast@std@@QAE@PBD@Z		; std::bad_cast::bad_cast
	push	OFFSET __TI2?AVbad_cast@std@@
	lea	edx, DWORD PTR $T148248[ebp]
	push	edx
	call	__CxxThrowException@8
...
; 528  : 			_Pf = _Psave;
	...
	mov	eax, DWORD PTR __Psave$140837[ebp]
	mov	DWORD PTR __Pf$140850[ebp], eax

; 529  : 			_Facetptr<_Facet>::_Psave = _Psave;

	mov	ecx, DWORD PTR __Psave$140837[ebp]
...
; 531  : 			locale::facet *_Pfmod = (_Facet *)_Psave;
	...
	mov	edx, DWORD PTR __Psave$140837[ebp]
	mov	DWORD PTR __Pfmod$140866[ebp], edx

; 532  : 			_Pfmod->_Incref();

	mov	ecx, DWORD PTR __Pfmod$140866[ebp]
	call	?_Incref@facet@locale@std@@QAEXXZ	; std::locale::facet::_Incref
...
; 536  : 		return ((const _Facet&)(*_Pf));	// should be dynamic_cast
	...
	mov	eax, DWORD PTR __Pf$140850[ebp]
	mov	DWORD PTR $T148249[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Lock$140836[ebp]
	call	??1_Lockit@std@@QAE@XZ			; std::_Lockit::~_Lockit
	mov	eax, DWORD PTR $T148249[ebp]
$LN8@use_facet:
...
; 78   : 				_BEGIN_LOCK(_LOCK_LOCALE)
	...
	push	0
	lea	ecx, DWORD PTR __Lock$33868[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
...
; 2374 : 				_Locinfo(_Ploc->c_str()));
	...
	mov	BYTE PTR __$EHRec$[ebp+8], 1
	mov	eax, DWORD PTR $T148285[ebp]
	or	eax, 1
	mov	DWORD PTR $T148285[ebp], eax
	mov	ecx, DWORD PTR tv133[ebp]
	push	ecx
	mov	ecx, DWORD PTR $T148279[ebp]
...
$LN5@Getcat:
	...
	mov	DWORD PTR $T148278[ebp], edx
	mov	DWORD PTR __$EHRec$[ebp+8], 2
	mov	eax, DWORD PTR __Ppf$[ebp]
	mov	ecx, DWORD PTR $T148278[ebp]
	mov	DWORD PTR [eax], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	edx, DWORD PTR $T148285[ebp]
	and	edx, 1
	je	SHORT $LN1@Getcat
	and	DWORD PTR $T148285[ebp], -2		; fffffffeH
	lea	ecx, DWORD PTR $T148281[ebp]
...
; 118  : 		return (::_Getctype());
	...
	lea	eax, DWORD PTR $T148359[ebp]
	push	eax
	call	__Getctype
	add	esp, 4
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR $T148358[ebp], ecx
	mov	edx, DWORD PTR [eax+4]
	mov	DWORD PTR $T148358[ebp+4], edx
	mov	ecx, DWORD PTR [eax+8]
	mov	DWORD PTR $T148358[ebp+8], ecx
	mov	edx, DWORD PTR [eax+12]
	mov	DWORD PTR $T148358[ebp+12], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
	mov	ecx, DWORD PTR $T148358[ebp]
	mov	DWORD PTR [eax], ecx
	mov	edx, DWORD PTR $T148358[ebp+4]
	mov	DWORD PTR [eax+4], edx
	mov	ecx, DWORD PTR $T148358[ebp+8]
	mov	DWORD PTR [eax+8], ecx
	mov	edx, DWORD PTR $T148358[ebp+12]
...
; 2408 : 			delete[] (void *)_Ctype._Table;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+16]
	mov	DWORD PTR $T148389[ebp], edx
	mov	eax, DWORD PTR $T148389[ebp]
	push	eax
...
$T148427 = -64						; size = 4
$T148426 = -60						; size = 12
__Pfmod$144350 = -48					; size = 4
__Pf$144339 = -44					; size = 4
__Id$144338 = -40					; size = 4
__Psave$144326 = -32					; size = 4
__Lock$144325 = -20					; size = 4
__$EHRec$ = -12						; size = 12
__Loc$ = 8						; size = 4
...
; 505  : 	_BEGIN_LOCK(_LOCK_LOCALE)	// the thread lock, make get atomic
	...
	push	0
	lea	ecx, DWORD PTR __Lock$144325[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
	mov	DWORD PTR __$EHRec$[ebp+8], 0
...
; 507  : 			_Facetptr<_Facet>::_Psave;	// static pointer to lazy facet
	...
	mov	DWORD PTR __Psave$144326[ebp], eax
...
; 509  : 		size_t _Id = _Facet::id;
	...
	call	??Bid@locale@std@@QAEIXZ		; std::locale::id::operator unsigned int
	mov	DWORD PTR __Id$144338[ebp], eax

; 510  : 		const locale::facet *_Pf = _Loc._Getfacet(_Id);

	mov	ecx, DWORD PTR __Id$144338[ebp]
	push	ecx
	mov	ecx, DWORD PTR __Loc$[ebp]
	call	?_Getfacet@locale@std@@QBEPBVfacet@12@I@Z ; std::locale::_Getfacet
	mov	DWORD PTR __Pf$144339[ebp], eax

; 511  : 
; 512  : 		if (_Pf != 0)

	cmp	DWORD PTR __Pf$144339[ebp], 0
...
; 514  : 		else if (_Psave != 0)
	...
	cmp	DWORD PTR __Psave$144326[ebp], 0
	je	SHORT $LN4@use_facet@2

; 515  : 			_Pf = _Psave;	// lazy facet already allocated

	mov	edx, DWORD PTR __Psave$144326[ebp]
	mov	DWORD PTR __Pf$144339[ebp], edx
	jmp	SHORT $LN5@use_facet@2
$LN4@use_facet@2:
...
; 516  : 		else if (_Facet::_Getcat(&_Psave, &_Loc) == (size_t)(-1))
	...
	mov	eax, DWORD PTR __Loc$[ebp]
	push	eax
	lea	ecx, DWORD PTR __Psave$144326[ebp]
	push	ecx
...
; 520  : 			_THROW_NCEE(bad_cast, _EMPTY_ARGUMENT);	// lazy disallowed
	...
	push	OFFSET ??_C@_08EPJLHIJG@bad?5cast?$AA@
	lea	ecx, DWORD PTR $T148426[ebp]
	call	??0bad_cast@std@@QAE@PBD@Z		; std::bad_cast::bad_cast
	push	OFFSET __TI2?AVbad_cast@std@@
	lea	edx, DWORD PTR $T148426[ebp]
	push	edx
	call	__CxxThrowException@8
...
; 528  : 			_Pf = _Psave;
	...
	mov	eax, DWORD PTR __Psave$144326[ebp]
	mov	DWORD PTR __Pf$144339[ebp], eax

; 529  : 			_Facetptr<_Facet>::_Psave = _Psave;

	mov	ecx, DWORD PTR __Psave$144326[ebp]
...
; 531  : 			locale::facet *_Pfmod = (_Facet *)_Psave;
	...
	mov	edx, DWORD PTR __Psave$144326[ebp]
	mov	DWORD PTR __Pfmod$144350[ebp], edx

; 532  : 			_Pfmod->_Incref();

	mov	ecx, DWORD PTR __Pfmod$144350[ebp]
	call	?_Incref@facet@locale@std@@QAEXXZ	; std::locale::facet::_Incref
...
; 536  : 		return ((const _Facet&)(*_Pf));	// should be dynamic_cast
	...
	mov	eax, DWORD PTR __Pf$144339[ebp]
	mov	DWORD PTR $T148427[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Lock$144325[ebp]
	call	??1_Lockit@std@@QAE@XZ			; std::_Lockit::~_Lockit
	mov	eax, DWORD PTR $T148427[ebp]
$LN8@use_facet@2:
...
PUBLIC	??_C@_0EH@CBNPAENE@C?3?2Program?5Files?5?$CIx86?$CJ?2Microsoft@ ; `string'
;	COMDAT ??_C@_0EH@CBNPAENE@C?3?2Program?5Files?5?$CIx86?$CJ?2Microsoft@
; File c:\program files (x86)\microsoft visual studio 10.0\vc\include\xlocnum
CONST	SEGMENT
??_C@_0EH@CBNPAENE@C?3?2Program?5Files?5?$CIx86?$CJ?2Microsoft@ DB 'C:\Pr'
	DB	'ogram Files (x86)\Microsoft Visual Studio 10.0\VC\include\xlo'
	DB	'cnum', 00H					; `string'
CONST	ENDS
;	COMDAT xdata$x
...
; 1054 : 				_Locinfo(_Ploc->c_str()));
	...
	call	?_DebugHeapTag_func@std@@YAABU_DebugHeapTag_t@1@XZ ; std::_DebugHeapTag_func
	mov	DWORD PTR $T148446[ebp], eax
	push	1053					; 0000041dH
	push	OFFSET ??_C@_0EH@CBNPAENE@C?3?2Program?5Files?5?$CIx86?$CJ?2Microsoft@
	mov	ecx, DWORD PTR $T148446[ebp]
	push	ecx
	push	16					; 00000010H
	call	??2facet@locale@std@@SAPAXIABU_DebugHeapTag_t@2@PADH@Z ; std::locale::facet::operator new
	add	esp, 16					; 00000010H
	mov	DWORD PTR $T148445[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T148445[ebp], 0
	je	SHORT $LN4@Getcat@2
	push	0
	mov	ecx, DWORD PTR __Ploc$[ebp]
	call	?c_str@locale@std@@QBEPBDXZ		; std::locale::c_str
	push	eax
	lea	ecx, DWORD PTR $T148447[ebp]
	call	??0_Locinfo@std@@QAE@PBD@Z		; std::_Locinfo::_Locinfo
	mov	DWORD PTR tv138[ebp], eax
	mov	edx, DWORD PTR tv138[ebp]
	mov	DWORD PTR tv133[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 1
	mov	eax, DWORD PTR $T148451[ebp]
	or	eax, 1
	mov	DWORD PTR $T148451[ebp], eax
	mov	ecx, DWORD PTR tv133[ebp]
	push	ecx
	mov	ecx, DWORD PTR $T148445[ebp]
...
$LN5@Getcat@2:
	mov	edx, DWORD PTR tv92[ebp]
	mov	DWORD PTR $T148444[ebp], edx
	mov	DWORD PTR __$EHRec$[ebp+8], 2
	mov	eax, DWORD PTR __Ppf$[ebp]
	mov	ecx, DWORD PTR $T148444[ebp]
	mov	DWORD PTR [eax], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	edx, DWORD PTR $T148451[ebp]
	and	edx, 1
	je	SHORT $LN1@Getcat@2
	and	DWORD PTR $T148451[ebp], -2		; fffffffeH
	lea	ecx, DWORD PTR $T148447[ebp]
	call	??1_Locinfo@std@@QAE@XZ			; std::_Locinfo::~_Locinfo
$LN1@Getcat@2:
...
PUBLIC	??_C@_1IO@CCDFGOKO@?$AAC?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?5?$AA?$CI?$AAx?$AA8?$AA6?$AA?$CJ?$AA?2?$AAM?$AAi?$AAc?$AAr?$AAo?$AAs?$AAo?$AAf?$AAt@ ; `string'
PUBLIC	__$ArrayPad$
;	COMDAT ??_C@_1IO@CCDFGOKO@?$AAC?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?5?$AA?$CI?$AAx?$AA8?$AA6?$AA?$CJ?$AA?2?$AAM?$AAi?$AAc?$AAr?$AAo?$AAs?$AAo?$AAf?$AAt@
CONST	SEGMENT
??_C@_1IO@CCDFGOKO@?$AAC?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?5?$AA?$CI?$AAx?$AA8?$AA6?$AA?$CJ?$AA?2?$AAM?$AAi?$AAc?$AAr?$AAo?$AAs?$AAo?$AAf?$AAt@ DB 'C'
	DB	00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H, 'g', 00H
	DB	'r', 00H, 'a', 00H, 'm', 00H, ' ', 00H, 'F', 00H, 'i', 00H, 'l'
	DB	00H, 'e', 00H, 's', 00H, ' ', 00H, '(', 00H, 'x', 00H, '8', 00H
	DB	'6', 00H, ')', 00H, '\', 00H, 'M', 00H, 'i', 00H, 'c', 00H, 'r'
...
$T148476 = -144						; size = 8
$T148473 = -136						; size = 4
__Fillcount$143561 = -132				; size = 4
$T143560 = -128						; size = 32
$T143558 = -96						; size = 32
__Str$143501 = -60					; size = 32
__Punct_fac$143494 = -24				; size = 4
_this$ = -20						; size = 4
__$ArrayPad$ = -16					; size = 4
__$EHRec$ = -12						; size = 12
___$ReturnUdt$ = 8					; size = 4
...
; 1144 : 		_DEBUG_POINTER(_Dest);
	...
	push	1144					; 00000478H
	push	OFFSET ??_C@_1IO@CCDFGOKO@?$AAC?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?5?$AA?$CI?$AAx?$AA8?$AA6?$AA?$CJ?$AA?2?$AAM?$AAi?$AAc?$AAr?$AAo?$AAs?$AAo?$AAf?$AAt@
...
; 1149 : 			const _Mypunct& _Punct_fac = _USE(_Iosbase.getloc(), _Mypunct);
	...
	add	esp, 4
	mov	DWORD PTR __Punct_fac$143494[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR $T148473[ebp]
	call	??1locale@std@@QAE@XZ			; std::locale::~locale
...
; 1150 : 			_Mystr _Str;
	...
	lea	ecx, DWORD PTR __Str$143501[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	DWORD PTR __$EHRec$[ebp+8], 1
...
; 1152 : 				_Str.assign(_Punct_fac.truename());
	...
	lea	edx, DWORD PTR $T143558[ebp]
	push	edx
	mov	ecx, DWORD PTR __Punct_fac$143494[ebp]
...
$LN9@do_put:
	...
	mov	DWORD PTR __Fillcount$143561[ebp], edx
...
; 1162 : 				_Dest = _Rep(_Dest, _Fill, _Fillcount);
	...
	mov	eax, DWORD PTR __Fillcount$143561[ebp]
	push	eax
...
; 1163 : 				_Fillcount = 0;
	...
	mov	DWORD PTR __Fillcount$143561[ebp], 0
$LN1@do_put:
...
$LN18@do_put@6:
	...
	mov	BYTE PTR __Signed$143607[ebp], cl

; 1230 : 			if (_Signed)

	movzx	edx, BYTE PTR __Signed$143607[ebp]
	test	edx, edx
...
; 1244 : 			if (_Signed)
	...
	movzx	ecx, BYTE PTR __Signed$143607[ebp]
	test	ecx, ecx
...
$LN18@do_put@7:
	...
	mov	BYTE PTR __Signed$143630[ebp], cl

; 1271 : 			if (_Signed)

	movzx	edx, BYTE PTR __Signed$143630[ebp]
	test	edx, edx
...
; 1285 : 			if (_Signed)
	...
	movzx	ecx, BYTE PTR __Signed$143630[ebp]
	test	ecx, ecx
...
$T148591 = -168						; size = 8
$T148586 = -160						; size = 4
__Expoffset$143832 = -156				; size = 4
__Fracoffset$143825 = -152				; size = 4
__Adjustfield$ = -148					; size = 4
__Fillcount$ = -144					; size = 4
__Off$143805 = -140					; size = 4
__Pg$143804 = -136					; size = 4
...
; 1380 : 			const char *_Pg = _Grouping.c_str();
	...
	lea	ecx, DWORD PTR __Grouping$[ebp]
	call	?c_str@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::c_str
	mov	DWORD PTR __Pg$143804[ebp], eax
...
; 1381 : 			size_t _Off = _CSTD strcspn(&_Groupstring[0], &_Enders[0]);
	...
	call	_strcspn
	add	esp, 8
	mov	DWORD PTR __Off$143805[ebp], eax
$LN9@Fput:

; 1382 : 			while (*_Pg != CHAR_MAX && '\0' < *_Pg
; 1383 : 				&& (size_t)*_Pg < _Off - _Prefix)

	mov	edx, DWORD PTR __Pg$143804[ebp]
	movsx	eax, BYTE PTR [edx]
	cmp	eax, 127				; 0000007fH
	je	SHORT $LN8@Fput
	mov	ecx, DWORD PTR __Pg$143804[ebp]
	movsx	edx, BYTE PTR [ecx]
	test	edx, edx
	jle	SHORT $LN8@Fput
	mov	eax, DWORD PTR __Pg$143804[ebp]
	movsx	ecx, BYTE PTR [eax]
	mov	edx, DWORD PTR __Off$143805[ebp]
...
; 1385 : 				_Groupstring.insert(_Off -= *_Pg, (size_t)1, '\0');
	...
	mov	edx, DWORD PTR __Off$143805[ebp]
	sub	edx, ecx
	mov	DWORD PTR __Off$143805[ebp], edx
	push	0
	push	1
	mov	eax, DWORD PTR __Off$143805[ebp]
	push	eax
	lea	ecx, DWORD PTR __Groupstring$[ebp]
	call	?insert@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV12@IID@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::insert
...
; 1427 : 			_Buf += _Fracoffset, _Count -= _Fracoffset;
	...
	mov	eax, DWORD PTR __Buf$[ebp]
	add	eax, DWORD PTR __Fracoffset$143825[ebp]
	mov	DWORD PTR __Buf$[ebp], eax
	mov	ecx, DWORD PTR __Count$[ebp]
	sub	ecx, DWORD PTR __Fracoffset$143825[ebp]
	mov	DWORD PTR __Count$[ebp], ecx
$LN2@Fput:
...
; 1439 : 			_Buf += _Expoffset, _Count -= _Expoffset;
	...
	mov	ecx, DWORD PTR __Buf$[ebp]
	add	ecx, DWORD PTR __Expoffset$143832[ebp]
	mov	DWORD PTR __Buf$[ebp], ecx
	mov	edx, DWORD PTR __Count$[ebp]
	sub	edx, DWORD PTR __Expoffset$143832[ebp]
	mov	DWORD PTR __Count$[ebp], edx
$LN1@Fput:
...
__Off$143860 = -72					; size = 4
__Pg$143859 = -68					; size = 4
__Prefix$ = -64						; size = 4
__Grouping$ = -56					; size = 32
__Punct_fac$ = -20					; size = 4
__$ArrayPad$ = -16					; size = 4
...
; 1489 : 			const char *_Pg = _Grouping.c_str();
	...
	lea	ecx, DWORD PTR __Grouping$[ebp]
	call	?c_str@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::c_str
	mov	DWORD PTR __Pg$143859[ebp], eax

; 1490 : 			size_t _Off = _Count;

	mov	ecx, DWORD PTR __Count$[ebp]
	mov	DWORD PTR __Off$143860[ebp], ecx
$LN6@Iput:

; 1491 : 			while (*_Pg != CHAR_MAX && '\0' < *_Pg
; 1492 : 				&& (size_t)*_Pg < _Off - _Prefix)

	mov	edx, DWORD PTR __Pg$143859[ebp]
	movsx	eax, BYTE PTR [edx]
	cmp	eax, 127				; 0000007fH
	je	$LN7@Iput
	mov	ecx, DWORD PTR __Pg$143859[ebp]
	movsx	edx, BYTE PTR [ecx]
	test	edx, edx
	jle	SHORT $LN7@Iput
	mov	eax, DWORD PTR __Pg$143859[ebp]
	movsx	ecx, BYTE PTR [eax]
	mov	edx, DWORD PTR __Off$143860[ebp]
	sub	edx, DWORD PTR __Prefix$[ebp]
	cmp	ecx, edx
	jae	SHORT $LN7@Iput
...
; 1494 : 				_Off -= *_Pg;
	...
	mov	edx, DWORD PTR __Off$143860[ebp]
	sub	edx, ecx
	mov	DWORD PTR __Off$143860[ebp], edx
...
; 1497 : 				_CRT_SECURE_MEMMOVE(&_Buf[_Off + 1], _Count + 1 - _Off,
	...
	mov	eax, DWORD PTR __Count$[ebp]
	add	eax, 1
	sub	eax, DWORD PTR __Off$143860[ebp]
	push	eax
	mov	ecx, DWORD PTR __Buf$[ebp]
	add	ecx, DWORD PTR __Off$143860[ebp]
	push	ecx
	mov	edx, DWORD PTR __Count$[ebp]
	add	edx, 1
	sub	edx, DWORD PTR __Off$143860[ebp]
	push	edx
	mov	eax, DWORD PTR __Off$143860[ebp]
	mov	ecx, DWORD PTR __Buf$[ebp]
...
; 1500 : 				_Buf[_Off] = '\0', ++_Count;
	...
	mov	eax, DWORD PTR __Buf$[ebp]
	add	eax, DWORD PTR __Off$143860[ebp]
	mov	BYTE PTR [eax], 0
	mov	ecx, DWORD PTR __Count$[ebp]
	add	ecx, 1
	mov	DWORD PTR __Count$[ebp], ecx
...
; 1502 : 					++_Pg;	// not last group, advance
	...
	mov	ecx, DWORD PTR __Pg$143859[ebp]
	add	ecx, 1
	mov	DWORD PTR __Pg$143859[ebp], ecx
$LN4@Iput:
...
; 84   : 		return (do_falsename());
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	ecx, DWORD PTR $T148668[ebp]
	or	ecx, 1
	mov	DWORD PTR $T148668[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 89   : 		return (do_truename());
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	ecx, DWORD PTR $T148673[ebp]
	or	ecx, 1
	mov	DWORD PTR $T148673[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
$T148684 = -24						; size = 8
$T148683 = -16						; size = 8
__Groupsize$144005 = -8					; size = 4
__Pend$144003 = -4					; size = 4
_this$ = 8						; size = 4
___$ReturnUdt$ = 12					; size = 4
__Dest$ = 16						; size = 8
__Ptr$ = 24						; size = 4
...
; 1553 : 				(const char *)_CSTD memchr(_Ptr, '\0', _Count);
	...
	call	_memchr
	add	esp, 12					; 0000000cH
	mov	DWORD PTR __Pend$144003[ebp], eax

; 1554 : 			size_t _Groupsize = _Pend != 0 ? _Pend - _Ptr : _Count;

	cmp	DWORD PTR __Pend$144003[ebp], 0
	je	SHORT $LN8@Putgrouped
	mov	ecx, DWORD PTR __Pend$144003[ebp]
...
$LN9@Putgrouped:
	...
	mov	DWORD PTR __Groupsize$144005[ebp], eax

; 1555 : 
; 1556 : 			_Dest = _Putc(_Dest, _Ptr, _Groupsize);

	mov	ecx, DWORD PTR __Groupsize$144005[ebp]
	push	ecx
	mov	edx, DWORD PTR __Ptr$[ebp]
	push	edx
	mov	eax, DWORD PTR __Dest$[ebp+4]
...
; 1557 : 			_Ptr += _Groupsize, _Count -= _Groupsize;
	...
	mov	eax, DWORD PTR __Ptr$[ebp]
	add	eax, DWORD PTR __Groupsize$144005[ebp]
	mov	DWORD PTR __Ptr$[ebp], eax
	mov	ecx, DWORD PTR __Count$[ebp]
	sub	ecx, DWORD PTR __Groupsize$144005[ebp]
	mov	DWORD PTR __Count$[ebp], ecx
...
; 625  : 				_Strbuf->sputc(_Right)))
	...
	mov	DWORD PTR $T148687[ebp], eax
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T148688[ebp], eax
	lea	eax, DWORD PTR $T148687[ebp]
	push	eax
	lea	ecx, DWORD PTR $T148688[ebp]
	push	ecx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	edx, al
...
$LN5@sputc:
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Pninc@?$basic_streambuf@DU?$char_traits@D@std@@@std@@IAEPADXZ ; std::basic_streambuf<char,std::char_traits<char> >::_Pninc
	mov	DWORD PTR $T148691[ebp], eax
	mov	eax, DWORD PTR $T148691[ebp]
	mov	cl, BYTE PTR __Ch$[ebp]
	mov	BYTE PTR [eax], cl
	mov	edx, DWORD PTR $T148691[ebp]
	push	edx
	call	?to_int_type@?$char_traits@D@std@@SAHABD@Z ; std::char_traits<char>::to_int_type
	add	esp, 4
	mov	DWORD PTR tv78[ebp], eax
...
; 79   : 		return (do_grouping());
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	ecx, DWORD PTR $T148706[ebp]
	or	ecx, 1
	mov	DWORD PTR $T148706[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
$T148713 = -64						; size = 4
$T148712 = -60						; size = 12
__Pfmod$144429 = -48					; size = 4
__Pf$144418 = -44					; size = 4
__Id$144417 = -40					; size = 4
__Psave$144405 = -32					; size = 4
__Lock$144404 = -20					; size = 4
__$EHRec$ = -12						; size = 12
__Loc$ = 8						; size = 4
...
; 505  : 	_BEGIN_LOCK(_LOCK_LOCALE)	// the thread lock, make get atomic
	...
	push	0
	lea	ecx, DWORD PTR __Lock$144404[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
	mov	DWORD PTR __$EHRec$[ebp+8], 0
...
; 507  : 			_Facetptr<_Facet>::_Psave;	// static pointer to lazy facet
	...
	mov	DWORD PTR __Psave$144405[ebp], eax
...
; 509  : 		size_t _Id = _Facet::id;
	...
	call	??Bid@locale@std@@QAEIXZ		; std::locale::id::operator unsigned int
	mov	DWORD PTR __Id$144417[ebp], eax

; 510  : 		const locale::facet *_Pf = _Loc._Getfacet(_Id);

	mov	ecx, DWORD PTR __Id$144417[ebp]
	push	ecx
	mov	ecx, DWORD PTR __Loc$[ebp]
	call	?_Getfacet@locale@std@@QBEPBVfacet@12@I@Z ; std::locale::_Getfacet
	mov	DWORD PTR __Pf$144418[ebp], eax

; 511  : 
; 512  : 		if (_Pf != 0)

	cmp	DWORD PTR __Pf$144418[ebp], 0
...
; 514  : 		else if (_Psave != 0)
	...
	cmp	DWORD PTR __Psave$144405[ebp], 0
	je	SHORT $LN4@use_facet@3

; 515  : 			_Pf = _Psave;	// lazy facet already allocated

	mov	edx, DWORD PTR __Psave$144405[ebp]
	mov	DWORD PTR __Pf$144418[ebp], edx
	jmp	SHORT $LN5@use_facet@3
$LN4@use_facet@3:
...
; 516  : 		else if (_Facet::_Getcat(&_Psave, &_Loc) == (size_t)(-1))
	...
	mov	eax, DWORD PTR __Loc$[ebp]
	push	eax
	lea	ecx, DWORD PTR __Psave$144405[ebp]
	push	ecx
...
; 520  : 			_THROW_NCEE(bad_cast, _EMPTY_ARGUMENT);	// lazy disallowed
	...
	push	OFFSET ??_C@_08EPJLHIJG@bad?5cast?$AA@
	lea	ecx, DWORD PTR $T148712[ebp]
	call	??0bad_cast@std@@QAE@PBD@Z		; std::bad_cast::bad_cast
	push	OFFSET __TI2?AVbad_cast@std@@
	lea	edx, DWORD PTR $T148712[ebp]
	push	edx
	call	__CxxThrowException@8
...
; 528  : 			_Pf = _Psave;
	...
	mov	eax, DWORD PTR __Psave$144405[ebp]
	mov	DWORD PTR __Pf$144418[ebp], eax

; 529  : 			_Facetptr<_Facet>::_Psave = _Psave;

	mov	ecx, DWORD PTR __Psave$144405[ebp]
...
; 531  : 			locale::facet *_Pfmod = (_Facet *)_Psave;
	...
	mov	edx, DWORD PTR __Psave$144405[ebp]
	mov	DWORD PTR __Pfmod$144429[ebp], edx

; 532  : 			_Pfmod->_Incref();

	mov	ecx, DWORD PTR __Pfmod$144429[ebp]
	call	?_Incref@facet@locale@std@@QAEXXZ	; std::locale::facet::_Incref
...
; 536  : 		return ((const _Facet&)(*_Pf));	// should be dynamic_cast
	...
	mov	eax, DWORD PTR __Pf$144418[ebp]
	mov	DWORD PTR $T148713[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Lock$144404[ebp]
	call	??1_Lockit@std@@QAE@XZ			; std::_Lockit::~_Lockit
	mov	eax, DWORD PTR $T148713[ebp]
$LN8@use_facet@3:
...
; 114  : 				_Locinfo(_Ploc->c_str()), 0, true);
	...
	call	?_DebugHeapTag_func@std@@YAABU_DebugHeapTag_t@1@XZ ; std::_DebugHeapTag_func
	mov	DWORD PTR $T148732[ebp], eax
	push	113					; 00000071H
	push	OFFSET ??_C@_0EH@CBNPAENE@C?3?2Program?5Files?5?$CIx86?$CJ?2Microsoft@
	mov	ecx, DWORD PTR $T148732[ebp]
	push	ecx
	push	24					; 00000018H
	call	??2facet@locale@std@@SAPAXIABU_DebugHeapTag_t@2@PADH@Z ; std::locale::facet::operator new
	add	esp, 16					; 00000010H
	mov	DWORD PTR $T148731[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T148731[ebp], 0
	...
	call	?c_str@locale@std@@QBEPBDXZ		; std::locale::c_str
	push	eax
	lea	ecx, DWORD PTR $T148733[ebp]
	call	??0_Locinfo@std@@QAE@PBD@Z		; std::_Locinfo::_Locinfo
	mov	DWORD PTR tv139[ebp], eax
	mov	edx, DWORD PTR tv139[ebp]
	mov	DWORD PTR tv134[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 1
	mov	eax, DWORD PTR $T148737[ebp]
	or	eax, 1
	mov	DWORD PTR $T148737[ebp], eax
	mov	ecx, DWORD PTR tv134[ebp]
	push	ecx
	mov	ecx, DWORD PTR $T148731[ebp]
...
$LN5@Getcat@3:
	...
	mov	DWORD PTR $T148730[ebp], edx
	mov	DWORD PTR __$EHRec$[ebp+8], 2
	mov	eax, DWORD PTR __Ppf$[ebp]
	mov	ecx, DWORD PTR $T148730[ebp]
	mov	DWORD PTR [eax], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	edx, DWORD PTR $T148737[ebp]
	and	edx, 1
	je	SHORT $LN1@Getcat@3
	and	DWORD PTR $T148737[ebp], -2		; fffffffeH
	lea	ecx, DWORD PTR $T148733[ebp]
	call	??1_Locinfo@std@@QAE@XZ			; std::_Locinfo::~_Locinfo
$LN1@Getcat@3:
...
; 174  : 		return (string(_Grouping));
	...
	mov	edx, DWORD PTR $T148763[ebp]
	or	edx, 1
	mov	DWORD PTR $T148763[ebp], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 179  : 		return (string_type(_Falsename));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	edx, DWORD PTR $T148780[ebp]
	or	edx, 1
	mov	DWORD PTR $T148780[ebp], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 184  : 		return (string_type(_Truename));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	edx, DWORD PTR $T148785[ebp]
	or	edx, 1
	mov	DWORD PTR $T148785[ebp], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 123  : 		return (::_Getcvt());
	...
	call	__Getcvt
	mov	DWORD PTR $T148807[ebp], eax
	mov	DWORD PTR $T148807[ebp+4], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
	mov	ecx, DWORD PTR $T148807[ebp]
	mov	DWORD PTR [eax], ecx
	mov	edx, DWORD PTR $T148807[ebp+4]
	mov	DWORD PTR [eax+4], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 660  : 	_Elem *_Ptrdest = _NEW_CRT _Elem[_Count];
	...
	add	esp, 16					; 00000010H
	mov	DWORD PTR $T148840[ebp], eax
	mov	edx, DWORD PTR $T148840[ebp]
...
; 664  : 	for (_Elem *_Ptrnext = _Ptrdest; 0 < _Count; --_Count, ++_Ptrnext, ++_Ptr)
	...
	mov	DWORD PTR __Ptrnext$144714[ebp], eax
	jmp	SHORT $LN3@Maklocstr
$LN2@Maklocstr:
	mov	ecx, DWORD PTR __Count$[ebp]
	sub	ecx, 1
	mov	DWORD PTR __Count$[ebp], ecx
	mov	edx, DWORD PTR __Ptrnext$144714[ebp]
	add	edx, 1
	mov	DWORD PTR __Ptrnext$144714[ebp], edx
	mov	eax, DWORD PTR __Ptr$[ebp]
	add	eax, 1
	mov	DWORD PTR __Ptr$[ebp], eax
$LN3@Maklocstr:
...
; 665  : 		*_Ptrnext = (_Elem)(unsigned char)*_Ptr;
	...
	mov	ecx, DWORD PTR __Ptrnext$144714[ebp]
	mov	edx, DWORD PTR __Ptr$[ebp]
	mov	al, BYTE PTR [edx]
	mov	BYTE PTR [ecx], al
