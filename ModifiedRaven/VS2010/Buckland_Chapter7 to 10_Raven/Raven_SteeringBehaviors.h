...
private:
  ...
  //this behavior will allow the bot to evade the pursuing enemy bot
  Vector2D Evade(const Raven_Bot* pursuer);

  //this behavior will allow the bot to flee
...
public:
  ...
  bool EvadeIsOn() { return On(evade); }
