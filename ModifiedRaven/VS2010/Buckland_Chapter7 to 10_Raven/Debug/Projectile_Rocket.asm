; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.30319.01 
	...
	TITLE	C:\Users\Alec\Desktop\GameAISource\VS2010\Buckland_Chapter7 to 10_Raven\armory\Projectile_Rocket.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_colors	DD	0ffH
	...
	DD	0c8c8c8H
	DD	0e6e6ffH
$SG138630 DB	'Rocket_Mass', 00H
_SmallestDelay DQ 03fd0000000000000r		; 0.25
_SEND_MSG_IMMEDIATELY DQ 00000000000000000r	; 0
$SG138629 DB	'Rocket_MaxForce', 00H
$SG138631 DB	'Rocket_MaxSpeed', 00H
$SG138632 DB	'Rocket_Scale', 00H
	ORG $+3
$SG138633 DB	'Rocket_Damage', 00H
	ORG $+2
$SG138634 DB	'Rocket_BlastRadius', 00H
	ORG $+1
$SG138637 DB	'a', 00H, 'r', 00H, 'm', 00H, 'o', 00H, 'r', 00H, 'y', 00H
	...
	ORG $+2
$SG138638 DB	't', 00H, 'a', 00H, 'r', 00H, 'g', 00H, 'e', 00H, 't', 00H
	DB	' ', 00H, '!', 00H, '=', 00H, ' ', 00H, 'V', 00H, 'e', 00H, 'c'
	DB	00H, 't', 00H, 'o', 00H, 'r', 00H, '2', 00H, 'D', 00H, '(', 00H
	DB	')', 00H, 00H, 00H
	ORG $+2
$SG138652 DB	'Rocket_ExplosionDecayRate', 00H
CONST	ENDS
...
; File c:\users\alec\desktop\gameaisource\vs2010\buckland_chapter7 to 10_raven\armory\projectile_rocket.cpp
rdata$r	SEGMENT
...
; 31   : {
	...
	sub	esp, 8
	fstp	QWORD PTR [esp]
	push	OFFSET $SG138631
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	sub	esp, 8
	fstp	QWORD PTR [esp]
	push	OFFSET $SG138632
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	sub	esp, 8
	fstp	QWORD PTR [esp]
	push	OFFSET $SG138633
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetInt@Scriptor@@QAEHPAD@Z		; Scriptor::GetInt
	push	eax
	lea	eax, DWORD PTR $T148929[ebp]
	push	eax
	...
	push	OFFSET $SG138634
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	mov	edx, DWORD PTR _this$[ebp]
	fstp	QWORD PTR [edx+232]
...
; 32   :    assert (target != Vector2D());
	...
	push	32					; 00000020H
	push	OFFSET $SG138637
	push	OFFSET $SG138638
	call	__wassert
...
; File c:\users\alec\desktop\gameaisource\vs2010\buckland_chapter7 to 10_raven\armory\raven_projectile.h
rdata$r	SEGMENT
...
; File c:\users\alec\desktop\gameaisource\vs2010\common\time\crudetimer.h
CONST	SEGMENT
...
; 264  :   Raven_Game* const                  GetWorld(){return m_pWorld;} 
...
; 43   :   {
; 44   :     m_vVelocity = MaxSpeed() * Heading();

	lea	edx, DWORD PTR $T149033[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
...
; 45   : 
; 46   :     //make sure vehicle does not exceed maximum velocity
; 47   :     m_vVelocity.Truncate(m_dMaxSpeed);
...
; 56   :   {
; 57   :     m_dCurrentBlastRadius += script->GetDouble("Rocket_ExplosionDecayRate");
...
; 58   : 
; 59   :     //when the rendered blast circle becomes equal in size to the blast radius
; 60   :     //the rocket can be removed from the game
; 61   :     if (m_dCurrentBlastRadius > m_dBlastRadius)

	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR _this$[ebp]
	fld	QWORD PTR [eax+232]
	fcomp	QWORD PTR [edx+240]
	fnstsw	ax
	test	ah, 5
	jp	SHORT $LN1@Update
...
EXTRN	?IncreasePain@Raven_Bot@@QAEXI@Z:PROC		; Raven_Bot::IncreasePain
...
; 70   :    
; 71   :     //if the projectile has reached the target position or it hits an entity
; 72   :     //or wall it should explode/inflict damage/whatever and then mark itself
; 73   :     //as dead
; 74   : 
; 75   : 
; 76   :     //test to see if the line segment connecting the rocket's current position
; 77   :     //and previous position intersects with any bots.
; 78   :     Raven_Bot* hit = GetClosestIntersectingBot(m_vPosition - m_vVelocity, m_vPosition);
...
; 84   : 
; 85   : 	  agressor->IncreasePain(this->m_iDamageInflicted);
	...
	call	?IncreasePain@Raven_Bot@@QAEXI@Z	; Raven_Bot::IncreasePain

; 86   : 
; 87   :       //send a message to the bot to let it know it's been hit, and who the
; 88   :       //shot came from
; 89   :       Dispatcher->DispatchMsg(SEND_MSG_IMMEDIATELY,
; 90   :                               m_iShooterID,
; 91   :                               hit->ID(),
; 92   :                               Msg_TakeThatMF,
; 93   :                               (void*)&m_iDamageInflicted);
...
; 94   : 
; 95   :       //test for bots within the blast radius and inflict damage
; 96   :       InflictDamageOnBotsWithinBlastRadius();
...
; 97   :     }
; 98   : 
; 99   :     //test for impact with a wall
; 100  :     double dist;
; 101  :      if( FindClosestPointOfIntersectionWithWalls(m_vPosition - m_vVelocity,
; 102  :                                                  m_vPosition,
; 103  :                                                  dist,
; 104  :                                                  m_vImpactPoint,
; 105  :                                                  m_pWorld->GetMap()->GetWalls()))
...
; 106  :      {
; 107  :         m_bImpacted = true;

	mov	edx, DWORD PTR _this$[ebp]
	mov	BYTE PTR [edx+197], 1

; 108  :       
; 109  :         //test for bots within the blast radius and inflict damage
; 110  :         InflictDamageOnBotsWithinBlastRadius();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?InflictDamageOnBotsWithinBlastRadius@Rocket@@AAEXXZ ; Rocket::InflictDamageOnBotsWithinBlastRadius

; 111  : 
; 112  :         m_vPosition = m_vImpactPoint;
...
; 115  :     }
; 116  :     
; 117  :     //test to see if rocket has reached target position. If so, test for
; 118  :      //all bots in vicinity
; 119  :     const double tolerance = 5.0;   

	fld	QWORD PTR __real@4014000000000000
	fstp	QWORD PTR _tolerance$[ebp]

; 120  :     if (Vec2DDistanceSq(Pos(), m_vTarget) < tolerance*tolerance)

	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 152				; 00000098H
	push	ecx
	lea	edx, DWORD PTR $T149062[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Pos@BaseGameEntity@@QBE?AUVector2D@@XZ	; BaseGameEntity::Pos
	push	eax
...
; 121  :     {
; 122  :       m_bImpacted = true;

	mov	eax, DWORD PTR _this$[ebp]
	mov	BYTE PTR [eax+197], 1

; 123  : 
; 124  :       InflictDamageOnBotsWithinBlastRadius();
...
; 135  :   std::list<Raven_Bot*>::const_iterator curBot = m_pWorld->GetAllBots().begin();
...
; 136  : 
; 137  :   for (curBot; curBot != m_pWorld->GetAllBots().end(); ++curBot)
...
$LN4@InflictDam:
	...
	movzx	eax, BYTE PTR $T149080[ebp]
	test	eax, eax
	je	$LN2@InflictDam

; 138  :   {
; 139  :     if (Vec2DDistance(Pos(), (*curBot)->Pos()) < m_dBlastRadius + (*curBot)->BRadius())
...
; 140  :     {
; 141  :       //send a message to the bot to let it know it's been hit, and who the
; 142  :       //shot came from
; 143  :       Dispatcher->DispatchMsg(SEND_MSG_IMMEDIATELY,
; 144  :                               m_iShooterID,
; 145  :                               (*curBot)->ID(),
; 146  :                               Msg_TakeThatMF,
; 147  :                               (void*)&m_iDamageInflicted);
...
; 161  :   gdi->Circle(Pos(), 2);

	sub	esp, 8
	fld	QWORD PTR __real@4000000000000000
	fstp	QWORD PTR [esp]
	lea	eax, DWORD PTR $T149123[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Pos@BaseGameEntity@@QBE?AUVector2D@@XZ	; BaseGameEntity::Pos
	sub	esp, 16					; 00000010H
...
; 166  :     gdi->Circle(Pos(), m_dCurrentBlastRadius);

	mov	eax, DWORD PTR _this$[ebp]
	sub	esp, 8
	fld	QWORD PTR [eax+240]
	fstp	QWORD PTR [esp]
	lea	ecx, DWORD PTR $T149124[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Pos@BaseGameEntity@@QBE?AUVector2D@@XZ	; BaseGameEntity::Pos
	sub	esp, 16					; 00000010H
...
; 787  : 		return (const_iterator(this->_Nextnode(this->_Myhead), this));
	...
	mov	ecx, DWORD PTR $T149140[ebp]
	or	ecx, 1
	mov	DWORD PTR $T149140[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 797  : 		return (const_iterator(this->_Myhead, this));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_List_const_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@PAU_Node@?$_List_nod@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@1@PBV?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@1@@Z ; std::_List_const_iterator<std::_List_val<Raven_Bot *,std::allocator<Raven_Bot *> > >::_List_const_iterator<std::_List_val<Raven_Bot *,std::allocator<Raven_Bot *> > >
	mov	eax, DWORD PTR $T149145[ebp]
	or	eax, 1
	mov	DWORD PTR $T149145[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 64   :     std::string err("<PopLuaNumber> Cannot retrieve: ");
	...
	lea	ecx, DWORD PTR _err$144375[ebp]
...
; 66   :     throw std::runtime_error(err + name);
	...
	mov	ecx, DWORD PTR _name$[ebp]
	push	ecx
	lea	edx, DWORD PTR _err$144375[ebp]
	push	edx
	lea	eax, DWORD PTR $T144377[ebp]
	push	eax
	...
	lea	eax, DWORD PTR $T149201[ebp]
	push	eax
	call	__CxxThrowException@8
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T144377[ebp]
...
; 165  : 		{	// construct from message string
	...
	mov	DWORD PTR $T149216[ebp], eax
	lea	eax, DWORD PTR $T149216[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 1993 : 			_Elem *_Ptr = this->_Bx._Ptr;
	...
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+4]
	mov	DWORD PTR __Ptr$140920[ebp], eax
...
; 1995 : 				_Traits::copy(this->_Bx._Buf, _Ptr, _Newsize);
	...
	push	ecx
	mov	edx, DWORD PTR __Ptr$140920[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	add	eax, 4
	push	eax
...
; 1996 : 			this->_Alval.deallocate(_Ptr, this->_Myres + 1);
	...
	add	edx, 1
	push	edx
	mov	eax, DWORD PTR __Ptr$140920[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 1118 : 			size_type _Newsize = this->_Mysize - _Count;
	...
	mov	DWORD PTR __Newsize$140899[ebp], eax

; 1119 : 			_Eos(_Newsize);

	mov	ecx, DWORD PTR __Newsize$140899[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Eos@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Eos
$LN1@erase:
...
; 69   : 	return (_Ans);
	...
	mov	ecx, DWORD PTR $T149370[ebp]
	or	ecx, 1
	mov	DWORD PTR $T149370[ebp], ecx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Ans$[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
__unwindfunclet$??$?HDU?$char_traits@D@std@@V?$allocator@D@1@@std@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@ABV10@PBD@Z$1:
	mov	eax, DWORD PTR $T149370[ebp]
	and	eax, 1
	je	$LN5@operator@7
	and	DWORD PTR $T149370[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
$LN5@operator@7:
	ret	0
...
; 64   :     std::string err("<PopLuaNumber> Cannot retrieve: ");
	...
	push	OFFSET ??_C@_0CB@NOKEJIID@?$DMPopLuaNumber?$DO?5Cannot?5retrieve?3?5@
	lea	ecx, DWORD PTR _err$144392[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	DWORD PTR __$EHRec$[ebp+8], 0
...
; 66   :     throw std::runtime_error(err + name);
	...
	mov	ecx, DWORD PTR _name$[ebp]
	push	ecx
	lea	edx, DWORD PTR _err$144392[ebp]
	push	edx
	lea	eax, DWORD PTR $T144393[ebp]
	push	eax
	call	??$?HDU?$char_traits@D@std@@V?$allocator@D@1@@std@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@ABV10@PBD@Z ; std::operator+<char,std::char_traits<char>,std::allocator<char> >
	add	esp, 12					; 0000000cH
	mov	DWORD PTR tv74[ebp], eax
...
;	COMDAT xdata$x
; File c:\users\alec\desktop\gameaisource\vs2010\common\2d\wallintersectiontests.h
xdata$x	SEGMENT
...
$T149435 = -88						; size = 12
$T149434 = -73						; size = 1
_point$144640 = -68					; size = 16
_dist$144639 = -44					; size = 8
_curWall$ = -28						; size = 12
__$EHRec$ = -12						; size = 12
_A$ = 8							; size = 16
_B$ = 24						; size = 16
...
$LN6@FindCloses:
	...
	movzx	edx, BYTE PTR $T149434[ebp]
	test	edx, edx
	je	$LN4@FindCloses
...
; 100  :     double dist = 0.0;
	...
	fldz
	fstp	QWORD PTR _dist$144639[ebp]

; 101  :     Vector2D point;

	lea	ecx, DWORD PTR _point$144640[ebp]
	call	??0Vector2D@@QAE@XZ			; Vector2D::Vector2D

; 102  : 
; 103  :     if (LineIntersection2D(A, B, (*curWall)->From(), (*curWall)->To(), dist, point))

	lea	eax, DWORD PTR _point$144640[ebp]
	push	eax
	lea	ecx, DWORD PTR _dist$144639[ebp]
	push	ecx
	lea	edx, DWORD PTR $T149436[ebp]
	push	edx
	lea	ecx, DWORD PTR _curWall$[ebp]
...
; 105  :       if (dist < distance)
	...
	fld	QWORD PTR [edx]
	fcomp	QWORD PTR _dist$144639[ebp]
	fnstsw	ax
	test	ah, 65					; 00000041H
...
; 107  :         distance = dist;
	...
	mov	eax, DWORD PTR _distance$[ebp]
	fld	QWORD PTR _dist$144639[ebp]
	fstp	QWORD PTR [eax]

; 108  :         ip = point;

	mov	ecx, DWORD PTR _ip$[ebp]
	mov	edx, DWORD PTR _point$144640[ebp]
	mov	DWORD PTR [ecx], edx
	mov	eax, DWORD PTR _point$144640[ebp+4]
	mov	DWORD PTR [ecx+4], eax
	mov	edx, DWORD PTR _point$144640[ebp+8]
	mov	DWORD PTR [ecx+8], edx
	mov	eax, DWORD PTR _point$144640[ebp+12]
	mov	DWORD PTR [ecx+12], eax
$LN2@FindCloses:
...
; 113  :   if (distance < MaxDouble) return true;
	...
	mov	BYTE PTR $T149438[ebp], 1
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _curWall$[ebp]
	call	??1?$_Vector_const_iterator@V?$_Vector_val@PAVWall2D@@V?$allocator@PAVWall2D@@@std@@@std@@@std@@QAE@XZ
	mov	al, BYTE PTR $T149438[ebp]
...
; 115  :   return false;
	...
	mov	BYTE PTR $T149439[ebp], 0
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _curWall$[ebp]
	call	??1?$_Vector_const_iterator@V?$_Vector_val@PAVWall2D@@V?$allocator@PAVWall2D@@@std@@@std@@@std@@QAE@XZ
	mov	al, BYTE PTR $T149439[ebp]
$LN7@FindCloses:
...
; 1543 : 			size_type _Size = this->_Mysize;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+20]
	mov	DWORD PTR __Size$145575[ebp], edx
...
; 1545 : 				_Eos(_Size);
	...
	mov	edx, DWORD PTR __Size$145575[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Eos@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Eos
$LN3@reserve:
...
; 797  : 		return (const_iterator(this->_Mylast, this));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_Vector_const_iterator@V?$_Vector_val@PAVWall2D@@V?$allocator@PAVWall2D@@@std@@@std@@@std@@QAE@PAPAVWall2D@@PBU_Container_base12@1@@Z ; std::_Vector_const_iterator<std::_Vector_val<Wall2D *,std::allocator<Wall2D *> > >::_Vector_const_iterator<std::_Vector_val<Wall2D *,std::allocator<Wall2D *> > >
	mov	eax, DWORD PTR $T149518[ebp]
	or	eax, 1
	mov	DWORD PTR $T149518[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 202  : 		::new ((void _FARQ *)_Ptr) _Ty(_STD forward<_Ty>(_Val));
	...
	add	esp, 8
	mov	DWORD PTR $T149523[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T149523[ebp], 0
