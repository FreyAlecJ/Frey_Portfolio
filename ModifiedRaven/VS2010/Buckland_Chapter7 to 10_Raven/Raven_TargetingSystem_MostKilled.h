#ifndef TARGETING_SYSTEM_MOSTKILLED_H
#define TARGETING_SYSTEM_MOSTKILLED_H
...
class Raven_TargetingSystem_MostKilled :
...
public:
	...
	Raven_TargetingSystem_MostKilled(Raven_Bot* owner);
