...
//----------------------------------- SetNewTarget -------------------------------
// sets a new target based on the int id passsed into the method
//--------------------------------------------------------------------------------
void Raven_TargetingSystem::SetNewTarget(int id)
{
	Raven_Bot*  newTarget = m_pOwner->GetWorld()->GetBotWithID(id);
